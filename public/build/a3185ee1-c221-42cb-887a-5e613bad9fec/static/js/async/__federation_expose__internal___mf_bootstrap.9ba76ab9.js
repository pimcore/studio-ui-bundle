<<<<<<<< HEAD:public/build/9de149f3-7689-4abd-8f86-3156da212ba1/static/js/async/__federation_expose__internal___mf_bootstrap.ce012e4f.js
/*! For license information please see __federation_expose__internal___mf_bootstrap.ce012e4f.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{11918:function(e,t,i){i.a(e,async function(a,n){try{i.r(t),i(35809);var m=i(27821),r=i(55620),p=i(3477),d=i(69984);e=i.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(i.bind(i,3477))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),d._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},27821:function(e,t,i){i.d(t,{m:()=>C});var a=i(85893),n=i(81004),m=i(20745),r=i(13436),p=i(26788),d=i(20602),g=i(87117),o=i(53478),l=i(46309),s=i(62368),h=i(29202);let x=(0,h.createGlobalStyle)`
========
/*! For license information please see __federation_expose__internal___mf_bootstrap.9ba76ab9.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{11918:function(e,t,i){i.a(e,async function(a,n){try{i.r(t),i(62255);var m=i(27821),r=i(55620),p=i(3477),d=i(69984);e=i.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(i.bind(i,3477))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),d._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},27821:function(e,t,i){i.d(t,{m:()=>C});var a=i(85893),n=i(81004),m=i(20745),r=i(13436),p=i(26788),d=i(20602),g=i(24382),o=i(53478),l=i(46309),s=i(62368),h=i(29202);let x=(0,h.createGlobalStyle)`
>>>>>>>> origin/1.x:public/build/a3185ee1-c221-42cb-887a-5e613bad9fec/static/js/async/__federation_expose__internal___mf_bootstrap.9ba76ab9.js
  * {
...
`;var c=i(54409),$=i(44432),u=i(88308),X=i(71099),b=i(81343),S=i(11347),f=i(35316),L=i(40483),v=i(30683);let{useMercureCreateCookieMutation:w}=i(42125).api.enhanceEndpoints({addTagTypes:["Mercure"]}).injectEndpoints({endpoints:e=>({mercureCreateCookie:e.mutation({query:()=>({url:"/pimcore-studio/api/mercure/auth",method:"POST"}),invalidatesTags:["Mercure"]})}),overrideExisting:!1});var M=i(27539),k=i(8178),y=i(54246),E=i(63654),P=i(60552),G=i(691),z=i(72323);let D=e=>{let[t,i]=(0,n.useState)(!0),m=(0,c.s)(),{modal:r}=p.App.useApp();$.E.setModalInstance(m),P.U.setModalInstance(r);let{isAuthenticated:d}=(0,u.k)(),{loadPublicTranslations:g,loadTranslations:h}=(()=>{let[e]=(0,S.tj)();return{loadPublicTranslations:async()=>{await e({translation:{locale:X.L,keys:[],useFallback:!0}}).unwrap().then(e=>{X.Z.addResourceBundle(X.L,"translation",e.keys??[],!0,!0),X.Z.changeLanguage(X.L)}).catch(()=>{throw(0,b.ZP)(new b.aE("Error loading translations")),Error("Error loading translations")})},loadTranslations:async()=>{let t=(0,f.HF)(l.h.getState());await e({translation:{locale:t.language,keys:[],useFallback:!0}}).unwrap().then(e=>{X.Z.addResourceBundle(t.language,"translation",e.keys??[],!0,!0),X.Z.changeLanguage(t.language)}).catch(e=>{console.error("Error loading translations",e),(0,b.ZP)(new b.aE("Error loading translations"))})}}})(),{loadUser:D}=(()=>{let e=(0,L.useAppDispatch)();return{loadUser:async()=>{let t=e(v.hi.endpoints.userGetCurrentInformation.initiate());await t.then(t=>{let{data:i,isSuccess:a,isError:n,error:m}=t;n?(0,b.ZP)(new b.MS(m)):a&&void 0!==i&&e((0,f.av)(i))}).catch(e=>{throw(0,b.ZP)(new b.aE("Error loading user information")),Error("Error loading user information",{cause:e})})}}})(),[j]=w(),{loadSettings:Z}=(()=>{let e=(0,L.useAppDispatch)();return{loadSettings:async()=>{e(k.hi.endpoints.systemSettingsGet.initiate()).then(t=>{let{data:i,isSuccess:a,isError:n,error:m}=t;n&&(0,b.ZP)(new b.MS(m)),a&&void 0!==i&&e((0,M.I2)(i))}).catch(()=>{})}}})(),{loadAvailableLocales:A}={loadAvailableLocales:async()=>{try{await l.h.dispatch(y.hi.endpoints.translationGetAvailableLocales.initiate(void 0,{forceRefetch:!1,subscribe:!0})).unwrap()}catch(e){throw(0,b.ZP)(new b.aE("Error loading available locales")),e}}},{loadBrandThumbnailUrls:R}=(()=>{let e=(0,L.useAppDispatch)();return{loadBrandThumbnailUrls:async()=>{let t=e(k.hi.endpoints.settingAdminThumbnail.initiate());await t.then(t=>{let{data:i,isSuccess:a,isError:n,error:m}=t;n?(0,b.ZP)(new b.MS(m)):a&&void 0!==i&&e((0,M.eJ)(i))}).catch(()=>{(0,b.ZP)(new b.aE("Error loading brand thumbnail URLs"))})}}})(),{loadAdminSettings:T}=(()=>{let e=(0,l.TL)();return{loadAdminSettings:async()=>{let t=e(k.hi.endpoints.adminSettingsGet.initiate());await t.then(t=>{let{data:i,isSuccess:a,isError:n,error:m}=t;n?(0,b.ZP)(new b.MS(m)):a&&void 0!==i&&e((0,M.xv)(i))}).catch(()=>{(0,b.ZP)(new b.aE("Error loading admin settings"))})}}})(),{loadPerspective:I}=(0,E.o)(),{initGlobalMessageBus:_}=(()=>{let e=(0,n.useRef)(!1);return{initGlobalMessageBus:t=>{if(!e.current)try{let i=L.container.get(L.serviceIds.globalMessageBus),a=L.container.get(L.serviceIds.globalMessageBusProcess),n=L.container.get(L.serviceIds.backgroundProcessor);i.registerTopics([...Object.values(z.F),`studio-backend-default/user/${t}`]),n.registerProcess(a),i.startGlobalSubscription(),document.addEventListener("visibilitychange",()=>{"visible"!==document.visibilityState||a.isConnected()||a.start()}),window.addEventListener("online",()=>{a.start()}),e.current=!0}catch(e){console.error("Failed to initialize global message bus:",e)}}}})(),C=L.container.get(L.serviceIds["AppLoader/Registry"]);async function F(){let e=(0,f.HF)(l.h.getState()),t=String((null==e?void 0:e.activePerspective)??"studio_default_perspective");return await I(t)}return(0,n.useEffect)(()=>{(async()=>{if(i(()=>!0),void 0!==d&&(d||await Promise.all([g(),R()]).then(()=>{i(()=>!1)}).catch(e=>{console.error("Error during login preparation",e)}),d)){await Promise.all([D()]);let e=(0,f.HF)(l.h.getState());(0,o.isNil)(null==e?void 0:e.id)||_(e.id),await Promise.all([j(),h(),Z(),T(),R(),A(),F(),(0,G.G)()]),await C.loadAll(),i(()=>!1)}})()},[d]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(x,{}),t&&(0,a.jsx)(s.V,{loading:!0}),!t&&e.children]})};var j=i(91061),Z=i(65980),A=i(60234),R=i(18605),T=i(74939);let I=()=>(0,a.jsx)(n.StrictMode,{children:(0,a.jsx)(Z.Z,{children:(0,a.jsx)(r.R,{children:(0,a.jsx)(p.App,{notification:{stack:!1},children:(0,a.jsx)(T.a,{children:(0,a.jsxs)(A.$,{children:[(0,a.jsx)(R.i4,{}),(0,a.jsx)(j.z,{children:(0,a.jsx)(D,{children:(0,a.jsx)(d.RouterProvider,{router:g.Nd})})})]})})})})})});var _=i(7117);function C(){_.p.initialize(l.h);let e=document.getElementById("app");if(null===e)return void(0,b.ZP)(new b.aE("Root element not found"));(0,m.createRoot)(e).render((0,a.jsx)(I,{}))}}}]);