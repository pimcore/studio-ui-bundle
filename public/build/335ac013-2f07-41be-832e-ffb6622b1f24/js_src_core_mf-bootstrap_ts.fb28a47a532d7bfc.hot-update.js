...
const FieldFiltersContainer = ()=>{
    ...
    const handleColumnClick = (column)=>{
        ...
        const objectDataType2 = objectDataRegistry.getDynamicType(column.type);
        const shouldOverrideFilterType = objectDataType.shouldOverrideFilterType();
        console.log('------>>>>>> frontendType: ', column.frontendType, column.type);
        console.log('------>>>>>> objectDataType: ', objectDataType);
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.fb28a47a532d7bfc.hot-update.js.map