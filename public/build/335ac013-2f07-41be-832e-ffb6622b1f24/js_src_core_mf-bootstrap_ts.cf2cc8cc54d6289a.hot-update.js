...
const FieldFiltersContainer = ()=>{
    ...
    const handleColumnClick = (column)=>{
        ...
        const objectHasDataByColumnType = objectDataRegistry.hasDynamicType(column.type);
        let shouldOverrideFilterType = false;
        if (objectHasDataByColumnType) {
            const objectDataByColumnType1 = objectDataRegistry.getDynamicType(column.type);
        }
        const shouldOverrideFilterType = hasType ? objectDataByColumnType.shouldOverrideFilterType() : false;
        console.log('------>>>>>> objectDataByFrontendType: ', objectDataByFrontendType);
        console.log('------>>>>>> objectDataByColumnType: ', objectDataByColumnType);
        console.log('------>>>>>> shouldOverrideFilterType: ', shouldOverrideFilterType);
        setFilters((prevFilters)=>[
                ...prevFilters,
                {
                    ...
                    ...shouldOverrideFilterType && {
                        filterType: objectDataByFrontendType.getFieldFilterType()
                    }
                }
            ]);
    };
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.cf2cc8cc54d6289a.hot-update.js.map