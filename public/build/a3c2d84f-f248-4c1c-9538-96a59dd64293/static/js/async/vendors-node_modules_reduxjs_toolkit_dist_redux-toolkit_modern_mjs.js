 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["vendors-node_modules_reduxjs_toolkit_dist_redux-toolkit_modern_mjs"], {
"./node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Tuple: () => (Tuple),
  __DO_NOT_USE__ActionTypes: () => (/* reexport safe */ redux__rspack_import_0.__DO_NOT_USE__ActionTypes),
  addListener: () => (addListener),
  applyMiddleware: () => (/* reexport safe */ redux__rspack_import_0.applyMiddleware),
  asyncThunkCreator: () => (asyncThunkCreator),
  autoBatchEnhancer: () => (autoBatchEnhancer),
  bindActionCreators: () => (/* reexport safe */ redux__rspack_import_0.bindActionCreators),
  buildCreateSlice: () => (buildCreateSlice),
  clearAllListeners: () => (clearAllListeners),
  combineReducers: () => (/* reexport safe */ redux__rspack_import_0.combineReducers),
  combineSlices: () => (combineSlices),
  compose: () => (/* reexport safe */ redux__rspack_import_0.compose),
  ...
  createNextState: () => (/* reexport safe */ immer__rspack_import_1.produce),
  createReducer: () => (createReducer),
  createSelector: () => (/* reexport safe */ reselect__rspack_import_2.createSelector),
  createSelectorCreator: () => (/* reexport safe */ reselect__rspack_import_2.createSelectorCreator),
  createSerializableStateInvariantMiddleware: () => (createSerializableStateInvariantMiddleware),
  createSlice: () => (createSlice),
  createStore: () => (/* reexport safe */ redux__rspack_import_0.createStore),
  current: () => (/* reexport safe */ immer__rspack_import_1.current),
  findNonSerializableValue: () => (findNonSerializableValue),
  formatProdErrorMessage: () => (formatProdErrorMessage),
  freeze: () => (/* reexport safe */ immer__rspack_import_1.freeze),
  isAction: () => (/* reexport safe */ redux__rspack_import_0.isAction),
  isActionCreator: () => (isActionCreator),
  isAllOf: () => (isAllOf),
  isAnyOf: () => (isAnyOf),
  isAsyncThunkAction: () => (isAsyncThunkAction),
  isDraft: () => (/* reexport safe */ immer__rspack_import_1.isDraft),
  isFluxStandardAction: () => (isFSA),
  isFulfilled: () => (isFulfilled),
  isImmutableDefault: () => (isImmutableDefault),
  isPending: () => (isPending),
  isPlain: () => (isPlain),
  isPlainObject: () => (/* reexport safe */ redux__rspack_import_0.isPlainObject),
  isRejected: () => (isRejected),
  isRejectedWithValue: () => (isRejectedWithValue),
  legacy_createStore: () => (/* reexport safe */ redux__rspack_import_0.legacy_createStore),
  lruMemoize: () => (/* reexport safe */ reselect__rspack_import_2.lruMemoize),
  miniSerializeError: () => (miniSerializeError),
  nanoid: () => (nanoid),
  original: () => (/* reexport safe */ immer__rspack_import_1.original),
  prepareAutoBatched: () => (prepareAutoBatched),
  removeListener: () => (removeListener),
  unwrapResult: () => (unwrapResult),
  weakMapMemoize: () => (/* reexport safe */ reselect__rspack_import_2.weakMapMemoize)
});
/* import */ var redux__rspack_import_0 = __webpack_require__("./node_modules/redux/dist/redux.mjs");
...
/* import */ var reselect__rspack_import_2 = __webpack_require__("./node_modules/reselect/dist/reselect.mjs");
/* import */ var redux_thunk__rspack_import_3 = __webpack_require__("./node_modules/redux-thunk/dist/redux-thunk.mjs");
// src/index.ts
...
var createDraftSafeSelectorCreator = (...args) => {
  const createSelector2 = (0,reselect__rspack_import_2.createSelectorCreator)(...args);
  const createDraftSafeSelector2 = Object.assign((...args2) => {
    const selector = createSelector2(...args2);
    const wrappedSelector = (value, ...rest) => selector((0,immer__rspack_import_1.isDraft)(value) ? (0,immer__rspack_import_1.current)(value) : value, ...rest);
...
var createDraftSafeSelector = /* @__PURE__ */ createDraftSafeSelectorCreator(reselect__rspack_import_2.weakMapMemoize);
...
var composeWithDevTools = typeof window !== "undefined" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ : function() {
  ...
  if (typeof arguments[0] === "object") return redux__rspack_import_0.compose;
  return redux__rspack_import_0.compose.apply(null, arguments);
};
...
function createAction(type, prepareAction) {
  ...
  actionCreator.match = (action) => (0,redux__rspack_import_0.isAction)(action) && action.type === type;
...
function isFSA(action) {
  return (0,redux__rspack_import_0.isAction)(action) && Object.keys(action).every(isValidKey);
}
...
function freezeDraftable(val) {
  return (0,immer__rspack_import_1.isDraftable)(val) ? (0,immer__rspack_import_1.produce)(val, () => {
  }) : val;
}
...
function isPlain(val) {
  ...
  return val == null || type === "string" || type === "boolean" || type === "number" || Array.isArray(val) || (0,redux__rspack_import_0.isPlainObject)(val);
}
...
function createSerializableStateInvariantMiddleware(options = {}) {
  if (false) {} else {
    ...
    return (storeAPI) => (next) => (action) => {
      if (!(0,redux__rspack_import_0.isAction)(action)) {
        return next(action);
      }
...
var buildGetDefaultMiddleware = () => function getDefaultMiddleware(options) {
  ...
  if (thunk) {
    if (isBoolean(thunk)) {
      middlewareArray.push(redux_thunk__rspack_import_3.thunk);
    } else {
      middlewareArray.push((0,redux_thunk__rspack_import_3.withExtraArgument)(thunk.extraArgument));
    }
  }
  if (true) {
    if (immutableCheck) {
...
function configureStore(options) {
  ...
  if (typeof reducer === "function") {
    rootReducer = reducer;
  } else if ((0,redux__rspack_import_0.isPlainObject)(reducer)) {
    rootReducer = (0,redux__rspack_import_0.combineReducers)(reducer);
  } else {
  ...
  let finalCompose = redux__rspack_import_0.compose;
  if (devTools) {
  ...
  const middlewareEnhancer = (0,redux__rspack_import_0.applyMiddleware)(...finalMiddleware);
  ...
  return (0,redux__rspack_import_0.createStore)(rootReducer, preloadedState, composedEnhancer);
}
...
function createReducer(initialState, mapOrBuilderCallback) {
  ...
  function reducer(state = getInitialState(), action) {
    ...
    return caseReducers.reduce((previousState, caseReducer) => {
      if (caseReducer) {
        if ((0,immer__rspack_import_1.isDraft)(previousState)) {
          ...
          return result;
        } else if (!(0,immer__rspack_import_1.isDraftable)(previousState)) {
          ...
          return (0,immer__rspack_import_1.produce)(previousState, (draft) => {
...
var isDraftTyped = immer__rspack_import_1.isDraft;
...
function createStateOperator(mutator) {
  return function operation(state, arg) {
    ...
    return (0,immer__rspack_import_1.produce)(state, runMutator);
  };
}
...
var createDynamicMiddleware = () => {
  ...
  const getFinalMiddleware = (api) => {
    ...
    return (0,redux__rspack_import_0.compose)(...appliedMiddleware);
  };
...
function combineSlices(...slices) {
  ...
  const getReducer = () => Object.keys(reducerMap).length ? (0,redux__rspack_import_0.combineReducers)(reducerMap) : noopReducer;
...
"./node_modules/redux-thunk/dist/redux-thunk.mjs"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  thunk: () => (thunk),
...
"./node_modules/redux/dist/redux.mjs"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
//# sourceMappingURL=vendors-node_modules_reduxjs_toolkit_dist_redux-toolkit_modern_mjs.js.map