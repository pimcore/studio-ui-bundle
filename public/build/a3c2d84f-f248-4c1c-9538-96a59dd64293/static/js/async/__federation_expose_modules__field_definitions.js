...
"./js/src/core/modules/field-definitions/dynamic-types/types/data/_abstracts/use-sync-title-from-name.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  useSyncTitleFromName: () => (useSyncTitleFromName)
});
/* import */ var _sdk_components__rspack_import_0 = __webpack_require__("./js/src/sdk/components/index.ts");
...
const useSyncTitleFromName = ()=>{
    const form = _sdk_components__rspack_import_0.Form.useFormInstance();
    const name = _sdk_components__rspack_import_0.Form.useWatch('name');
    const initializedRef = (0,react__rspack_import_1.useRef)(false);
    const autoOverwriteRef = (0,react__rspack_import_1.useRef)(false);
    const lastSyncedRef = (0,react__rspack_import_1.useRef)(undefined);
    const prevNameRef = (0,react__rspack_import_1.useRef)(undefined);
    (0,react__rspack_import_1.useEffect)(()=>{
        if (!initializedRef.current) {
            ...
            const initialTitle = form.getFieldValue('title');
            autoOverwriteRef.current = !initialTitle;
            lastSyncedRef.current = initialTitle;
            prevNameRef.current = form.getFieldValue('name');
        ...
        form.setFieldValue('title', transformed, {
            triggerChange: true
        });
    }, [
        name,
...
__webpack_require__.d(__webpack_exports__, {
  ...
  useClassDefinitionGetBrickFieldsQuery: () => (/* reexport safe */ _Pimcore_modules_class_definition_class_definition_slice_enhanced__rspack_import_0.useClassDefinitionGetBrickFieldsQuery),
...
/* import */ var _Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_2 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/custom-layout/unsaved-changes-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_3 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/settings-provider.tsx");
...
const CustomLayoutModal = ()=>{
    ...
    const settings = (0,_Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_3.useSettings)();
    const { open, closeModal } = useCustomLayoutModal();
    const { guard } = (0,_Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_2.useUnsavedChanges)();
...
_s(CustomLayoutModal, "AgCgQcqhpRKjIEc1bBECzbhDvKk=", false, function() {
    return [
        ...
        _Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_2.useUnsavedChanges
    ];
});
...
/* import */ var _Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_4 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/custom-layout/unsaved-changes-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_5 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/provider.tsx");
...
const CustomLayout = ()=>{
    _s();
    const { activeConfiguration } = (0,_Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_5.useItems)();
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_field_definitions_components_editor_custom_layout_current_configuration_provider__rspack_import_1.CurrentConfigurationProvider, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_4.UnsavedChangesProvider, {
...
_s(CustomLayout, "HowMWCnJwmGsZG9fyznSSTpt2Yo=", false, function() {
    return [
        _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_5.useItems
    ];
});
_c = CustomLayout;
var _c;
...
"./js/src/core/modules/field-definitions/components/editor/custom-layout/unsaved-changes-provider.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  UnsavedChangesProvider: () => (UnsavedChangesProvider),
  useOptionalUnsavedChanges: () => (useOptionalUnsavedChanges),
...
const UnsavedChangesContext = /*#__PURE__*/ (0,react__rspack_import_2.createContext)(undefined);
const UnsavedChangesProvider = (props)=>{
    _s();
    const { t } = (0,react_i18next__rspack_import_3.useTranslation)();
    const modal = (0,_sdk_components__rspack_import_1.useFormModal)();
    const handlerRef = (0,react__rspack_import_2.useRef)(null);
    const register = (0,react__rspack_import_2.useCallback)((handler)=>{
    ...
    const guard = (0,react__rspack_import_2.useCallback)((onProceed)=>{
        var _handlerRef_current;
        if (((_handlerRef_current = handlerRef.current) === null || _handlerRef_current === void 0 ? void 0 : _handlerRef_current.isDirty()) !== true) {
            onProceed();
            return;
        }
        modal.confirm({
            ...
            onOk: async ()=>{
                var _handlerRef_current;
                if (await ((_handlerRef_current = handlerRef.current) === null || _handlerRef_current === void 0 ? void 0 : _handlerRef_current.save()) ?? true) {
                    onProceed();
                }
            }
        });
    ...
    const value = (0,react__rspack_import_2.useMemo)(()=>({
            register,
            guard
        }), [
        register,
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(UnsavedChangesContext.Provider, {
        value: value,
        children: props.children
    }, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/field-definitions/components/editor/custom-layout/unsaved-changes-provider.tsx",
        lineNumber: 52,
        columnNumber: 10
    }, undefined);
};
_s(UnsavedChangesProvider, "WTyQTj+5tNuaDg0ISyFBro/9Bwo=", false, function() {
    return [
        react_i18next__rspack_import_3.useTranslation,
        _sdk_components__rspack_import_1.useFormModal
    ];
});
_c = UnsavedChangesProvider;
const useUnsavedChanges = ()=>{
    _s1();
    const context = (0,react__rspack_import_2.useContext)(UnsavedChangesContext);
    if (context === undefined) {
        throw new Error('useUnsavedChanges must be used within an UnsavedChangesProvider');
    }
    return context;
};
_s1(useUnsavedChanges, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
const useOptionalUnsavedChanges = ()=>{
    _s2();
    return (0,react__rspack_import_2.useContext)(UnsavedChangesContext);
};
_s2(useOptionalUnsavedChanges, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
$RefreshReg$(_c, "UnsavedChangesProvider");
...
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_detail_refresh_provider__rspack_import_7 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/detail/refresh-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_8 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_9 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/settings-provider.tsx");
/* import */ var _sdk_components__rspack_import_10 = __webpack_require__("./js/src/sdk/components/index.ts");
/* import */ var _sdk_modules_app__rspack_import_11 = __webpack_require__("./js/src/sdk/modules/app/index.ts");
/* import */ var react__rspack_import_12 = __webpack_require__("webpack/sharing/consume/default/react/react");
/* import */ var react__rspack_import_12_default = /*#__PURE__*/__webpack_require__.n(react__rspack_import_12);
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const ItemDetail = (props)=>{
    _s();
    const { useDetailGeneralSettingsQuery, useDetailLayoutQuery, useDetailLayoutAccessor, customLayouts, LayoutProvider } = (0,_Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_9.useSettings)();
    const { setDetailView } = (0,_Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_8.useItems)();
    ...
    const [layoutKey, setLayoutKey] = (0,react__rspack_import_12.useState)(0);
    ...
    const layout = (0,react__rspack_import_12.useMemo)(()=>{
    ...
    (0,react__rspack_import_12.useEffect)(()=>{
        if (layoutError !== undefined && (!('status' in layoutError) || layoutError.status !== 404)) {
            (0,_sdk_modules_app__rspack_import_11.trackError)(new _sdk_modules_app__rspack_import_11.ApiError(layoutError));
        }
    }, [
        layoutError
    ]);
    (0,react__rspack_import_12.useEffect)(()=>{
        if (detailError !== undefined) {
            (0,_sdk_modules_app__rspack_import_11.trackError)(new _sdk_modules_app__rspack_import_11.ApiError(detailError));
        }
    }, [
        detailError
    ]);
    const refreshLayout = (0,react__rspack_import_12.useCallback)(async ()=>{
        const promises = [
            refetchDetail()
        ];
        ...
        refetchDetail,
        layoutResult === null || layoutResult === void 0 ? void 0 : layoutResult.refetch,
        setDetailView
    ]);
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_field_definitions_components_editor_items_detail_refresh_provider__rspack_import_7.RefreshProvider, {
        refreshLayout: refreshLayout,
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_3.GeneralSettingsProvider, {
            generalSettings: detailData,
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(LayoutProvider, {
                layout: layout,
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_10.ContentLayout, {
                    className: "absolute-stretch",
                    renderToolbar: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_10.Toolbar, {
                        children: [
                            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_10.Flex, {
                                gap: 'mini',
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_10.IconButton, {
                                        icon: {
                                            value: 'refresh'
                                        },
                                        onClick: ()=>{
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_10.Content, {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_10.ConfigLayout, {
                            leftItem: {
                                minSize: 250,
                                maxSize: 350,
                                size: 250,
...
_s(ItemDetail, "PDEsmXF095pfA2ry/Ui0pA98BEE=", true, function() {
    return [
        _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_9.useSettings,
        _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_8.useItems
    ];
});
_c = ItemDetail;
var _c;
...
const GeneralSettingsContext = /*#__PURE__*/ (0,react__rspack_import_2.createContext)(undefined);
const GeneralSettingsProvider = (props)=>{
    _s();
    const [generalSettings, setGeneralSettings] = (0,react__rspack_import_2.useState)(props.generalSettings);
    (0,react__rspack_import_2.useEffect)(()=>{
    ...
    const getIsDirty = ()=>{
        return !(0,lodash__rspack_import_1.isEqual)(generalSettings ?? {}, props.generalSettings ?? {});
    };
    return (0,react__rspack_import_2.useMemo)(()=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(GeneralSettingsContext.Provider, {
            value: {
                generalSettings,
...
const useGeneralSettings = ()=>{
    _s1();
    const context = (0,react__rspack_import_2.useContext)(GeneralSettingsContext);
    if (context === undefined) {
...
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_detail_refresh_provider__rspack_import_2 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/detail/refresh-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_3 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/settings-provider.tsx");
/* import */ var _sdk_components__rspack_import_4 = __webpack_require__("./js/src/sdk/components/index.ts");
/* import */ var _Pimcore_components_import_modal_import_modal__rspack_import_5 = __webpack_require__("./js/src/core/components/import-modal/import-modal.tsx");
...
const ImportExportActions = ()=>{
    ...
    const { importExportConfig } = (0,_Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_3.useSettings)();
    const { refreshLayout } = (0,_Pimcore_modules_field_definitions_components_editor_items_detail_refresh_provider__rspack_import_2.useRefresh)();
    const messageApi = (0,_sdk_components__rspack_import_4.useMessage)();
    const [isImportModalOpen, setIsImportModalOpen] = (0,react__rspack_import_7.useState)(false);
    const itemId = activeConfiguration === null || activeConfiguration === void 0 ? void 0 : activeConfiguration.id;
    if ((0,lodash__rspack_import_6.isNil)(importExportConfig)) {
    ...
    const handleExport = ()=>{
        if ((0,lodash__rspack_import_6.isNil)(itemId)) {
            return;
        }
    ...
    const uploadUrl = !(0,lodash__rspack_import_6.isNil)(itemId) ? getImportUrl(itemId) : '';
    const menuItems = [
        {
            key: 'export',
            icon: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_4.Icon, {
                value: "export"
            }, void 0, false, {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(react_jsx_dev_runtime__rspack_import_0.Fragment, {
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_4.Dropdown, {
                menu: {
                    items: menuItems
                },
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_4.IconTextButton, {
                    icon: {
                        value: 'chevron-down'
                    },
                    iconPlacement: "right",
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_import_modal_import_modal__rspack_import_5.ImportModal, {
...
_s(ImportExportActions, "sBEpbm0ACsSwfboT6gpM/oO6mPs=", false, function() {
    return [
        ...
        _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_3.useSettings,
        _Pimcore_modules_field_definitions_components_editor_items_detail_refresh_provider__rspack_import_2.useRefresh,
        _sdk_components__rspack_import_4.useMessage
    ];
});
...
"./js/src/core/modules/field-definitions/components/editor/items/detail/refresh-provider.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
 ...
 *  @license    Pimcore Open Core License (POCL)
 */ 
const RefreshContext = /*#__PURE__*/ (0,react__rspack_import_1.createContext)(undefined);
const RefreshProvider = (props)=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(RefreshContext.Provider, {
        value: value,
        children: props.children
    }, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/field-definitions/components/editor/items/detail/refresh-provider.tsx",
        lineNumber: 17,
        columnNumber: 10
    }, undefined);
};
_s(RefreshProvider, "tPauEVZ6EeuERV9ttvKTwQ7++Gw=");
_c = RefreshProvider;
const useRefresh = ()=>{
    _s1();
    const context = (0,react__rspack_import_1.useContext)(RefreshContext);
    if (context === undefined) {
...
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_3 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/detail/general-settings-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_4 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/settings-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_dynamic_types_utils_reserved_words__rspack_import_5 = __webpack_require__("./js/src/core/modules/field-definitions/dynamic-types/utils/reserved-words.ts");
/* import */ var _Pimcore_modules_field_definitions_utils_layout_helpers__rspack_import_6 = __webpack_require__("./js/src/core/modules/field-definitions/utils/layout-helpers.tsx");
/* import */ var _sdk_components__rspack_import_7 = __webpack_require__("./js/src/sdk/components/index.ts");
/* import */ var _sdk_modules_app__rspack_import_8 = __webpack_require__("./js/src/sdk/modules/app/index.ts");
/* import */ var _Pimcore_components_modal_alert_modal_hooks_use_alert_modal__rspack_import_9 = __webpack_require__("./js/src/core/components/modal/alert-modal/hooks/use-alert-modal.tsx");
...
const DetailSave = ()=>{
    ...
    const { useDetailUpdateMutation, useLayout } = (0,_Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_4.useSettings)();
    const { fieldDefinitions, setInvalidFieldDefinitionIds, structure, markClean, getIsDirty: isLayoutDirty } = useLayout();
    const { generalSettings, getIsDirty: areGeneralSettingsDirty } = (0,_Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_3.useGeneralSettings)();
    const [updateDetailMutation, result] = useDetailUpdateMutation();
    const { isLoading } = result;
    const messageApi = (0,_sdk_components__rspack_import_7.useMessage)();
    const alertModal = (0,_Pimcore_components_modal_alert_modal_hooks_use_alert_modal__rspack_import_9.useAlertModal)();
    const fieldDefinitionRegistry = (0,_Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_4.useSettings)().fieldDefinitionRegistry;
    const { area } = (0,_Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_1.useArea)();
    const unsavedChanges = (0,_Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_2.useOptionalUnsavedChanges)();
    ...
    const collectViolations = ()=>{
        ...
        const pathMap = structure !== undefined ? (0,_Pimcore_modules_field_definitions_utils_layout_helpers__rspack_import_6.buildPathMap)(structure) : {};
        // Data types only, skip localizedfields
        const checkDataTypeName = (key, name)=>{
            if ((0,_Pimcore_modules_field_definitions_dynamic_types_utils_reserved_words__rspack_import_5.isReservedWord)(name)) {
            ...
            if (structure !== undefined) {
                const namesInNamespace = (0,_Pimcore_modules_field_definitions_utils_layout_helpers__rspack_import_6.getNamesInNamespace)(structure, fieldDefinitions, key, pathMap);
        ...
        for (const [key, definition] of Object.entries(fieldDefinitions)){
            ...
            if (key === (structure === null || structure === void 0 ? void 0 : structure.id)) continue;
            // @todo check if we can handle the path here
            if (fieldDefinitionRegistry.hasDynamicType(definition.fieldtype) && !fieldDefinitionRegistry.getDynamicType(definition.fieldtype).isValid(definition, {
                area,
                fieldDefinitions,
                path: []
            })) {
    ...
    const performSave = async ()=>{
        ...
        try {
            ...
            (0,_sdk_modules_app__rspack_import_8.trackError)(new _sdk_modules_app__rspack_import_8.ApiError(e));
            return false;
        }
    ...
    // is a no-op.
    (0,react__rspack_import_10.useEffect)(()=>unsavedChanges === null || unsavedChanges === void 0 ? void 0 : unsavedChanges.register({
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_7.Button, {
...
_s(DetailSave, "jLbmzN8yGdEjSb3H27kyUUmTDMk=", true, function() {
    return [
        react_i18next__rspack_import_11.useTranslation,
        _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_4.useSettings,
        _Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_3.useGeneralSettings,
        _sdk_components__rspack_import_7.useMessage,
        _Pimcore_components_modal_alert_modal_hooks_use_alert_modal__rspack_import_9.useAlertModal,
        _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_4.useSettings,
        _Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_1.useArea,
        _Pimcore_modules_field_definitions_components_editor_custom_layout_unsaved_changes_provider__rspack_import_2.useOptionalUnsavedChanges
    ];
});
_c = DetailSave;
var _c;
...
/* import */ var _Pimcore_utils_normalize_icon__rspack_import_8 = __webpack_require__("./js/src/core/utils/normalize-icon.ts");
/* import */ var _sdk_utils__rspack_import_9 = __webpack_require__("./js/src/sdk/utils/index.ts");
...
/* import */ var react_i18next__rspack_import_12 = __webpack_require__("webpack/sharing/consume/default/react-i18next/react-i18next");
/* import */ var react_i18next__rspack_import_12_default = /*#__PURE__*/__webpack_require__.n(react_i18next__rspack_import_12);
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const renderConfigurationIcon = (icon)=>{
    if (icon === undefined || (0,_sdk_utils__rspack_import_9.isEmptyValue)(icon.value)) return undefined;
    const normalizedIcon = icon.type !== undefined ? icon : (0,_Pimcore_utils_normalize_icon__rspack_import_8.normalizeIcon)(icon.value);
    return normalizedIcon !== null ? /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_6.Icon, {
        ...normalizedIcon
    }, void 0, false, {
...
const ItemsSidebar = ()=>{
    _s();
    const { t } = (0,react_i18next__rspack_import_12.useTranslation)();
    ...
    const [searchTerm, setSearchTerm] = (0,react__rspack_import_11.useState)('');
    const debouncedSearchTerm = (0,_sdk_utils__rspack_import_9.useDebounce)(searchTerm, 300);
    const [showNewModal, setShowNewModal] = (0,react__rspack_import_11.useState)(false);
    ...
    const treeData = (0,react__rspack_import_11.useMemo)(()=>{
        if (data === undefined) {
            return [];
        }
        ...
        filteredData.forEach((configuration)=>{
            ...
            if ((0,lodash__rspack_import_10.isNil)(groupName) || groupName === '') {
            ...
            const treeDataItem = {
                title: configuration.name !== '' && configuration.name !== undefined && configuration.name !== configuration.id ? `${configuration.name} (${configuration.id})` : `${configuration.id}`,
                key: `${configuration.id}`,
                icon: renderConfigurationIcon(configuration.icon) ?? /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_6.Icon, {
                    value: "class"
                }, void 0, false, {
                    fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/field-definitions/components/editor/items/sidebar.tsx",
                    lineNumber: 103,
        ...
        const compareByTitle = (a, b)=>String(a.title).localeCompare(String(b.title), undefined, {
                sensitivity: 'base'
            });
    ...
    const expandedKeys = (0,react__rspack_import_11.useMemo)(()=>{
    ...
    const deleteConfiguration = (node)=>{
        ...
        const displayName = !(0,_sdk_utils__rspack_import_9.isEmptyValue)(configuration === null || configuration === void 0 ? void 0 : configuration.name) ? configuration.name : configuration.id;
        modal.confirm({
            title: t('delete'),
...
/* import */ var react__rspack_import_1 = __webpack_require__("webpack/sharing/consume/default/react/react");
/* import */ var react__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(react__rspack_import_1);
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_detail__rspack_import_2 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/detail.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_3 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/provider.tsx");
/* import */ var _Pimcore_utils_normalize_icon__rspack_import_4 = __webpack_require__("./js/src/core/utils/normalize-icon.ts");
/* import */ var _sdk_utils__rspack_import_5 = __webpack_require__("./js/src/sdk/utils/index.ts");
/* import */ var _sdk_components__rspack_import_6 = __webpack_require__("./js/src/sdk/components/index.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const renderConfigurationIcon = (icon)=>{
    if (icon === undefined || (0,_sdk_utils__rspack_import_5.isEmptyValue)(icon.value)) {
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_6.Icon, {
            value: "class"
        }, void 0, false, {
    ...
    const normalizedIcon = icon.type !== undefined ? icon : (0,_Pimcore_utils_normalize_icon__rspack_import_4.normalizeIcon)(icon.value);
    return normalizedIcon !== null ? /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_6.Icon, {
        ...normalizedIcon
    }, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/field-definitions/components/editor/items/tabs.tsx",
...
const ItemsTabs = ()=>{
    _s();
    const { configurations, activeConfiguration, setActiveConfiguration, closeConfiguration } = (0,_Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_3.useItems)();
    const items = configurations.map((configuration)=>({
            ...
            icon: renderConfigurationIcon(configuration.icon),
            closable: true,
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_field_definitions_components_editor_items_detail__rspack_import_2.ItemDetail, {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_6.Tabs, {
...
/* import */ var react_jsx_dev_runtime__rspack_import_0 = __webpack_require__("./node_modules/react/jsx-dev-runtime.js");
/* import */ var _Pimcore_modules_field_definitions_dynamic_types_types_data_abstracts_use_sync_title_from_name__rspack_import_1 = __webpack_require__("./js/src/core/modules/field-definitions/dynamic-types/types/data/_abstracts/use-sync-title-from-name.ts");
/* import */ var _sdk_components__rspack_import_2 = __webpack_require__("./js/src/sdk/components/index.ts");
/* import */ var react__rspack_import_3 = __webpack_require__("webpack/sharing/consume/default/react/react");
/* import */ var react__rspack_import_3_default = /*#__PURE__*/__webpack_require__.n(react__rspack_import_3);
/* import */ var react_i18next__rspack_import_4 = __webpack_require__("webpack/sharing/consume/default/react-i18next/react-i18next");
...
const FieldDefinitionDataFormFields = (props)=>{
    _s();
    (0,_Pimcore_modules_field_definitions_dynamic_types_types_data_abstracts_use_sync_title_from_name__rspack_import_1.useSyncTitleFromName)();
    const { t } = (0,react_i18next__rspack_import_4.useTranslation)();
    const isCustomLayout = props.context.area.includes('custom-layout');
    const typeTranslation = t('field-definition.' + (0,lodash__rspack_import_5.kebabCase)(props.type));
    const panelTitle = `${props.id} (${t('type')}: ${typeTranslation})`;
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.FormKit.Panel, {
        title: panelTitle,
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                label: t('name'),
                name: "name",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Input, {
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                label: t('title'),
                name: "title",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Input, {}, void 0, false, {
                    fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/field-definitions/dynamic-types/types/data/_abstracts/field-defintion-data-form-fields.tsx",
                    lineNumber: 30,
                    columnNumber: 9
                }, undefined)
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                label: t('tooltip'),
                name: "tooltip",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.TextArea, {}, void 0, false, {
                    fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/field-definitions/dynamic-types/types/data/_abstracts/field-defintion-data-form-fields.tsx",
                    lineNumber: 34,
                    columnNumber: 9
                }, undefined)
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                name: "mandatory",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Switch, {
            ...
            !isCustomLayout && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                name: "index",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Switch, {
            ...
            props.context.hideUnique !== true && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                name: "unique",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Switch, {
            ...
            props.context.hideNotEditable !== true && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Form.Item, {
                name: "noteditable",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_2.Switch, {
...
_s(FieldDefinitionDataFormFields, "pK9i7+0wdYVJmGY/e1f5YHmJP1o=", false, function() {
    return [
        _Pimcore_modules_field_definitions_dynamic_types_types_data_abstracts_use_sync_title_from_name__rspack_import_1.useSyncTitleFromName,
        react_i18next__rspack_import_4.useTranslation
    ];
});
...
/* import */ var _Pimcore_components_many_to_one_relation__rspack_import_8 = __webpack_require__("./js/src/core/components/many-to-one-relation/index.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
                                ...
                                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(react_jsx_dev_runtime__rspack_import_0.Fragment, {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_1.Form.Item, {
                                            ...
                                            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_many_to_one_relation__rspack_import_8.ManyToOneRelationPath, {
...
const create = ()=>{
    var _s = $RefreshSig$(), _s1 = $RefreshSig$();
    const LayoutContext = /*#__PURE__*/ (0,react__rspack_import_6.createContext)(undefined);
    ...
    const LayoutProvider = (props)=>{
        _s();
        const [structure, setStructure] = (0,react__rspack_import_6.useState)(undefined);
        const [fieldDefinitions, setFieldDefinitions] = (0,react__rspack_import_6.useState)({});
        const [currentFieldDefinitionId, setCurrentFieldDefinitionId] = (0,react__rspack_import_6.useState)(null);
        const [currentFieldDefinitionIdPath, setCurrentFieldDefinitionIdPath] = (0,react__rspack_import_6.useState)(null);
        const [invalidFieldDefinitionIds, setInvalidFieldDefinitionIds] = (0,react__rspack_import_6.useState)([]);
        const [copiedPath, setCopiedPath] = (0,react__rspack_import_6.useState)(undefined);
        const fieldDefinitionRegistry = props.fieldDefinitionRegistry;
        const { area } = (0,_Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_1.useArea)();
        // Use refs to always access latest values in callbacks
        const structureRef = react__rspack_import_6_default().useRef(structure);
        const fieldDefinitionsRef = react__rspack_import_6_default().useRef(fieldDefinitions);
        const areaRef = react__rspack_import_6_default().useRef(area);
        const isInitializedRef = (0,react__rspack_import_6.useRef)(false);
        ...
        const baselineRef = (0,react__rspack_import_6.useRef)(undefined);
        react__rspack_import_6_default().useEffect(()=>{
            structureRef.current = structure;
        ...
        (0,react__rspack_import_6.useEffect)(()=>{
            ...
            baselineRef.current = (0,lodash__rspack_import_5.cloneDeep)({
                structure: rootStructure,
                fieldDefinitions: initialFieldDefinitions
            });
            setCurrentFieldDefinitionId(null);
        ...
        const updateFieldDefinition = (0,react__rspack_import_6.useCallback)(function(structureNodeId, updatedFieldDefinition) {
        ...
        const addFieldDefinition = (0,react__rspack_import_6.useCallback)((structureNodeId, newFieldDefinition)=>{
            const newId = (0,_sdk_utils__rspack_import_4.uuid)();
        ...
        const removeFieldDefinition = (0,react__rspack_import_6.useCallback)((structureNodeId)=>{
        ...
        const removeChildren = (0,react__rspack_import_6.useCallback)((structureNodeId)=>{
        ...
        const cloneFieldDefinition = (0,react__rspack_import_6.useCallback)((structureNodeId)=>{
        ...
        const moveFieldDefinition = (0,react__rspack_import_6.useCallback)((structureNodeId, newParentId, newIndex)=>{
        ...
        const copyFieldDefinition = (0,react__rspack_import_6.useCallback)((path)=>{
            setCopiedPath(path);
        ...
        const pasteFieldDefinition = (0,react__rspack_import_6.useCallback)((path)=>{
        ...
        const getLayout = (0,react__rspack_import_6.useCallback)((props)=>{
        ...
        const getRecursiveChildrenIdsFromPath = (0,react__rspack_import_6.useCallback)((path)=>{
        ...
        const isValidChildFieldDefinition = (0,react__rspack_import_6.useCallback)((targetPath, childPath)=>{
        ...
        const isValidExternalChildFieldDefinition = (0,react__rspack_import_6.useCallback)((targetPath, externalLayout)=>{
        ...
        const addExternalFieldDefinition = (0,react__rspack_import_6.useCallback)((structureNodeId, layout, insertIndex)=>{
        ...
        const getIsDirty = (0,react__rspack_import_6.useCallback)(()=>{
            if (baselineRef.current === undefined || structureRef.current === undefined) {
                return false;
            }
            return !(0,lodash__rspack_import_5.isEqual)({
                structure: structureRef.current,
                fieldDefinitions: fieldDefinitionsRef.current
            }, baselineRef.current);
        }, []);
        const markClean = (0,react__rspack_import_6.useCallback)(()=>{
            baselineRef.current = (0,lodash__rspack_import_5.cloneDeep)({
                structure: structureRef.current,
                fieldDefinitions: fieldDefinitionsRef.current
            });
        }, []);
        return (0,react__rspack_import_6.useMemo)(()=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(LayoutContext.Provider, {
                value: {
                    structure,
                    fieldDefinitions,
                    copiedPath,
    ...
    _s(LayoutProvider, "KvIaufmLc4U84dqTMWPiRbnJLV4=", false, function() {
        return [
            _Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_1.useArea
        ];
    });
    const useLayout = ()=>{
        _s1();
        const context = (0,react__rspack_import_6.useContext)(LayoutContext);
        if (context === undefined) {
