/*! For license information please see __federation_expose__internal___mf_bootstrap.7f89b0ee.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{11918:function(e,i,t){t.a(e,async function(a,n){try{t.r(i),t(59701);var m=t(27821),r=t(55620),p=t(3477),d=t(69984);e=t.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(t.bind(t,3477))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),d._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},27821:function(e,i,t){t.d(i,{m:()=>F});var a=t(85893),n=t(81004),m=t(20745),r=t(13436),p=t(26788),d=t(20602),g=t(24382),o=t(53478),l=t(46309),s=t(62368),h=t(29202);let x=(0,h.createGlobalStyle)`
  * {
