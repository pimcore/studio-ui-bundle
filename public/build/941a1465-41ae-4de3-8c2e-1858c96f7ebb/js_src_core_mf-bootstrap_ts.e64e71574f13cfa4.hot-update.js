...
const versionsDataToTableData = (param)=>{
    ...
    for(let index = 0; index < mainVersionData.length; index++){
        ...
        console.log('============>>>>>>> mainVersionData: ', mainVersionItem);
        console.log('============>>>>>>> compareVersionData: ', compareVersionItem);
        console.log(' --- NEXT --- ');
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.e64e71574f13cfa4.hot-update.js.map