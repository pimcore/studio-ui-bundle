...
const versionsDataToTableData = (param)=>{
    ...
    console.log('============>>>>>>> mainVersionData: ', mainVersionData);
    console.log('============>>>>>>> compareVersionData: ', compareVersionData);
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.8bdd98f295c4c48d.hot-update.js.map