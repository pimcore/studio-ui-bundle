...
const versionsDataToTableData = (param)=>{
    ...
    for(let index = 0; index < fullVersionFieldList.length; index++){
        ...
        console.log('============>>>>>>> mainVersion: ', mainVersionItem);
        console.log('============>>>>>>> compareVersion: ', compareVersionItem);
        console.log(' --- NEXT --- ');
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.d422e1b16853bb6b.hot-update.js.map