...
const versionsDataToTableData = (param)=>{
    ...
    console.log('============>>>>>>> mainVersion: ', mainVersionData);
    console.log('============>>>>>>> compareVersion: ', compareVersionData);
    console.log(' --- NEXT --- ');
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.208910f9b2f2f392.hot-update.js.map