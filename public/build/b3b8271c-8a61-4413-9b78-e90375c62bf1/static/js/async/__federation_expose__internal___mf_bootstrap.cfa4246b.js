/*! For license information please see __federation_expose__internal___mf_bootstrap.cfa4246b.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{8178:function(e,i,t){t.d(i,{LA:()=>n,d_:()=>r,hi:()=>m,wG:()=>p});var a=t(42125);let n=["Settings"],m=a.api.enhanceEndpoints({addTagTypes:n}).injectEndpoints({endpoints:e=>({systemSettingsGet:e.query({query:()=>({url:"/pimcore-studio/api/settings"}),providesTags:["Settings"]}),activeBundlesGet:e.query({query:()=>({url:"/pimcore-studio/api/settings/active-bundles"}),providesTags:["Settings"]})}),overrideExisting:!1}),{useSystemSettingsGetQuery:r,useActiveBundlesGetQuery:p}=m},11918:function(e,i,t){t.a(e,async function(a,n){try{t.r(i),t(64746);var m=t(55237),r=t(55620),p=t(80452),g=t(69984);e=t.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(t.bind(t,80452))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),g._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},55237:function(e,i,t){t.d(i,{m:()=>H});var a=t(85893),n=t(81004),m=t(20745),r=t(13436),p=t(26788),g=t(20602),d=t(78712),o=t(46309),l=t(62368),s=t(29202);let h=(0,s.createGlobalStyle)`
  * {
