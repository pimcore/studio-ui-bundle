 ...
 */
"use strict";
(self["webpackChunkpimcore_studio_ui_bundle"] = self["webpackChunkpimcore_studio_ui_bundle"] || []).push([["vendors-node_modules_reduxjs_toolkit_dist_query_react_rtk-query-react_modern_mjs"], {
"./node_modules/@reduxjs/toolkit/dist/query/react/rtk-query-react.modern.mjs": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* ESM import */var redux__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./node_modules/redux/dist/redux.mjs");
/* ESM import */var immer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("webpack/sharing/consume/default/immer/immer");
/* ESM import */var reselect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./node_modules/reselect/dist/reselect.mjs");
/* ESM import */var redux_thunk__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./node_modules/redux-thunk/dist/redux-thunk.mjs");
/* ESM import */var _standard_schema_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./node_modules/@standard-schema/utils/dist/index.js");
/* ESM import */var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("webpack/sharing/consume/default/react-redux/react-redux");
...
__export(src_exports, {
  ...
  lruMemoize: () => reselect__WEBPACK_IMPORTED_MODULE_3__.lruMemoize,
  miniSerializeError: () => miniSerializeError,
  nanoid: () => nanoid,
  original: () => immer__WEBPACK_IMPORTED_MODULE_0__.original,
  prepareAutoBatched: () => prepareAutoBatched,
  removeListener: () => removeListener,
  unwrapResult: () => unwrapResult,
  weakMapMemoize: () => reselect__WEBPACK_IMPORTED_MODULE_3__.weakMapMemoize
});
__reExport(src_exports, redux__WEBPACK_IMPORTED_MODULE_4__);
...
var createDraftSafeSelectorCreator = (...args) => {
  ...
  const createDraftSafeSelector2 = Object.assign((...args2) => {
    ...
    const wrappedSelector = (value, ...rest) => selector((0,immer__WEBPACK_IMPORTED_MODULE_0__.isDraft)(value) ? (0,immer__WEBPACK_IMPORTED_MODULE_0__.current)(value) : value, ...rest);
...
var composeWithDevTools = typeof window !== "undefined" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ : function() {
  ...
  if (typeof arguments[0] === "object") return redux__WEBPACK_IMPORTED_MODULE_4__.compose;
  return redux__WEBPACK_IMPORTED_MODULE_4__.compose.apply(null, arguments);
};
...
function createAction(type, prepareAction) {
  ...
  actionCreator.match = (action) => (0,redux__WEBPACK_IMPORTED_MODULE_4__.isAction)(action) && action.type === type;
...
function isFSA(action) {
  return (0,redux__WEBPACK_IMPORTED_MODULE_4__.isAction)(action) && Object.keys(action).every(isValidKey);
}
...
function freezeDraftable(val) {
  return (0,immer__WEBPACK_IMPORTED_MODULE_0__.isDraftable)(val) ? (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(val, () => {
  }) : val;
}
...
function isPlain(val) {
  ...
  return val == null || type === "string" || type === "boolean" || type === "number" || Array.isArray(val) || (0,redux__WEBPACK_IMPORTED_MODULE_4__.isPlainObject)(val);
}
...
function createSerializableStateInvariantMiddleware(options = {}) {
  if (false) {} else {
    ...
    return (storeAPI) => (next) => (action) => {
      if (!(0,redux__WEBPACK_IMPORTED_MODULE_4__.isAction)(action)) {
        return next(action);
      }
...
var buildGetDefaultMiddleware = () => function getDefaultMiddleware(options) {
  ...
  if (thunk) {
    if (isBoolean(thunk)) {
      middlewareArray.push(redux_thunk__WEBPACK_IMPORTED_MODULE_5__.thunk);
    } else {
      middlewareArray.push((0,redux_thunk__WEBPACK_IMPORTED_MODULE_5__.withExtraArgument)(thunk.extraArgument));
    }
  }
  if (true) {
    if (immutableCheck) {
...
function configureStore(options) {
  ...
  if (typeof reducer === "function") {
    rootReducer = reducer;
  } else if ((0,redux__WEBPACK_IMPORTED_MODULE_4__.isPlainObject)(reducer)) {
    rootReducer = (0,redux__WEBPACK_IMPORTED_MODULE_4__.combineReducers)(reducer);
  } else {
  ...
  let finalCompose = redux__WEBPACK_IMPORTED_MODULE_4__.compose;
  if (devTools) {
  ...
  const middlewareEnhancer = (0,redux__WEBPACK_IMPORTED_MODULE_4__.applyMiddleware)(...finalMiddleware);
  ...
  return (0,redux__WEBPACK_IMPORTED_MODULE_4__.createStore)(rootReducer, preloadedState, composedEnhancer);
}
    ...
    return caseReducers.reduce((previousState, caseReducer) => {
      if (caseReducer) {
        if ((0,immer__WEBPACK_IMPORTED_MODULE_0__.isDraft)(previousState)) {
          ...
          return (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(previousState, (draft) => {
...
var isDraftTyped = immer__WEBPACK_IMPORTED_MODULE_0__.isDraft;
...
function createStateOperator(mutator) {
  return function operation(state, arg) {
    ...
    return (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(state, runMutator);
  };
}
...
function getCurrent(value) {
  return (0,immer__WEBPACK_IMPORTED_MODULE_0__.isDraft)(value) ? (0,immer__WEBPACK_IMPORTED_MODULE_0__.current)(value) : value;
}
...
var createDynamicMiddleware = () => {
  ...
  const getFinalMiddleware = (api) => {
    ...
    return (0,redux__WEBPACK_IMPORTED_MODULE_4__.compose)(...appliedMiddleware);
  };
...
function combineSlices(...slices) {
  ...
  const getReducer = () => Object.keys(reducerMap).length ? (0,redux__WEBPACK_IMPORTED_MODULE_4__.combineReducers)(reducerMap) : noopReducer;
...
var NamedSchemaError = class extends _standard_schema_utils__WEBPACK_IMPORTED_MODULE_6__.SchemaError {
...
function buildThunks({
  ...
  const updateQueryData = (endpointName, arg, updateRecipe, updateProvided = true) => (dispatch, getState) => {
    ...
    if ("data" in currentState) {
      if ((0,immer__WEBPACK_IMPORTED_MODULE_0__.isDraftable)(currentState.data)) {
        const [value, patches, inversePatches] = (0,immer__WEBPACK_IMPORTED_MODULE_0__.produceWithPatches)(currentState.data, updateRecipe);
    ...
    updateQuerySubstateIfExists(draft, meta.arg.queryCacheKey, (substate) => {
      ...
      if (merge) {
        if (substate.data !== void 0) {
          ...
          let newData = (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(substate.data, (draftSubstateData) => {
        ...
        substate.data = definitions[meta.arg.endpointName].structuralSharing ?? true ? copyWithStructuralSharing((0,immer__WEBPACK_IMPORTED_MODULE_0__.isDraft)(substate.data) ? (0,immer__WEBPACK_IMPORTED_MODULE_0__.original)(substate.data) : substate.data, payload) : payload;
      }
      ...
      queryResultPatched: {
        reducer(draft, {
          ...
          updateQuerySubstateIfExists(draft, queryCacheKey, (substate) => {
            substate.data = (0,immer__WEBPACK_IMPORTED_MODULE_0__.applyPatches)(substate.data, patches.concat());
          });
        },
        prepare: prepareAutoBatched()
      }
    ...
    reducers: {
      subscriptionsUpdated: {
        reducer(state, action) {
          return (0,immer__WEBPACK_IMPORTED_MODULE_0__.applyPatches)(state, action.payload);
        },
        prepare: prepareAutoBatched()
      }
    }
...
var defaultQuerySubState = /* @__PURE__ */ (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(initialSubState, () => {
});
var defaultMutationSubState = /* @__PURE__ */ (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(initialSubState, () => {
});
    ...
    if (didMutate) {
      if (!updateSyncTimer) {
        updateSyncTimer = setTimeout(() => {
          ...
          const [, patches] = (0,immer__WEBPACK_IMPORTED_MODULE_0__.produceWithPatches)(previousSubscriptions, () => newSubscriptions);
...
var coreModule = ({
  ...
  init(api, {
    ...
    (0,immer__WEBPACK_IMPORTED_MODULE_0__.enablePatches)();
...
function useStableQueryArgs(queryArgs, serialize, endpointDefinition, endpointName) {
  const incoming = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => ({
    queryArgs,
  ...
  const cache2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(incoming);
...
function useShallowStableValue(value) {
  const cache2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(value);
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
...
var getUseIsomorphicLayoutEffect = () => isDOM || isReactNative ? react__WEBPACK_IMPORTED_MODULE_2__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_2__.useEffect;
...
function buildHooks({
  ...
  const usePossiblyImmediateEffect = unstable__sideEffectsInRender ? (cb) => cb() : react__WEBPACK_IMPORTED_MODULE_2__.useEffect;
  return {
    buildQueryHooks,
  ...
  function usePrefetch(endpointName, defaultOptions) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)((arg, options) => dispatch(api.util.prefetch(endpointName, arg, {
  ...
  function useQuerySubscriptionCommonImpl(endpointName, arg, {
    ...
    const dispatch = useDispatch();
    const subscriptionSelectorsRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(void 0);
    ...
    const promiseRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(void 0);
    let {
      queryCacheKey,
      requestId
    } = promiseRef.current || {};
  ...
  function buildUseQueryState(endpointName, preSelector) {
    const useQueryState = (arg, {
      ...
      const lastValue = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(void 0);
      const selectDefaultResult = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => (
      ...
      const querySelector = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => selectFromResult ? createSelector2([selectDefaultResult], selectFromResult, {
        devModeChecks: {
  ...
  function buildQueryHooks(endpointName) {
    ...
    const useLazyQuerySubscription = ({
      ...
      const dispatch = useDispatch();
      const [arg, setArg] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(UNINITIALIZED_VALUE);
      const promiseRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(void 0);
      const stableSubscriptionOptions = useShallowStableValue({
        refetchOnReconnect,
        refetchOnFocus,
      ...
      const subscriptionOptionsRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(stableSubscriptionOptions);
      usePossiblyImmediateEffect(() => {
        subscriptionOptionsRef.current = stableSubscriptionOptions;
      }, [stableSubscriptionOptions]);
      const trigger = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(function(arg2, preferCacheValue = false) {
        let promise;
        batch(() => {
          promiseRef.current?.unsubscribe();
      ...
      return (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => [trigger, arg, {
        reset
      }], [trigger, arg, reset]);
    };
    ...
    return {
      ...
      useLazyQuery(options) {
        ...
        const info = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => ({
          lastArg: arg
        }), [arg]);
        return (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => [trigger, {
          ...queryStateResults,
          reset
      ...
      useQuery(arg, options) {
        ...
        (0,react__WEBPACK_IMPORTED_MODULE_2__.useDebugValue)(debugValue);
        return (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => ({
          ...queryStateResults,
  ...
  function buildInfiniteQueryHooks(endpointName) {
    const useInfiniteQuerySubscription = (arg, options = {}) => {
      ...
      const trigger = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(function(arg2, direction) {
        let promise;
        batch(() => {
          promiseRef.current?.unsubscribe();
          promiseRef.current = promise = dispatch(initiate(arg2, {
      ...
      const refetch = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(() => refetchOrErrorIfUnmounted(promiseRef), [promiseRef]);
      return (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
        const fetchNextPage = () => {
  ...
  function buildMutationHook(name) {
    return ({
      ...
      const dispatch = useDispatch();
      const [promise, setPromise] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)();
      (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => () => {
        if (!promise?.arg.fixedCacheKey) {
          promise?.reset();
        }
      }, [promise]);
      const triggerMutation = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(function(arg) {
      ...
      const selectDefaultResult = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => select({
        fixedCacheKey,
        requestId: promise?.requestId
      }), [fixedCacheKey, promise, select]);
      const mutationSelector = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => selectFromResult ? createSelector2([selectDefaultResult], selectFromResult) : selectDefaultResult, [selectFromResult, selectDefaultResult]);
      ...
      (0,react__WEBPACK_IMPORTED_MODULE_2__.useDebugValue)(debugValue);
      const finalState = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => ({
        ...currentState,
        originalArgs,
        reset
      }), [currentState, originalArgs, reset]);
      return (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => [triggerMutation, finalState], [triggerMutation, finalState]);
    };
  }
}
...
function ApiProvider(props) {
  ...
  const existingContext = (0,react__WEBPACK_IMPORTED_MODULE_2__.useContext)(context);
  if (existingContext) {
  ...
  const [store] = react__WEBPACK_IMPORTED_MODULE_2__.useState(() => configureStore({
    reducer: {
      [props.api.reducerPath]: props.api.reducer
    },
    middleware: (gDM) => gDM().concat(props.api.middleware)
  }));
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => props.setupListeners === false ? void 0 : setupListeners(store.dispatch, props.setupListeners), [props.setupListeners, store.dispatch]);
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_2__.createElement(react_redux__WEBPACK_IMPORTED_MODULE_1__.Provider, { store, context }, props.children);
}
...
"./node_modules/@standard-schema/utils/dist/index.js": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
