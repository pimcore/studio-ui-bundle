...
const REPLACEMENT_FILTER_TYPES = [
    'dataobject.adapter',
...
const FieldFiltersContainer = ()=>{
    ...
    const handleColumnClick = (column)=>{
        ...
        const isReplType = REPLACEMENT_FILTER_TYPES.includes(column.type);
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.d248db505dc97ada.hot-update.js.map