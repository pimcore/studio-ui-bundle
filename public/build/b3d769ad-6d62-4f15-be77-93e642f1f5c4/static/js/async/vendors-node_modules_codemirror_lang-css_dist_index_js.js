 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["vendors-node_modules_codemirror_lang-css_dist_index_js"], {
"./node_modules/@codemirror/lang-css/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* import */ var _lezer_css__rspack_import_0 = __webpack_require__("./node_modules/@lezer/css/dist/index.js");
...
const VariablesByNode = /*@__PURE__*/new _lezer_common__rspack_import_1.NodeWeakMap();
...
function variableNames(doc, node, isVariable) {
    if (node.to - node.from > 4096) {
        ...
        if (known)
            return known;
        let result = [], seen = new Set, cursor = node.cursor(_lezer_common__rspack_import_1.IterMode.IncludeAnonymous);
...
const defineCSSCompletionSource = (isVariable) => context => {
    let { state, pos } = context, node = (0,_codemirror_language__rspack_import_2.syntaxTree)(state).resolveInner(pos, -1);
...
*/
const cssLanguage = /*@__PURE__*/_codemirror_language__rspack_import_2.LRLanguage.define({
    name: "css",
    parser: /*@__PURE__*/_lezer_css__rspack_import_0.parser.configure({
        props: [
            /*@__PURE__*/_codemirror_language__rspack_import_2.indentNodeProp.add({
                Declaration: /*@__PURE__*/(0,_codemirror_language__rspack_import_2.continuedIndent)()
            }),
            /*@__PURE__*/_codemirror_language__rspack_import_2.foldNodeProp.add({
                "Block KeyframeList": _codemirror_language__rspack_import_2.foldInside
            })
        ]
    }),
    languageData: {
...
*/
function css() {
    return new _codemirror_language__rspack_import_2.LanguageSupport(cssLanguage, cssLanguage.data.of({ autocomplete: cssCompletionSource }));
}
...
"./node_modules/@lezer/css/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  parser: () => (parser)
});
...
const identifiers = new _lezer_lr__rspack_import_0.ExternalTokenizer(
  identifierTokens(identifier, VariableName, callee),
  {contextual: true}
);
const queryIdentifiers = new _lezer_lr__rspack_import_0.ExternalTokenizer(
  identifierTokens(queryIdentifier, queryVariableName, QueryCallee),
  {contextual: true}
);

const descendant = new _lezer_lr__rspack_import_0.ExternalTokenizer(input => {
...
const unitToken = new _lezer_lr__rspack_import_0.ExternalTokenizer(input => {
  if (!space.includes(input.peek(-1))) {
    let {next} = input;
...
const cssHighlighting = (0,_lezer_highlight__rspack_import_1.styleTags)({
  "AtKeyword import charset namespace keyframes media supports font-feature-values": _lezer_highlight__rspack_import_1.tags.definitionKeyword,
  "from to selector scope MatchFlag": _lezer_highlight__rspack_import_1.tags.keyword,
  NamespaceName: _lezer_highlight__rspack_import_1.tags.namespace,
  KeyframeName: _lezer_highlight__rspack_import_1.tags.labelName,
  KeyframeRangeName: _lezer_highlight__rspack_import_1.tags.operatorKeyword,
  TagName: _lezer_highlight__rspack_import_1.tags.tagName,
  ClassName: _lezer_highlight__rspack_import_1.tags.className,
  PseudoClassName: _lezer_highlight__rspack_import_1.tags.constant(_lezer_highlight__rspack_import_1.tags.className),
  IdName: _lezer_highlight__rspack_import_1.tags.labelName,
  "FeatureName PropertyName": _lezer_highlight__rspack_import_1.tags.propertyName,
  AttributeName: _lezer_highlight__rspack_import_1.tags.attributeName,
  NumberLiteral: _lezer_highlight__rspack_import_1.tags.number,
  KeywordQuery: _lezer_highlight__rspack_import_1.tags.keyword,
  UnaryQueryOp: _lezer_highlight__rspack_import_1.tags.operatorKeyword,
  "CallTag ValueName FontName": _lezer_highlight__rspack_import_1.tags.atom,
  VariableName: _lezer_highlight__rspack_import_1.tags.variableName,
  Callee: _lezer_highlight__rspack_import_1.tags.operatorKeyword,
  Unit: _lezer_highlight__rspack_import_1.tags.unit,
  "UniversalSelector NestingSelector": _lezer_highlight__rspack_import_1.tags.definitionOperator,
  "MatchOp CompareOp": _lezer_highlight__rspack_import_1.tags.compareOperator,
  "ChildOp SiblingOp, LogicOp": _lezer_highlight__rspack_import_1.tags.logicOperator,
  BinOp: _lezer_highlight__rspack_import_1.tags.arithmeticOperator,
  Important: _lezer_highlight__rspack_import_1.tags.modifier,
  Comment: _lezer_highlight__rspack_import_1.tags.blockComment,
  ColorLiteral: _lezer_highlight__rspack_import_1.tags.color,
  "ParenthesizedContent StringLiteral": _lezer_highlight__rspack_import_1.tags.string,
  ":": _lezer_highlight__rspack_import_1.tags.punctuation,
  "PseudoOp #": _lezer_highlight__rspack_import_1.tags.derefOperator,
...
const parser = _lezer_lr__rspack_import_0.LRParser.deserialize({
  ...
  tokenizers: [descendant, unitToken, identifiers, queryIdentifiers, 1, 2, 3, 4, new _lezer_lr__rspack_import_0.LocalTokenGroup("m~RRYZ[z{a~~g~aO$T~~dP!P!Qg~lO$U~~", 28, 142)],
...
//# sourceMappingURL=vendors-node_modules_codemirror_lang-css_dist_index_js.js.map