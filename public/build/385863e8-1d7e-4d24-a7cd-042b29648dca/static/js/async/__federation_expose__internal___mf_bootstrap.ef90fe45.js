/*! For license information please see __federation_expose__internal___mf_bootstrap.ef90fe45.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{8178:function(e,i,t){t.d(i,{LA:()=>n,d_:()=>r,hi:()=>m,wG:()=>p});var a=t(42125);let n=["Settings"],m=a.api.enhanceEndpoints({addTagTypes:n}).injectEndpoints({endpoints:e=>({systemSettingsGet:e.query({query:()=>({url:"/pimcore-studio/api/settings"}),providesTags:["Settings"]}),activeBundlesGet:e.query({query:()=>({url:"/pimcore-studio/api/settings/active-bundles"}),providesTags:["Settings"]})}),overrideExisting:!1}),{useSystemSettingsGetQuery:r,useActiveBundlesGetQuery:p}=m},11918:function(e,i,t){t.a(e,async function(a,n){try{t.r(i),t(88282);var m=t(55237),r=t(55620),p=t(80452),g=t(69984);e=t.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(t.bind(t,80452))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),g._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},55237:function(e,i,t){t.d(i,{m:()=>O});var a=t(85893),n=t(81004),m=t(20745),r=t(13436),p=t(26788),g=t(20602),d=t(84723),o=t(46309),l=t(62368),s=t(29202);let h=(0,s.createGlobalStyle)`
  * {
...
`;var x=t(54409),$=t(44432),c=t(88308),u=t(71099),X=t(81343),b=t(11347),S=t(35316),f=t(40483),L=t(30683);let{useMercureCreateCookieMutation:v}=t(42125).api.enhanceEndpoints({addTagTypes:["Mercure"]}).injectEndpoints({endpoints:e=>({mercureCreateCookie:e.mutation({query:()=>({url:"/pimcore-studio/api/mercure/auth",method:"POST"}),invalidatesTags:["Mercure"]})}),overrideExisting:!1});var y=t(27539),M=t(8178),w=t(54246),k=t(63654),G=t(60552),E=t(35950),P=t(34769),z=t(8156),j=t(56232),D=t(53478),R=t(30225),Z=t(80380),C=t(79771),A=t(35046);let T=async()=>{if((0,E.y)(P.P.Reports)){let e="Reporting",i=Z.nC.get(C.j.mainNavRegistry),t=Z.nC.get(C.j.widgetManager);try{let a=await o.h.dispatch(j.hi.endpoints.customReportsGetTree.initiate({page:1,pageSize:999999})).unwrap();(0,D.isUndefined)(null==a?void 0:a.items)||(a.items.forEach((t,a)=>{if(t.menuShortcut){let n=t.name,m=(0,R.O)(t.niceName)?n:t.niceName,r=(0,R.O)(t.group)?`${e}/${n}`:`${e}/${t.group}/${n}`;i.registerMainNavItem({id:`${n}-${a}`,path:r,label:m,group:t.group,order:300+a,permission:P.P.Reports,perspectivePermission:z.Q.Reports,widgetConfig:{component:"dynamic-report",config:{translationKey:"navigation.reports",icon:{type:"name",value:"pie-chart"},reportId:n}}})}}),t.registerWidget({name:"dynamic-report",component:A.$}))}catch(e){console.error("Failed to load reports for menu:",e)}}},_=e=>{let[i,t]=(0,n.useState)(!0),m=(0,x.s)(),{modal:r}=p.App.useApp();$.E.setModalInstance(m),G.U.setModalInstance(r);let{isAuthenticated:g}=(0,c.k)(),{loadPublicTranslations:d,loadTranslations:s}=(()=>{let[e]=(0,b.tj)();return{loadPublicTranslations:async()=>{await e({translation:{locale:u.L,keys:[],useFallback:!0}}).unwrap().then(e=>{u.Z.addResourceBundle(u.L,"translation",e.keys??[],!0,!0),u.Z.changeLanguage(u.L)}).catch(()=>{throw(0,X.ZP)(new X.aE("Error loading translations")),Error("Error loading translations")})},loadTranslations:async()=>{let i=(0,S.HF)(o.h.getState());await e({translation:{locale:i.language,keys:[],useFallback:!0}}).unwrap().then(e=>{u.Z.addResourceBundle(i.language,"translation",e.keys??[],!0,!0),u.Z.changeLanguage(i.language)}).catch(e=>{console.error("Error loading translations",e),(0,X.ZP)(new X.aE("Error loading translations"))})}}})(),{loadUser:E}=(()=>{let e=(0,f.useAppDispatch)();return{loadUser:async()=>{let i=e(L.hi.endpoints.userGetCurrentInformation.initiate());await i.then(i=>{let{data:t,isSuccess:a,isError:n,error:m}=i;n?(0,X.ZP)(new X.MS(m)):a&&void 0!==t&&e((0,S.av)(t))}).catch(e=>{throw(0,X.ZP)(new X.aE("Error loading user information")),Error("Error loading user information",{cause:e})})}}})(),[P]=v(),{loadSettings:z}=(()=>{let e=(0,f.useAppDispatch)();return{loadSettings:async()=>{e(M.hi.endpoints.systemSettingsGet.initiate()).then(i=>{let{data:t,isSuccess:a,isError:n,error:m}=i;n&&(0,X.ZP)(new X.MS(m)),a&&void 0!==t&&e((0,y.I)(t))}).catch(()=>{})}}})(),{loadAvailableLocales:j}={loadAvailableLocales:async()=>{try{await o.h.dispatch(w.hi.endpoints.translationGetAvailableLocales.initiate(void 0,{forceRefetch:!1,subscribe:!0})).unwrap()}catch(e){throw(0,X.ZP)(new X.aE("Error loading available locales")),e}}},{loadPerspective:D}=(0,k.o)();async function R(){let e=(0,S.HF)(o.h.getState()),i=String((null==e?void 0:e.activePerspective)??"studio_default_perspective");return await D(i)}return(0,n.useEffect)(()=>{(async()=>{t(()=>!0),void 0!==g&&(g||await Promise.all([d()]).then(()=>{t(()=>!1)}).catch(e=>{console.error("Error during login preparation",e)}),g&&(await Promise.all([E()]),await Promise.all([P(),s(),z(),j(),R(),T()]),t(()=>!1)))})()},[g]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(h,{}),i&&(0,a.jsx)(l.V,{loading:!0}),!i&&e.children]})};var F=t(91061),I=t(65980),U=t(14651),q=t(18605),B=t(74939);let N=()=>(0,a.jsx)(n.StrictMode,{children:(0,a.jsx)(I.Z,{children:(0,a.jsx)(r.R,{children:(0,a.jsx)(p.App,{children:(0,a.jsx)(B.a,{children:(0,a.jsxs)(U.$,{children:[(0,a.jsx)(q.i4,{}),(0,a.jsx)(F.z,{children:(0,a.jsx)(_,{children:(0,a.jsx)(g.RouterProvider,{router:d.Nd})})})]})})})})})});var H=t(7117);function O(){H.p.initialize(o.h);try{Z.nC.get(C.j.globalMessageBus).startGlobalSubscription()}catch(e){console.error("Failed to start global message bus subscription:",e)}let e=document.getElementById("app");if(null===e)return void(0,X.ZP)(new X.aE("Root element not found"));(0,m.createRoot)(e).render((0,a.jsx)(N,{}))}}}]);