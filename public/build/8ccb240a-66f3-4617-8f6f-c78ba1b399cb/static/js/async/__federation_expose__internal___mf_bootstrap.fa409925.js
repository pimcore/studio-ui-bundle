/*! For license information please see __federation_expose__internal___mf_bootstrap.fa409925.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{11918:function(e,a,t){t.a(e,async function(i,n){try{t.r(a),t(80143);var m=t(483),p=t(55620),r=t(3477),g=t(69984);e=t.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(t.bind(t,3477))).Pimcore,window.PimcoreStudio=r.PimcoreStudio,window.addEventListener("load",async()=>{await p.p.loadPlugins(),p.p.initPlugins(),p.p.startupPlugins(),g._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},483:function(e,a,t){t.d(a,{m:()=>I});var i=t(85893),n=t(81004),m=t(20745),p=t(13436),r=t(26788),g=t(20602),d=t(17799),o=t(46309),l=t(62368),h=t(29202);let s=(0,h.createGlobalStyle)`
  * {
