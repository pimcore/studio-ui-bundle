...
"./node_modules/@rsbuild/core/node_modules/@rspack/core/dist/cssExtractHmr.js": (function (__unused_webpack_module, exports) {
"use strict";
...
// extracted by css-extract-rspack-plugin
    ...
    if(true) {
      (function() {
        ...
        // 1748968068331
        var cssReload = (__webpack_require__("./node_modules/@rsbuild/core/node_modules/@rspack/core/dist/cssExtractHmr.js")/* .cssReload */.cssReload)(module.id, {});
...
/* ESM import */var immer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("webpack/sharing/consume/default/immer/immer");
/* ESM import */var _standard_schema_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/@standard-schema/utils/dist/index.js");
  ...
  const updateQueryData = (endpointName, arg, updateRecipe, updateProvided = true) => (dispatch, getState) => {
    ...
    if ("data" in currentState) {
      if ((0,immer__WEBPACK_IMPORTED_MODULE_1__.isDraftable)(currentState.data)) {
        const [value, patches, inversePatches] = (0,immer__WEBPACK_IMPORTED_MODULE_1__.produceWithPatches)(currentState.data, updateRecipe);
  ...
  function writeFulfilledCacheEntry(draft, meta, payload, upserting) {
    updateQuerySubstateIfExists(draft, meta.arg.queryCacheKey, (substate) => {
      ...
      if (merge) {
        ...
        substate.data = definitions[meta.arg.endpointName].structuralSharing ?? true ? copyWithStructuralSharing((0,immer__WEBPACK_IMPORTED_MODULE_1__.isDraft)(substate.data) ? (0,immer__WEBPACK_IMPORTED_MODULE_1__.original)(substate.data) : substate.data, payload) : payload;
      }
    ...
    if (didMutate) {
      if (!updateSyncTimer) {
        updateSyncTimer = setTimeout(() => {
          ...
          const [, patches] = (0,immer__WEBPACK_IMPORTED_MODULE_1__.produceWithPatches)(previousSubscriptions, () => newSubscriptions);
