/*! For license information please see __federation_expose__internal___mf_bootstrap.22b6581e.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{11918:function(e,t,a){a.a(e,async function(i,n){try{a.r(t),a(38050);var m=a(88688),r=a(55620),p=a(3477),d=a(69984);e=a.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(a.bind(a,3477))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),d._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},88688:function(e,t,a){a.d(t,{m:()=>F});var i=a(85893),n=a(81004),m=a(20745),r=a(2953),p=a(26788),d=a(20602),g=a(17799),o=a(53478),l=a(46309),s=a(62368),h=a(29202);let x=(0,h.createGlobalStyle)`
  * {
