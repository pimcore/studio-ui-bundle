/*! For license information please see __federation_expose__internal___mf_bootstrap.33a3f3f7.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{11918:function(e,t,i){i.a(e,async function(a,n){try{i.r(t),i(35877);var m=i(27821),r=i(55620),p=i(3477),d=i(69984);e=i.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(i.bind(i,3477))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),d._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},27821:function(e,t,i){i.d(t,{m:()=>C});var a=i(85893),n=i(81004),m=i(20745),r=i(13436),p=i(26788),d=i(20602),g=i(87117),o=i(53478),l=i(46309),s=i(62368),h=i(29202);let x=(0,h.createGlobalStyle)`
  * {
