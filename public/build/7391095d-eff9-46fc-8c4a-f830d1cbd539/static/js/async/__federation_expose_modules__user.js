"use strict";
(self["webpackChunkpimcore_studio_ui_bundle"] = self["webpackChunkpimcore_studio_ui_bundle"] || []).push([["__federation_expose_modules__user"], {
...
const useGlobalUserContext = ()=>{
    ...
    const context = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>(0,_Pimcore_modules_app_global_context_global_context_slice__WEBPACK_IMPORTED_MODULE_1__.selectContextByType)(state, 'user'));
...
/* ESM import */var _Pimcore_modules_user_user_api_slice_gen__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./js/src/core/modules/user/user-api-slice.gen.ts");
...
const useUserDraft = (id)=>{
    ...
    const user = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>(0,_Pimcore_modules_user_user_slice__WEBPACK_IMPORTED_MODULE_1__.selectUserById)(state, id));
    ...
    async function fetchUser() {
        const { data, isError: isUserGetByIdError, error } = await dispatch(_Pimcore_modules_user_user_api_slice_gen__WEBPACK_IMPORTED_MODULE_2__.api.endpoints.userGetById.initiate({
            id
        }));
    ...
    async function fetchUserAvailablePermissions() {
        const { data, isError: isFetchUserAvailablePermissionsError, error } = await dispatch(_Pimcore_modules_user_user_api_slice_gen__WEBPACK_IMPORTED_MODULE_2__.api.endpoints.userGetAvailablePermissions.initiate());
        if (data !== undefined) {
            return data;
        }
    ...
    function getUser() {
        ...
        fetchUserAvailablePermissions().then((data)=>{
            dispatch((0,_Pimcore_modules_user_user_slice__WEBPACK_IMPORTED_MODULE_1__.userAvailablePermissionsFetched)(data));
        }).catch((e)=>{
            console.error(e);
        });
    }
...
_s(useUserDraft, "fxDG1eJQbvTQoem4ZMmbYPCu9ic=", false, function() {
    return [
        ...
        _Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector
    ];
});
...
const useUserHelper = ()=>{
    ...
    async function getAvailablePermissions(props) {
        const { data } = await dispatch(_Pimcore_modules_user_user_api_slice_enhanced__WEBPACK_IMPORTED_MODULE_1__.api.endpoints.userGetAvailablePermissions.initiate());
        return data;
    }
    ...
    const activeId = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>state.user.activeId);
    const getAllIds = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>state.user.ids);
    const availablePermissions = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>state.user.availablePermissions);
    return {
...
_s(useUserHelper, "wzQ/OGX5/Nju38efN1tQx8EQkGE=", false, function() {
    return [
...
const useRoleDraft = (id)=>{
    _s();
    const dispatch = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppDispatch)();
    const role = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>(0,_Pimcore_modules_user_roles_roles_slice__WEBPACK_IMPORTED_MODULE_1__.selectRoleById)(state, id));
    const [isLoading, setIsLoading] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(true);
    const [isError, setIsError] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
...
const useRoleHelper = ()=>{
    ...
    const activeId = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>state.role.activeId);
    const getAllIds = (0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.useAppSelector)((state)=>state.role.ids);
    return {
        openRole,
        closeRole,
        getRoleTree,
...
/* ESM import */var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs");
/* ESM import */var _Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./js/src/core/app/store/index.ts");
/* ESM import */var _Pimcore_modules_user_hooks_use_user_trackable_changes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./js/src/core/modules/user/hooks/use-user-trackable-changes.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
* Pimcore
*
...
const userAdapter = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__.createEntityAdapter)({});
const slice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__.createSlice)({
    ...
    reducers: {
        ...
        ...(0,_Pimcore_modules_user_hooks_use_user_trackable_changes__WEBPACK_IMPORTED_MODULE_1__.useTrackableChangesReducers)(userAdapter)
    }
});
(0,_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.injectSliceWithState)(slice);
...
"./js/src/sdk/modules/user/index.ts": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  useGlobalUserContext: () => (/* reexport safe */ _Pimcore_modules_user_hooks_use_global_user_context__WEBPACK_IMPORTED_MODULE_0__.useGlobalUserContext),
  useRoleDraft: () => (/* reexport safe */ _Pimcore_modules_user_roles_hooks_use_roles_draft__WEBPACK_IMPORTED_MODULE_4__.useRoleDraft),
  useRoleHelper: () => (/* reexport safe */ _Pimcore_modules_user_roles_hooks_use_roles_helper__WEBPACK_IMPORTED_MODULE_5__.useRoleHelper),
  useTrackableChangesDraft: () => (/* reexport safe */ _Pimcore_modules_user_hooks_use_user_trackable_changes__WEBPACK_IMPORTED_MODULE_3__.useTrackableChangesDraft),
  useTrackableChangesReducers: () => (/* reexport safe */ _Pimcore_modules_user_hooks_use_user_trackable_changes__WEBPACK_IMPORTED_MODULE_3__.useTrackableChangesReducers),
  useUserDraft: () => (/* reexport safe */ _Pimcore_modules_user_hooks_use_user_draft__WEBPACK_IMPORTED_MODULE_1__.useUserDraft),
  useUserHelper: () => (/* reexport safe */ _Pimcore_modules_user_hooks_use_user_helper__WEBPACK_IMPORTED_MODULE_2__.useUserHelper)
});
/* ESM import */var _Pimcore_modules_user_hooks_use_global_user_context__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./js/src/core/modules/user/hooks/use-global-user-context.ts");
/* ESM import */var _Pimcore_modules_user_hooks_use_user_draft__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./js/src/core/modules/user/hooks/use-user-draft.tsx");
/* ESM import */var _Pimcore_modules_user_hooks_use_user_helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./js/src/core/modules/user/hooks/use-user-helper.tsx");
/* ESM import */var _Pimcore_modules_user_hooks_use_user_trackable_changes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./js/src/core/modules/user/hooks/use-user-trackable-changes.ts");
/* ESM import */var _Pimcore_modules_user_roles_hooks_use_roles_draft__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./js/src/core/modules/user/roles/hooks/use-roles-draft.tsx");
/* ESM import */var _Pimcore_modules_user_roles_hooks_use_roles_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./js/src/core/modules/user/roles/hooks/use-roles-helper.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
* Pimcore
*
...
//# sourceMappingURL=__federation_expose_modules__user.js.map