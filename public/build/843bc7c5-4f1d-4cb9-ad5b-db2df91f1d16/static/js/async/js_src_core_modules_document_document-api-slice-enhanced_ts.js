 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["js_src_core_modules_document_document-api-slice-enhanced_ts"], {
"./js/src/core/modules/document/document-api-slice-enhanced.ts"(module, __webpack_exports__, __webpack_require__) {
...
/* import */ var _document_api_slice_gen__rspack_import_1 = __webpack_require__("./js/src/core/modules/document/document-api-slice.gen.ts");
/* import */ var _sdk_api__rspack_import_2 = __webpack_require__("./js/src/sdk/api/index.ts");
...
const api = _document_api_slice_gen__rspack_import_1.api.enhanceEndpoints({
    addTagTypes: [
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DOCUMENT,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DOCUMENT_TREE,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DOCUMENT_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DOCUMENT_TYPES,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DOCUMENT_SITE
    ],
    endpoints: {
        documentClone: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.DOCUMENT_TREE_ID(args.parentId)
        },
        documentGetById: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DOCUMENT_DETAIL_ID(args.id)
        },
        documentGetTree: {
            providesTags: (result, error, args)=>args.parentId !== undefined ? _Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DOCUMENT_TREE_ID(args.parentId) : _Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DOCUMENT_TREE()
        },
        documentDocTypeList: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DOCUMENT_TYPES()
        },
        ...
        documentUpdateById: {
            invalidatesTags: (result, error, args)=>args.body.data.task === 'autoSave' ? [] : _Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.DOCUMENT_DETAIL_ID(args.id)
        },
        documentAdd: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.DOCUMENT_TREE_ID(args.parentId)
        },
        ...
        documentUpdateSite: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.DOCUMENT_SITE()
        },
        documentDeleteSite: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.DOCUMENT_SITE()
        },
        documentsListAvailableSites: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DOCUMENT_SITE()
        },
        documentGetTranslations: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DOCUMENT_DETAIL_ID(args.id)
        },
        documentAddTranslation: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.DOCUMENT_DETAIL_ID(args.id)
        },
            ...
            documentRenderletRender: build.query({
                queryFn: async (arg, api, extraOptions, baseQuery)=>{
                    const result = await baseQuery({
                        url: `${(0,_sdk_api__rspack_import_2.getPrefix)()}/documents/renderlet/render`,
                        params: {
                            id: arg.id,
                            type: arg.type,
...
"./js/src/core/modules/document/document-api-slice.gen.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  ...
  useDocumentGetTranslationsQuery: () => (useDocumentGetTranslationsQuery),
  useDocumentGetTreeQuery: () => (useDocumentGetTreeQuery),
  useDocumentGetTypesQuery: () => (useDocumentGetTypesQuery),
...
const injectedRtkApi = _sdk_api__rspack_import_0.api.enhanceEndpoints({
    ...
    endpoints: (build)=>({
            ...
            documentGetTypes: build.query({
                query: ()=>({
                        url: `/pimcore-studio/api/documents/types`
                    }),
                providesTags: [
                    "Documents"
                ]
