...
class DownloadJob {
    async run(options) {
        ...
        if (!(0,lodash__rspack_import_6.isNull)(jobRunId)) {
    ...
    async executeAction() {
        try {
            ...
            console.error(e);
            (0,_Pimcore_modules_app_error_handler__rspack_import_4["default"])(new _Pimcore_modules_app_error_handler__rspack_import_4.GeneralError((0,i18next__rspack_import_5.t)('jobs.job.download-error')));
            return null;
        }
    }
    createHandler(jobRunId, options) {
        ...
        return new _message_handlers_message_bus_job_message_bus_job_handler__rspack_import_0.MessageBusJobHandler({
            jobRunId,
            title,
            stepTracker: hasChildJob === true ? new _message_handlers_message_bus_job_step_tracker_child_job_step_tracker__rspack_import_2.ChildJobStepTracker({
                totalSteps: 2
            ...
            onCustomizeButtons: (context)=>{
                context.addSuccessButton({
                    label: (0,i18next__rspack_import_5.t)('jobs.job.button-download'),
                    handler: ()=>{
