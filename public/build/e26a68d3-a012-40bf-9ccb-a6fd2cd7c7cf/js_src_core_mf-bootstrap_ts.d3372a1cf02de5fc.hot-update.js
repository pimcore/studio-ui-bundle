...
const addGeoBoundsToolbar = (leafletMap, featureGroup, geoBounds, onChange, disabled)=>{
    ...
    leafletMap.on((leaflet__WEBPACK_IMPORTED_MODULE_0___default().Draw.Event.EDITSTOP) + ' ' + (leaflet__WEBPACK_IMPORTED_MODULE_0___default().Draw.Event.EDITMOVE), function(e) {
        if (onChange !== undefined) {
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.d3372a1cf02de5fc.hot-update.js.map