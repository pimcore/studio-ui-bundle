...
const GeoMap = /*#__PURE__*/ _s((0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(_c = _s((props, ref)=>{
    ...
    const setupToolbar = (param)=>{
        let { map: map1, group: group1, value } = param;
        if (props.mode === 'geoPoint') {
            (0,_Pimcore_components_geo_map_toolbar_add_geo_point_toolbar__WEBPACK_IMPORTED_MODULE_7__.addGeoPointToolbar)(map1, group1, settings.maps.reverse_geocoding_url_template, value, props.onChange, props.disabled);
        } else if (props.mode === 'geoPolyLine') {
            (0,_Pimcore_components_geo_map_toolbar_add_geo_poly_line_toolbar__WEBPACK_IMPORTED_MODULE_11__.addGeoPolyLineToolbar)(map1, group1, value, props.onChange, props.disabled);
        } else if (props.mode === 'geoPolygon') {
            (0,_Pimcore_components_geo_map_toolbar_add_geo_polygon_toolbar__WEBPACK_IMPORTED_MODULE_12__.addGeoPolygonToolbar)(map1, group1, value, props.onChange, props.disabled);
        } else if (props.mode === 'geoBounds') {
            (0,_Pimcore_components_geo_map_toolbar_add_geo_bounds_toolbar__WEBPACK_IMPORTED_MODULE_13__.addGeoBoundsToolbar)(map1, group1, value, props.onChange, props.disabled);
        }
    };
    const initializeMap = ()=>{
        if (mapContainer.current !== null) {
            const map1 = leaflet__WEBPACK_IMPORTED_MODULE_3___default().map(mapContainer.current);
            ...
            const featureGroup = leaflet__WEBPACK_IMPORTED_MODULE_3___default().featureGroup().addTo(map1);
            setupToolbar({
                map: map1,
                group: featureGroup,
                value
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.b8a3ce50efde17fa.hot-update.js.map