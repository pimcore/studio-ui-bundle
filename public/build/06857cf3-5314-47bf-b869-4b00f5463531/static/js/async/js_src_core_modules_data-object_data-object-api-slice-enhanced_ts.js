...
/* import */ var _data_object_api_slice_gen__rspack_import_1 = __webpack_require__("./js/src/core/modules/data-object/data-object-api-slice.gen.ts");
...
const api = _data_object_api_slice_gen__rspack_import_1.api.enhanceEndpoints({
    addTagTypes: [
    ...
    endpoints: {
        ...
        dataObjectGetGrid: {
            providesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DATA_OBJECT_GRID_ID(args.body.folderId),
                    ...args.body.elementId !== undefined ? _Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DATA_OBJECT_DETAIL_ID(args.body.elementId) : []
                ]
        },
