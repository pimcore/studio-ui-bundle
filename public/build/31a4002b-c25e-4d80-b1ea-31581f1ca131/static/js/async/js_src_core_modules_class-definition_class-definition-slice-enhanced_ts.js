...
/* import */ var _class_definition_slice_gen__rspack_import_1 = __webpack_require__("./js/src/core/modules/class-definition/class-definition-slice.gen.ts");
...
/* eslint-disable max-lines */ const api = _class_definition_slice_gen__rspack_import_1.api.enhanceEndpoints({
    addTagTypes: [
    ...
    endpoints: {
        ...
        classSelectOptionUpdate: {
            ...
            async onQueryStarted (args, param) {
                ...
                try {
                    const { data } = await queryFulfilled;
                    dispatch(api.util.updateQueryData('classSelectOptionGet', {
                        id: args.id
                    }, (draft)=>{
                        Object.assign(draft, data);
                    }));
