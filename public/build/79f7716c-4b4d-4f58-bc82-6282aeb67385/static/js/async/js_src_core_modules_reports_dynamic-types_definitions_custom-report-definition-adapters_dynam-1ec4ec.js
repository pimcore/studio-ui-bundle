...
"./js/src/core/modules/execution-engine/jobs/download/csv-download-job.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  CsvDownloadJob: () => (CsvDownloadJob)
});
...
/* import */ var _rehydration_helpers__rspack_import_3 = __webpack_require__("./js/src/core/modules/execution-engine/jobs/rehydration-helpers.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const CSV_FOLDER_EXPORT_JOB_NAME = 'studio_ee_job_collect_csv_folder_export_elements';
class CsvDownloadJob extends _abstract_download_job__rspack_import_0.AbstractDownloadJob {
    usesChildJob() {
        return this.isFolderExport;
    }
    static getTitle() {
        return (0,i18next__rspack_import_2.t)('jobs.download-csv-job.title');
    }
    static getDownloadUrl() {
        return `${(0,_Pimcore_app_api_pimcore_route__rspack_import_1.getPrefix)()}/export/download/csv/{jobRunId}`;
    }
    static rehydrate(jobRuns) {
        const [parent] = jobRuns;
        return this.buildHandler({
            ...(0,_rehydration_helpers__rspack_import_3.resolveChildJobRunOptions)(jobRuns),
...
CsvDownloadJob.jobNames = [
    'studio_ee_job_create_csv',
    CSV_FOLDER_EXPORT_JOB_NAME
];
void CsvDownloadJob;
...
"./js/src/core/modules/reports/reports-editor/components/helpers.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  isFolder: () => (isFolder)
});
...
__webpack_require__.d(__webpack_exports__, {
  ...
  normalizeIconFields: () => (normalizeIconFields)
});
...
/* import */ var _Pimcore_utils_normalize_icon__rspack_import_1 = __webpack_require__("./js/src/core/utils/normalize-icon.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const normalizeIconFields = (data)=>{
    return {
        iconClass: (0,_Pimcore_utils_normalize_icon__rspack_import_1.denormalizeIcon)(data === null || data === void 0 ? void 0 : data.iconClass) ?? '',
        groupIconClass: (0,_Pimcore_utils_normalize_icon__rspack_import_1.denormalizeIcon)(data === null || data === void 0 ? void 0 : data.groupIconClass) ?? ''
    };
};
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  normalizeReportFormData: () => (normalizeReportFormData),
...
/* import */ var lodash__rspack_import_1 = __webpack_require__("webpack/sharing/consume/default/lodash/lodash");
/* import */ var lodash__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(lodash__rspack_import_1);
/* import */ var _Pimcore_utils_normalize_icon__rspack_import_2 = __webpack_require__("./js/src/core/utils/normalize-icon.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const normalizeReportFormData = (data)=>({
        ...data,
        iconClass: (0,_Pimcore_utils_normalize_icon__rspack_import_2.normalizeIcon)(data === null || data === void 0 ? void 0 : data.iconClass),
        groupIconClass: (0,_Pimcore_utils_normalize_icon__rspack_import_2.normalizeIcon)(data === null || data === void 0 ? void 0 : data.groupIconClass)
    });
...
const loadReportsMenuItems = async ()=>{
    if ((0,_Pimcore_modules_auth_permission_helper__rspack_import_1.isAllowed)(_Pimcore_modules_auth_enums_user_permission__rspack_import_2.UserPermission.Reports)) {
        ...
        try {
            const reportsData = await _Pimcore_app_store__rspack_import_0.store.dispatch(_Pimcore_modules_reports_custom_reports_api_slice_gen__rspack_import_4.api.endpoints.customReportsGetTree.initiate(undefined, {
                forceRefetch: true
            })).unwrap();
...
const ColumnsProvider = (param)=>{
    ...
    const resetColumnsToInitial = (0,react__rspack_import_1.useCallback)(()=>{
        setColumns(initialColumns);
    }, [
        initialColumns,
        setColumns
    ]);
    const addColumn = (0,react__rspack_import_1.useCallback)((column)=>{
        setColumns((prev)=>[
                ...prev,
                column
            ]);
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(ColumnsContext.Provider, {
        ...
        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/components/grid/contexts/columns-context.tsx",
        lineNumber: 33,
        columnNumber: 10
    }, undefined);
};
_s(ColumnsProvider, "/UJED4qROTrcAKvqJVVpzVNBmtY=");
_c = ColumnsProvider;
...
function createFilterContext() {
    ...
    const FilterProvider = (param)=>{
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(FilterContext.Provider, {
            ...
            fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/components/grid/contexts/filter-context.tsx",
            lineNumber: 28,
            columnNumber: 12
        }, this);
    };
...
const Pagination = (param)=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_pagination_pagination__rspack_import_3.Pagination, {
        ...
        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/components/pagination/pagination.tsx",
        lineNumber: 29,
        columnNumber: 10
    }, undefined);
};
    ...
    if (isFetching) {
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_box_box__rspack_import_4.Box, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_spin_spin__rspack_import_3.Spin, {}, void 0, false, {
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/components/refetch/refetch.tsx",
                lineNumber: 24,
                columnNumber: 9
            }, undefined)
        }, void 0, false, {
    ...
    const renderSelectItem = (param)=>{
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_form_form__rspack_import_5.Form.Item, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_select_select__rspack_import_4.Select, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/chart-settings/chart-settings.tsx",
                lineNumber: 52,
                columnNumber: 7
            }, undefined)
        }, void 0, false, {
...
const ColumnConfiguration = (param)=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_form_form_kit__rspack_import_5.FormKit.Panel, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_grid_grid__rspack_import_6.Grid, {
            ...
            fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/column-configuration/column-configuration.tsx",
            lineNumber: 67,
            columnNumber: 7
        }, undefined)
    }, void 0, false, {
        ...
        columnHelper.accessor(_Pimcore_modules_reports_reports_editor_components_report_configuration_components_column_configuration_constants__rspack_import_4.COLUMN_KEYS.ORDER, {
            ...
            cell: (cellData)=>{
                ...
                return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_grid_columns_default_cell__rspack_import_5.DefaultCell, {
                    ...
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/column-configuration/hooks/use-columns.tsx",
                    lineNumber: 46,
                    columnNumber: 14
                }, undefined);
            },
...
/* import */ var _Pimcore_components_icon_selector_icon_selector__rspack_import_6 = __webpack_require__("./js/src/core/components/icon-selector/icon-selector.tsx");
    ...
    const renderInputItem = (param)=>{
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_form_form__rspack_import_4.Form.Item, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_input_input__rspack_import_5.Input, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/general-settings/general-settings.tsx",
                lineNumber: 28,
                columnNumber: 7
            }, undefined)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_form_form_kit__rspack_import_3.FormKit.Panel, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_form_form__rspack_import_4.Form.Item, {
                ...
                name: "iconClass",
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_selector_icon_selector__rspack_import_6.IconSelector, {}, void 0, false, {
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/general-settings/general-settings.tsx",
                    lineNumber: 41,
                    columnNumber: 9
                }, undefined)
...
const Permissions = (param)=>{
    ...
    const renderIcon = (iconName, size)=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_icon__rspack_import_12.Icon, {
            ...
            fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/permissions/permissions.tsx",
            lineNumber: 65,
            columnNumber: 42
        }, undefined);
    ...
    const renderAddButton = ()=>{
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_dropdown_dropdown__rspack_import_9.Dropdown, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_text_button_icon_text_button__rspack_import_10.IconTextButton, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/components/source-definition/source-definition.tsx",
                lineNumber: 66,
                columnNumber: 9
            }, undefined)
        }, void 0, false, {
...
const ReportConfiguration = (param)=>{
    let { report, modifiedReports, setModifiedReports } = param;
    _s();
    const activeTabKey = (0,react__rspack_import_1.useContext)(_Pimcore_modules_reports_reports_editor_reports_editor__rspack_import_12.ActiveReportTabContext);
    ...
    const handleSave = ()=>{
        ...
        const bundleCustomReportUpdateData = {
            ...currentData,
            ...(0,_Pimcore_modules_reports_reports_editor_components_report_configuration_helpers__rspack_import_18.normalizeIconFields)(currentData),
    ...
    const renderRefetchButton = ()=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_portal_portal__rspack_import_9.Portal, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_components_refetch_refetch__rspack_import_6.Refetch, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/report-configuration/report-configuration.tsx",
                lineNumber: 117,
                columnNumber: 7
            }, undefined)
        }, void 0, false, {
...
_s(ReportConfiguration, "XCaG/8x817Ta3qGEp4keYmJVCvQ=", false, function() {
    return [
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_toolbar_toolbar__rspack_import_3.Toolbar, {
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_components_refetch_refetch__rspack_import_4.Refetch, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/reports-sidebar/components/toolbar/toolbar.tsx",
                lineNumber: 25,
                columnNumber: 7
            }, undefined),
...
/* import */ var _Pimcore_components_search_input_search_input__rspack_import_7 = __webpack_require__("./js/src/core/components/search-input/search-input.tsx");
/* import */ var _Pimcore_modules_reports_reports_editor_components_reports_sidebar_components_toolbar_toolbar__rspack_import_8 = __webpack_require__("./js/src/core/modules/reports/reports-editor/components/reports-sidebar/components/toolbar/toolbar.tsx");
/* import */ var _Pimcore_components_modal_form_modal_hooks_use_form_modal__rspack_import_9 = __webpack_require__("./js/src/core/components/modal/form-modal/hooks/use-form-modal.tsx");
/* import */ var _Pimcore_modules_reports_reports_editor_hooks_use_report_actions__rspack_import_10 = __webpack_require__("./js/src/core/modules/reports/reports-editor/hooks/use-report-actions.ts");
/* import */ var _Pimcore_modules_reports_reports_editor_reports_editor_styles__rspack_import_11 = __webpack_require__("./js/src/core/modules/reports/reports-editor/reports-editor.styles.tsx");
/* import */ var _Pimcore_utils_type_utils__rspack_import_12 = __webpack_require__("./js/src/core/utils/type-utils.ts");
/* import */ var _Pimcore_modules_reports_utils_reports_loader__rspack_import_13 = __webpack_require__("./js/src/core/modules/reports/utils/reports-loader.ts");
/* import */ var _Pimcore_modules_reports_reports_editor_components_helpers__rspack_import_14 = __webpack_require__("./js/src/core/modules/reports/reports-editor/components/helpers.ts");
/* import */ var _Pimcore_components_tree_element_tree_element__rspack_import_15 = __webpack_require__("./js/src/core/components/tree-element/tree-element.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const ReportsSidebar = (param)=>{
    ...
    const flattenItems = (items)=>items.flatMap((item)=>(0,_Pimcore_modules_reports_reports_editor_components_helpers__rspack_import_14.isFolder)(item) ? item.children : [
                item
            ]);
    const findReportById = (items, id)=>flattenItems(items ?? []).find((report)=>report.id === id);
    (0,react__rspack_import_1.useEffect)(()=>{
    ...
    const { styles } = (0,_Pimcore_modules_reports_reports_editor_reports_editor_styles__rspack_import_11.useStyles)();
    const { t } = (0,react_i18next__rspack_import_3.useTranslation)();
    const modal = (0,_Pimcore_components_modal_form_modal_hooks_use_form_modal__rspack_import_9.useFormModal)();
    const { addReport, cloneReport, deleteReport } = (0,_Pimcore_modules_reports_reports_editor_hooks_use_report_actions__rspack_import_10.useReportActions)();
    const handleReportAdd = ()=>{
        modal.input({
            ...
            onOk: async (value)=>{
                ...
                const addedReport = findReportById(updatedData === null || updatedData === void 0 ? void 0 : updatedData.items, value);
                !(0,lodash__rspack_import_2.isUndefined)(addedReport) && handleOpenReport(addedReport);
            }
        });
    };
    const handleReportClone = (report)=>{
        modal.input({
            ...
            onOk: async (value)=>{
                ...
                const { data: updatedData } = await refetch();
                void (0,_Pimcore_modules_reports_utils_reports_loader__rspack_import_13.loadReportsMenuItems)();
                const clonedReport = findReportById(updatedData === null || updatedData === void 0 ? void 0 : updatedData.items, value);
    ...
    const handleSearch = (value)=>{
        if ((0,_Pimcore_utils_type_utils__rspack_import_12.isEmptyValue)(value)) {
            setReportsListData((reportsList === null || reportsList === void 0 ? void 0 : reportsList.items) ?? []);
            return;
        }
        const lowerValue = value.toLowerCase();
        const filteredItems = ((reportsList === null || reportsList === void 0 ? void 0 : reportsList.items) ?? []).reduce((acc, item)=>{
            if ((0,_Pimcore_modules_reports_reports_editor_components_helpers__rspack_import_14.isFolder)(item)) {
                const matchingChildren = item.children.filter((child)=>child.text.toLowerCase().includes(lowerValue));
    ...
    const buildTreeData = ()=>reportsListData.map((item)=>{
            if ((0,_Pimcore_modules_reports_reports_editor_components_helpers__rspack_import_14.isFolder)(item)) {
                return {
                    key: item.group,
                    title: item.group,
                    icon: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_icon__rspack_import_6.Icon, {
                        value: "folder"
                    }, void 0, false, {
                        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/reports-sidebar/reports-sidebar.tsx",
                        lineNumber: 150,
                        columnNumber: 15
                    }, undefined),
                    selectable: false,
    ...
    const handleActionsClick = (key, action, node)=>{
        var _node_meta;
        const report = (_node_meta = node.meta) === null || _node_meta === void 0 ? void 0 : _node_meta.report;
        if ((0,lodash__rspack_import_2.isNil)(report)) return;
        if (action === 'clone') {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_layout_content_layout__rspack_import_4.ContentLayout, {
        renderToolbar: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_reports_editor_components_reports_sidebar_components_toolbar_toolbar__rspack_import_8.Toolbar, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_content__rspack_import_5.Content, {
            ...
            padded: true,
            children: [
                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_search_input_search_input__rspack_import_7.SearchInput, {
                    onChange: (e)=>{
                ...
                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_content__rspack_import_5.Content, {
                    loading: isFetching,
                    children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_tree_element_tree_element__rspack_import_15.TreeElement, {
                        ...
                        onSelected: (_key, node)=>{
                            var _node_meta;
                            const report = (_node_meta = node.meta) === null || _node_meta === void 0 ? void 0 : _node_meta.report;
                            if (!(0,lodash__rspack_import_2.isNil)(report)) {
                                handleOpenReport(report);
                            }
                        },
                        treeData: buildTreeData(),
                        withCustomSwitcherIcon: true
                    }, void 0, false, {
                        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/components/reports-sidebar/reports-sidebar.tsx",
                        lineNumber: 192,
                        columnNumber: 11
...
_s(ReportsSidebar, "krAys/jMDhy2Qd6nrtjqIhpJriw=", false, function() {
    return [
        _Pimcore_modules_reports_reports_editor_reports_editor_styles__rspack_import_11.useStyles,
        react_i18next__rspack_import_3.useTranslation,
        _Pimcore_components_modal_form_modal_hooks_use_form_modal__rspack_import_9.useFormModal,
        _Pimcore_modules_reports_reports_editor_hooks_use_report_actions__rspack_import_10.useReportActions
    ];
});
_c = ReportsSidebar;
var _c;
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  ActiveReportTabContext: () => (ActiveReportTabContext),
...
/* import */ var _Pimcore_modules_reports_reports_editor_components_helpers__rspack_import_14 = __webpack_require__("./js/src/core/modules/reports/reports-editor/components/helpers.ts");
/* import */ var _reports_editor_styles__rspack_import_15 = __webpack_require__("./js/src/core/modules/reports/reports-editor/reports-editor.styles.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const ActiveReportTabContext = /*#__PURE__*/ (0,react__rspack_import_1.createContext)(undefined);
const ReportsEditor = ()=>{
    _s();
    ...
    const { styles } = (0,_reports_editor_styles__rspack_import_15.useStyles)();
    const tabItems = (0,react__rspack_import_1.useMemo)(()=>{
        var _reportsConfigTreeData_items;
        const existingReportIds = new Set(reportsConfigTreeData === null || reportsConfigTreeData === void 0 ? void 0 : (_reportsConfigTreeData_items = reportsConfigTreeData.items) === null || _reportsConfigTreeData_items === void 0 ? void 0 : _reportsConfigTreeData_items.flatMap((item)=>{
            var _item_children;
            return (0,_Pimcore_modules_reports_reports_editor_components_helpers__rspack_import_14.isFolder)(item) ? item === null || item === void 0 ? void 0 : (_item_children = item.children) === null || _item_children === void 0 ? void 0 : _item_children.map((child)=>child.id) : [
                item.id
            ];
        }));
        return openedReports.filter((report)=>existingReportIds.has(report.id)).map((report)=>({
                ...
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_reports_editor_components_report_configuration_report_configuration__rspack_import_9.ReportConfiguration, {
                    ...
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-editor/reports-editor.tsx",
                    lineNumber: 52,
                    columnNumber: 17
                }, undefined)
            }));
    ...
    const mainContent = ()=>{
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_layout_content_layout__rspack_import_4.ContentLayout, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(ActiveReportTabContext.Provider, {
                value: activeTabKey,
...
_s(ReportsEditor, "Nq11a1yjaijMzamSpEKNUf/yaS4=", false, function() {
    return [
        ...
        _reports_editor_styles__rspack_import_15.useStyles
    ];
});
_c = ReportsEditor;
var _c;
                        ...
                        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_3.Flex, {
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)("div", {
                                    ...
                                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-chart/components/bar-chart/bar-chart.tsx",
                                    lineNumber: 94,
                                    columnNumber: 13
                                }, undefined),
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_4.Flex, {
        ...
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)("div", {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-chart/components/legend-item/legend-item.tsx",
                lineNumber: 30,
                columnNumber: 7
            }, undefined),
                        ...
                        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_3.Flex, {
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)("div", {
                                    ...
                                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-chart/components/line-chart/line-chart.tsx",
                                    lineNumber: 93,
                                    columnNumber: 13
                                }, undefined),
                                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_3.Flex, {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)("div", {
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_ant_design_plots__rspack_import_8["default"], {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-chart/components/pie-chart/pie-chart.tsx",
                lineNumber: 99,
                columnNumber: 7
            }, undefined),
...
const ShowMoreBtn = (param)=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_3.Flex, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_text_button_icon_text_button__rspack_import_4.IconTextButton, {
            ...
            fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-chart/components/show-more-btn/show-more-btn.tsx",
            lineNumber: 23,
            columnNumber: 7
        }, undefined)
    }, void 0, false, {
...
const ReportChart = (param)=>{
    ...
    if ((0,lodash__rspack_import_2.isUndefined)(reportData) || (0,lodash__rspack_import_2.isUndefined)(chartData)) {
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_content__rspack_import_4.Content, {
            ...
            fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-chart/report-chart.tsx",
            lineNumber: 26,
            columnNumber: 12
        }, undefined);
    }
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_4.Flex, {
        ...
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_text_text__rspack_import_5.Text, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-detail/components/drill-down-select/drill-down-select.tsx",
                lineNumber: 57,
                columnNumber: 7
            }, undefined),
...
const ReportDetail = (param)=>{
    ...
    const handleSortingChange = (0,react__rspack_import_1.useCallback)((updatedSorting)=>{
    ...
    const handleElementOpen = (0,react__rspack_import_1.useCallback)((param)=>{
    ...
    const renderColumnActionCell = (0,react__rspack_import_1.useCallback)((param)=>{
        let { id, actionType } = param;
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_8.Flex, {
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_button_icon_button__rspack_import_15.IconButton, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-detail/report-detail.tsx",
                lineNumber: 114,
                columnNumber: 7
            }, undefined)
        }, void 0, false, {
    ...
    const getColumns = (0,react__rspack_import_1.useCallback)(()=>{
    ...
    const drillDownFields = (0,react__rspack_import_1.useMemo)(()=>{
        var _reportDetailData_columnConfigurations;
    ...
    const chartData = (0,react__rspack_import_1.useMemo)(()=>{
        var _chartDetailData_items;
        return chartDetailData === null || chartDetailData === void 0 ? void 0 : (_chartDetailData_items = chartDetailData.items) === null || _chartDetailData_items === void 0 ? void 0 : _chartDetailData_items.map((item)=>item.data);
    }, [
        chartDetailData
    ]);
    const fullChartData = (0,react__rspack_import_1.useMemo)(()=>{
        var _fullChartDataList_items;
        return fullChartDataList === null || fullChartDataList === void 0 ? void 0 : (_fullChartDataList_items = fullChartDataList.items) === null || _fullChartDataList_items === void 0 ? void 0 : _fullChartDataList_items.map((item)=>item.data);
    }, [
        fullChartDataList
    ]);
...
_s(ReportDetail, "5VCo8DvoLViCY+AwmWP0LuyNkJY=", false, function() {
    return [
...
/* import */ var _Pimcore_components_stack_list_stack_list__rspack_import_12 = __webpack_require__("./js/src/core/components/stack-list/stack-list.tsx");
/* import */ var _Pimcore_components_toolbar_toolbar__rspack_import_13 = __webpack_require__("./js/src/core/components/toolbar/toolbar.tsx");
/* import */ var _Pimcore_components_button_button__rspack_import_14 = __webpack_require__("./js/src/core/components/button/button.tsx");
/* import */ var _Pimcore_components_dropdown_dropdown__rspack_import_15 = __webpack_require__("./js/src/core/components/dropdown/dropdown.tsx");
/* import */ var _Pimcore_components_icon_text_button_icon_text_button__rspack_import_16 = __webpack_require__("./js/src/core/components/icon-text-button/icon-text-button.tsx");
/* import */ var _Pimcore_components_title_title__rspack_import_17 = __webpack_require__("./js/src/core/components/title/title.tsx");
/* import */ var _Pimcore_components_tooltip_tooltip__rspack_import_18 = __webpack_require__("./js/src/core/components/tooltip/tooltip.tsx");
/* import */ var _Pimcore_modules_reports_reports_view_reports_view_styles__rspack_import_19 = __webpack_require__("./js/src/core/modules/reports/reports-view/reports-view.styles.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const ColumnsConfiguration = ()=>{
    ...
    const handleRemoveColumn = (0,react__rspack_import_1.useCallback)((columnId)=>{
    ...
    const stackListItems = (0,react__rspack_import_1.useMemo)(()=>columns.map((column, index)=>{
            const stableId = column.id ?? `col-${index}`;
            return {
                id: stableId,
                sortable: true,
                meta: column,
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_tooltip_tooltip__rspack_import_18.Tooltip, {
                    title: column.header,
                    children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_tag_tag__rspack_import_9.Tag, {
                        ...
                        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-sidebar/components/columns-configuration/columns-configuration.tsx",
                        lineNumber: 68,
                        columnNumber: 11
                    }, undefined)
                }, void 0, false, {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_layout_content_layout__rspack_import_6.ContentLayout, {
        renderToolbar: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_toolbar_toolbar__rspack_import_13.Toolbar, {
            theme: "secondary",
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_button_button__rspack_import_14.Button, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_content__rspack_import_7.Content, {
            padded: true,
            children: [
                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_title_title__rspack_import_17.Title, {
                    ...
                    children: [
                        /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_8.Flex, {
                            ...
                            children: [
                                ...
                                stackListItems.length > 0 && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_stack_list_stack_list__rspack_import_12.StackList, {
                        ...
                        !(0,lodash__rspack_import_4.isEmpty)(addColumnMenu) && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_dropdown_dropdown__rspack_import_15.Dropdown, {
                            menu: {
                                items: addColumnMenu
                            },
                            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_text_button_icon_text_button__rspack_import_16.IconTextButton, {
...
_s(ColumnsConfiguration, "f3/fxBnAa9GAcWsYw1j0kHv3C54=", false, function() {
    return [
        ...
        renderToolbar: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_toolbar_toolbar__rspack_import_5.Toolbar, {
            ...
            children: [
                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_button_button__rspack_import_6.Button, {
                    ...
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-sidebar/components/columns-filters/columns-filters.tsx",
                    lineNumber: 57,
                    columnNumber: 11
                }, undefined),
                /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_button_button__rspack_import_6.Button, {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(react_jsx_dev_runtime__rspack_import_0.Fragment, {
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_title_title__rspack_import_6.Title, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-sidebar/components/columns-filters/components/field-filters/field-filters.tsx",
                lineNumber: 127,
                columnNumber: 7
            }, undefined),
...
const ColumnsFiltersProvider = (param)=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(ColumnsFiltersContext.Provider, {
        ...
        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-sidebar/components/columns-filters/context/columns-filters-context.tsx",
        lineNumber: 25,
        columnNumber: 10
    }, undefined);
};
...
const ReportSidebar = ()=>{
    ...
    const sidebarProps = (0,react__rspack_import_1.useMemo)(()=>{
        const entries = [
            {
                component: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_reports_view_components_report_sidebar_components_columns_configuration_columns_configuration__rspack_import_6.ColumnsConfiguration, {}, void 0, false, {
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-sidebar/report-sidebar.tsx",
                    lineNumber: 33,
                    columnNumber: 18
                }, undefined),
...
_s(ReportSidebar, "suPBm5/lVmB5jmNIP27UOmqq0xg=", false, function() {
    return [
        react_i18next__rspack_import_2.useTranslation,
...
/* import */ var _Pimcore_modules_execution_engine_jobs_download_csv_download_job__rspack_import_14 = __webpack_require__("./js/src/core/modules/execution-engine/jobs/download/csv-download-job.ts");
...
const ReportToolbar = (param)=>{
    ...
    const handleExportCSV = ()=>{
        const job = new _Pimcore_modules_execution_engine_jobs_download_csv_download_job__rspack_import_14.CsvDownloadJob({
            action: async ()=>{
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_8.Flex, {
            ...
            children: [
                isShowIcon && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_icon__rspack_import_7.Icon, {
                    ...
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-toolbar/report-toolbar.tsx",
                    lineNumber: 77,
                    columnNumber: 22
                }, _this),
                t(translationKey)
            ...
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_4.Flex, {
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_text_text__rspack_import_5.Text, {
                        ...
                        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-top-bar/report-top-bar.tsx",
                        lineNumber: 56,
                        columnNumber: 11
                    }, undefined),
...
const ReportViewContent = (param)=>{
    ...
    const renderMainContent = ()=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_content__rspack_import_11.Content, {
            ...
            children: isCurrentReportSelected ? /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_reports_view_components_report_detail_report_detail__rspack_import_12.ReportDetail, {
                ...
                fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/components/report-view-content/report-view-content.tsx",
                lineNumber: 69,
                columnNumber: 34
...
const ReportDataProvider = (param)=>{
    ...
    const resetData = (0,react__rspack_import_1.useCallback)(()=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(ReportDataContext.Provider, {
        ...
        fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/context/report-data-context.tsx",
        lineNumber: 51,
        columnNumber: 10
    }, undefined);
};
_s(ReportDataProvider, "xhHzkgQTunwRMdYE+XZw5gMMIZE=", false, function() {
    return [
        ...
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_grid_contexts_columns_context__rspack_import_3.ColumnsProvider, {
            children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_element_dynamic_types_registry_provider_dynamic_type_registry_provider__rspack_import_5.DynamicTypeRegistryProvider, {
                ...
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_reports_reports_view_reports_view__rspack_import_4.ReportsView, {
                    ...
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/reports-view-wrapper.tsx",
                    lineNumber: 25,
                    columnNumber: 11
                }, undefined)
            }, void 0, false, {
...
/* import */ var _Pimcore_modules_auth_permission_helper__rspack_import_12 = __webpack_require__("./js/src/core/modules/auth/permission-helper.ts");
/* import */ var _Pimcore_modules_auth_enums_user_permission__rspack_import_13 = __webpack_require__("./js/src/core/modules/auth/enums/user-permission.ts");
/* import */ var _Pimcore_utils_normalize_icon__rspack_import_14 = __webpack_require__("./js/src/core/utils/normalize-icon.ts");
/* import */ var _reports_view_styles__rspack_import_15 = __webpack_require__("./js/src/core/modules/reports/reports-view/reports-view.styles.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const ReportsView = (param)=>{
    ...
    const { isLoading: isReportsTreeLoading, data: reportsTreeData } = (0,_Pimcore_modules_reports_custom_reports_api_slice_enhanced__rspack_import_5.useCustomReportsGetTreeQuery)(undefined, {
        skip: !hasPermission
    });
    const { styles } = (0,_reports_view_styles__rspack_import_15.useStyles)();
    const renderOptionLabel = (iconClass, value)=>{
        const icon = (0,_Pimcore_utils_normalize_icon__rspack_import_14.normalizeIcon)(iconClass);
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_flex_flex__rspack_import_7.Flex, {
            align: "center",
            gap: "mini",
            children: [
                !(0,lodash__rspack_import_2.isUndefined)(icon === null || icon === void 0 ? void 0 : icon.value) && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_icon__rspack_import_8.Icon, {
                    ...icon
                }, void 0, false, {
                    fileName: "/var/www/2025.x/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/reports/reports-view/reports-view.tsx",
                    lineNumber: 43,
                    columnNumber: 39
                }, undefined),
...
_s(ReportsView, "IHqp0mW9DXgRHWEcFVCDqnsvBL8=", false, function() {
    return [
        ...
        _reports_view_styles__rspack_import_15.useStyles
    ];
});
_c = ReportsView;
var _c;
