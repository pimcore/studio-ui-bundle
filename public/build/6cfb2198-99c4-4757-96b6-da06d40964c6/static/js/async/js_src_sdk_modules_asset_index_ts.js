    ...
    const clearImageThumbnailContextMenuItem = (node, onFinish)=>{
        return {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_Pimcore_components_icon_icon__WEBPACK_IMPORTED_MODULE_2__.Icon, {
                ...
                fileName: "/Users/valeriia.maltseva/projects/pimcore/demo-enterprise/dev/pimcore/studio-ui-bundle/assets/js/src/core/modules/asset/actions/clear-thumbnails/use-clear-thumbnails.tsx",
                lineNumber: 42,
                columnNumber: 13
            }, undefined),
...
/* ESM import */var _Pimcore_components_element_tree_provider_tree_permission_provider_use_tree_permission__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./js/src/core/components/element-tree/provider/tree-permission-provider/use-tree-permission.ts");
...
const useUploadNewVersion = ()=>{
    ...
    const { isTreeActionAllowed } = (0,_Pimcore_components_element_tree_provider_tree_permission_provider_use_tree_permission__WEBPACK_IMPORTED_MODULE_9__.useTreePermission)();
    ...
    const uploadNewVersionContextMenuItem = (node, onFinish)=>{
        return {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_Pimcore_components_icon_icon__WEBPACK_IMPORTED_MODULE_3__.Icon, {
                ...
                fileName: "/Users/valeriia.maltseva/projects/pimcore/demo-enterprise/dev/pimcore/studio-ui-bundle/assets/js/src/core/modules/asset/actions/upload-new-version/upload-new-version.tsx",
                lineNumber: 76,
                columnNumber: 13
            }, undefined),
...
_s(useUploadNewVersion, "DKC4BzVZSZvyrAhvc1012Dx07PQ=", false, function() {
    return [
        ...
        _Pimcore_components_element_tree_provider_tree_permission_provider_use_tree_permission__WEBPACK_IMPORTED_MODULE_9__.useTreePermission
    ];
});
...
/* ESM import */var _Pimcore_app_api_pimcore_route__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./js/src/core/app/api/pimcore/route.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rsbuild/plugin-react/node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const useZipDownload = (props)=>{
    ...
    const createZipDownload = (param)=>{
        ...
        addJob((0,_Pimcore_modules_execution_engine_jobs_download_factory__WEBPACK_IMPORTED_MODULE_3__.createJob)({
            ...
            downloadUrl: `${(0,_Pimcore_app_api_pimcore_route__WEBPACK_IMPORTED_MODULE_15__.getPrefix)()}/assets/download/zip/{jobRunId}`,
            action: async ()=>{
                let promise;
                ...
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_14__.isUndefined)(response.error)) {
                    (0,_Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_12__["default"])(new _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_12__.ApiError(response.error));
                    throw new _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_12__.ApiError(response.error);
                }
                const data = response.data;
    ...
    const createZipDownloadContextMenuItem = (node, onFinish)=>{
        return {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_Pimcore_components_icon_icon__WEBPACK_IMPORTED_MODULE_6__.Icon, {
                ...
                fileName: "/Users/valeriia.maltseva/projects/pimcore/demo-enterprise/dev/pimcore/studio-ui-bundle/assets/js/src/core/modules/asset/actions/zip-download/use-zip-download.tsx",
                lineNumber: 77,
                columnNumber: 13
            }, undefined),
...
_s(useZipDownload, "OE7jK8OJh0eYB8XxdJGhibsz+ag=", false, function() {
    return [
...
const TAB_EMBEDDED_METADATA = {
    ...
    children: /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_Pimcore_modules_app_component_registry_component_renderer__WEBPACK_IMPORTED_MODULE_3__.ComponentRenderer, {
        ...
        fileName: "/Users/valeriia.maltseva/projects/pimcore/demo-enterprise/dev/pimcore/studio-ui-bundle/assets/js/src/core/modules/asset/editor/shared-tab-manager/tab-definitions.tsx",
        lineNumber: 18,
        columnNumber: 13
    }, undefined),
