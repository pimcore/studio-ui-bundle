/*! For license information please see __federation_expose__internal___mf_bootstrap.b9f789df.js.LICENSE.txt */
"use strict";(self["chunk_pimcore_studio_ui_bundle "]=self["chunk_pimcore_studio_ui_bundle "]||[]).push([["2108"],{55831(e,i,t){t.a(e,async function(a,n){try{t.r(i),t(14436);var m=t(72022),r=t(80323),p=t(21849),d=t(27755);e=t.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(t.bind(t,21849))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.f.loadPlugins(),r.f.initPlugins(),r.f.startupPlugins(),d.s.initModules(),(0,m.T)()}),n()}catch(e){n(e)}},1)},72022(e,i,t){t.d(i,{T:()=>B});var a=t(74848),n=t(47867),m=t(5338),r=t(64471),p=t(86569),d=t(52725),g=t(40595),o=t(35864),l=t(41630),s=t(39808),h=t(44241);let x=(0,h.createGlobalStyle)`
  * {
