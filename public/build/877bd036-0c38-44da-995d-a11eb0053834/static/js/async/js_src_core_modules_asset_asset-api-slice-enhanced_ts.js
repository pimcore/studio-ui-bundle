...
const api = _asset_api_slice_gen__WEBPACK_IMPORTED_MODULE_1__.api.enhanceEndpoints({
    ...
    endpoints: {
        ...
        assetGetGridConfigurationByFolderId: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.providingTags.ASSET_GRID_CONFIGURATION_DETAIL(args.configurationId)
        },
        assetGetGrid: {
        ...
        assetSaveGridConfiguration: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.invalidatingTags.ASSET_GRID_CONFIGURATION_LIST()
        },
        assetSetGridConfigurationAsFavorite: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.invalidatingTags.ASSET_GRID_CONFIGURATION_LIST()
        },
        assetUpdateGridConfiguration: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.invalidatingTags.ASSET_GRID_CONFIGURATION_DETAIL(args.configurationId)
        },
        assetDeleteGridConfigurationByConfigurationId: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.invalidatingTags.ASSET_GRID_CONFIGURATION_DETAIL(),
                    ..._Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.invalidatingTags.ASSET_GRID_CONFIGURATION_LIST()
                ]
        },
        assetGetSavedGridConfigurations: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__WEBPACK_IMPORTED_MODULE_0__.providingTags.ASSET_GRID_CONFIGURATION_LIST()
        }
    }
});
