...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  AddModal: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_sidebar_add_modal__rspack_import_14.AddModal),
  AddModalContext: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_sidebar_add_modal__rspack_import_14.AddModalContext),
  AddModalProvider: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_sidebar_add_modal__rspack_import_14.AddModalProvider),
  AreaContext: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_9.AreaContext),
  AreaProvider: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_9.AreaProvider),
  ...
  Editor: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor__rspack_import_8.Editor),
  ...
  FieldDefinitionSelectOptionsGrid: () => (/* reexport safe */ _Pimcore_modules_field_definitions_dynamic_types_components_field_definition_select_options_grid_field_definition_select_options_grid__rspack_import_15.FieldDefinitionSelectOptionsGrid),
  GeneralSettingsContext: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_13.GeneralSettingsContext),
  GeneralSettingsProvider: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_13.GeneralSettingsProvider),
  ItemsContext: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_11.ItemsContext),
  ItemsProvider: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_11.ItemsProvider),
  LayoutProvider: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_detail_layout_provider__rspack_import_12.LayoutProvider),
  SettingsContext: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_10.SettingsContext),
  SettingsProvider: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_10.SettingsProvider),
  ...
  useAddModal: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_sidebar_add_modal__rspack_import_14.useAddModal),
  useArea: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_9.useArea),
  useGeneralSettings: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_13.useGeneralSettings),
  useItems: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_11.useItems),
  useLayout: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_items_detail_layout_provider__rspack_import_12.useLayout),
  useSettings: () => (/* reexport safe */ _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_10.useSettings)
});
...
/* import */ var _Pimcore_modules_field_definitions_components_editor__rspack_import_8 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_area_provider__rspack_import_9 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/area-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_10 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/settings-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_provider__rspack_import_11 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_detail_layout_provider__rspack_import_12 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/detail/layout-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_detail_general_settings_provider__rspack_import_13 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/detail/general-settings-provider.tsx");
/* import */ var _Pimcore_modules_field_definitions_components_editor_items_sidebar_add_modal__rspack_import_14 = __webpack_require__("./js/src/core/modules/field-definitions/components/editor/items/sidebar/add-modal.tsx");
/* import */ var _Pimcore_modules_field_definitions_dynamic_types_components_field_definition_select_options_grid_field_definition_select_options_grid__rspack_import_15 = __webpack_require__("./js/src/core/modules/field-definitions/dynamic-types/components/field-definition-select-options-grid/field-definition-select-options-grid.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const ItemDetail = (props)=>{
    ...
    const [layout, setLayout] = (0,react__rspack_import_11.useState)(layoutResult === null || layoutResult === void 0 ? void 0 : layoutResult.data);
...
const ItemsSidebar = ()=>{
    ...
    const { useItemsQuery, useItemsDeleteMutation, AddModal } = (0,_Pimcore_modules_field_definitions_components_editor_settings_provider__rspack_import_5.useSettings)();
    ...
    const deleteConfiguration = (node)=>{
        ...
        deleteConfigurationMutation({
            ...
            (0,_sdk_modules_app__rspack_import_7.trackError)(new _sdk_modules_app__rspack_import_7.ApiError(err));
        });
    };
...
const useColumns = (value, onChange, autoWidth)=>{
    ...
    return (0,react__rspack_import_4.useMemo)(()=>[
            ...
            columnHelper.display({
                header: t('delete'),
                cell: (info)=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_1.Box, {
                        padding: "mini",
                        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_1.ButtonGroup, {
                            items: [
