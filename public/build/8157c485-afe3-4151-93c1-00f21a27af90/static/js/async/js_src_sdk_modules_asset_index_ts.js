...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  ActionColumnDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.ActionColumnDecorator),
  ArchiveTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_archive_tab_manager_archive_tab_manager__rspack_import_9.ArchiveTabManager),
  AssetApiSlice: () => (/* reexport module object */ _Pimcore_modules_asset_asset_api_slice_enhanced__rspack_import_21),
  AssetContext: () => (/* reexport safe */ _Pimcore_modules_asset_asset_provider__rspack_import_23.AssetContext),
  AssetListingBuilder: () => (/* reexport safe */ _Pimcore_modules_asset_listing_builder_asset_listing_builder__rspack_import_26.AssetListingBuilder),
  AssetProvider: () => (/* reexport safe */ _Pimcore_modules_asset_asset_provider__rspack_import_23.AssetProvider),
  AssetSaveDataContext: () => (/* reexport safe */ _Pimcore_modules_asset_services_processors_asset_save_data_processor_registry__rspack_import_4.AssetSaveDataContext),
  AssetSaveDataProcessorRegistry: () => (/* reexport safe */ _Pimcore_modules_asset_services_processors_asset_save_data_processor_registry__rspack_import_4.AssetSaveDataProcessorRegistry),
  AudioTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_audio_tab_manager_audio_tab_manager__rspack_import_10.AudioTabManager),
  BaseListing: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.BaseListing),
  ColumnConfigurationDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.ColumnConfigurationDecorator),
  ContextMenuDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.ContextMenuDecorator),
  DocumentTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_document_tab_manager_document_tab_manager__rspack_import_11.DocumentTabManager),
  FolderTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_folder_tab_manager_folder_tab_manager__rspack_import_12.FolderTabManager),
  GeneralFiltersDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.GeneralFiltersDecorator),
  ImageTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_image_tab_manager_image_tab_manager__rspack_import_13.ImageTabManager),
  InlineEditDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.InlineEditDecorator),
  ListingContainer: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.ListingContainer),
  MetadataApiSlice: () => (/* reexport module object */ _Pimcore_modules_asset_editor_shared_tab_manager_tabs_custom_metadata_metadata_api_slice_gen__rspack_import_8),
  PagingDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.PagingDecorator),
  RowSelectionDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.RowSelectionDecorator),
  SortingDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.SortingDecorator),
  TAB_CUSTOM_METADATA: () => (/* reexport safe */ _Pimcore_modules_asset_editor_shared_tab_manager_tab_definitions__rspack_import_7.TAB_CUSTOM_METADATA),
  TAB_EMBEDDED_METADATA: () => (/* reexport safe */ _Pimcore_modules_asset_editor_shared_tab_manager_tab_definitions__rspack_import_7.TAB_EMBEDDED_METADATA),
  TAB_VERSIONS: () => (/* reexport safe */ _Pimcore_modules_asset_editor_shared_tab_manager_tab_definitions__rspack_import_7.TAB_VERSIONS),
  TagFilterDecorator: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.TagFilterDecorator),
  TextTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_text_tab_manager_text_tab_manager__rspack_import_14.TextTabManager),
  UnknownTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_unknown_tab_manager_unknown_tab_manager__rspack_import_15.UnknownTabManager),
  VideoTabManager: () => (/* reexport safe */ _Pimcore_modules_asset_editor_types_video_tab_manager_video_tab_manager__rspack_import_16.VideoTabManager),
  addCustomMetadataToAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.addCustomMetadataToAsset),
  addImageSettingsToAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.addImageSettingsToAsset),
  addPropertyToAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.addPropertyToAsset),
  addScheduleToAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.addScheduleToAsset),
  assetReceived: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.assetReceived),
  assetsAdapter: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.assetsAdapter),
  listingDefaultProps: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.listingDefaultProps),
  removeAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.removeAsset),
  removeCustomMetadataFromAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.removeCustomMetadataFromAsset),
  removeCustomSettingsFromAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.removeCustomSettingsFromAsset),
  removeImageSettingFromAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.removeImageSettingFromAsset),
  removePropertyFromAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.removePropertyFromAsset),
  removeScheduleFromAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.removeScheduleFromAsset),
  resetAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.resetAsset),
  resetChanges: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.resetChanges),
  resetSchedulesChangesForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.resetSchedulesChangesForAsset),
  selectAssetById: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.selectAssetById),
  setActiveTabForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.setActiveTabForAsset),
  setCustomMetadataForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.setCustomMetadataForAsset),
  setCustomSettingsForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.setCustomSettingsForAsset),
  setModifiedCells: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.setModifiedCells),
  setPropertiesForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.setPropertiesForAsset),
  setSchedulesForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.setSchedulesForAsset),
  slice: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.slice),
  transformApiDataToNode: () => (/* reexport safe */ _Pimcore_modules_asset_tree_utils_transform_api_data_to_node__rspack_import_24.transformApiDataToNode),
  transformApiDataToNodes: () => (/* reexport safe */ _Pimcore_modules_asset_tree_utils_transform_api_data_to_node__rspack_import_24.transformApiDataToNodes),
  updateAllCustomMetadataForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updateAllCustomMetadataForAsset),
  updateCustomMetadataForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updateCustomMetadataForAsset),
  updateFilename: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updateFilename),
  updateImageSettingForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updateImageSettingForAsset),
  updatePropertyForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updatePropertyForAsset),
  updateScheduleForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updateScheduleForAsset),
  updateTextDataForAsset: () => (/* reexport safe */ _Pimcore_modules_asset_asset_draft_slice__rspack_import_22.updateTextDataForAsset),
  useAsset: () => (/* reexport safe */ _Pimcore_modules_asset_hooks_use_asset__rspack_import_17.useAsset),
  useAssetDraft: () => (/* reexport safe */ _Pimcore_modules_asset_hooks_use_asset_draft__rspack_import_18.useAssetDraft),
  useAssetHelper: () => (/* reexport safe */ _Pimcore_modules_asset_hooks_use_asset_helper__rspack_import_19.useAssetHelper),
  ...
  useCustomMetadataDraft: () => (/* reexport safe */ _Pimcore_modules_asset_draft_hooks_use_custom_metadata__rspack_import_5.useCustomMetadataDraft),
  useCustomMetadataReducers: () => (/* reexport safe */ _Pimcore_modules_asset_draft_hooks_use_custom_metadata__rspack_import_5.useCustomMetadataReducers),
  useDownload: () => (/* reexport safe */ _Pimcore_modules_asset_actions_download_use_download__rspack_import_1.useDownload),
  useGlobalAssetContext: () => (/* reexport safe */ _Pimcore_modules_asset_hooks_use_global_asset_context__rspack_import_20.useGlobalAssetContext),
  useImageSettingsDraft: () => (/* reexport safe */ _Pimcore_modules_asset_draft_hooks_use_image_settings__rspack_import_6.useImageSettingsDraft),
  useImageSettingsReducers: () => (/* reexport safe */ _Pimcore_modules_asset_draft_hooks_use_image_settings__rspack_import_6.useImageSettingsReducers),
  useInlineEditApiUpdate: () => (/* reexport safe */ _Pimcore_modules_asset_listing_listing_container__rspack_import_25.useInlineEditApiUpdate),
...
/* import */ var _Pimcore_modules_asset_services_processors_asset_save_data_processor_registry__rspack_import_4 = __webpack_require__("./js/src/core/modules/asset/services/processors/asset-save-data-processor-registry.ts");
/* import */ var _Pimcore_modules_asset_draft_hooks_use_custom_metadata__rspack_import_5 = __webpack_require__("./js/src/core/modules/asset/draft/hooks/use-custom-metadata.ts");
/* import */ var _Pimcore_modules_asset_draft_hooks_use_image_settings__rspack_import_6 = __webpack_require__("./js/src/core/modules/asset/draft/hooks/use-image-settings.ts");
/* import */ var _Pimcore_modules_asset_editor_shared_tab_manager_tab_definitions__rspack_import_7 = __webpack_require__("./js/src/core/modules/asset/editor/shared-tab-manager/tab-definitions.tsx");
/* import */ var _Pimcore_modules_asset_editor_shared_tab_manager_tabs_custom_metadata_metadata_api_slice_gen__rspack_import_8 = __webpack_require__("./js/src/core/modules/asset/editor/shared-tab-manager/tabs/custom-metadata/metadata-api-slice.gen.ts");
/* import */ var _Pimcore_modules_asset_editor_types_archive_tab_manager_archive_tab_manager__rspack_import_9 = __webpack_require__("./js/src/core/modules/asset/editor/types/archive/tab-manager/archive-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_audio_tab_manager_audio_tab_manager__rspack_import_10 = __webpack_require__("./js/src/core/modules/asset/editor/types/audio/tab-manager/audio-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_document_tab_manager_document_tab_manager__rspack_import_11 = __webpack_require__("./js/src/core/modules/asset/editor/types/document/tab-manager/document-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_folder_tab_manager_folder_tab_manager__rspack_import_12 = __webpack_require__("./js/src/core/modules/asset/editor/types/folder/tab-manager/folder-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_image_tab_manager_image_tab_manager__rspack_import_13 = __webpack_require__("./js/src/core/modules/asset/editor/types/image/tab-manager/image-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_text_tab_manager_text_tab_manager__rspack_import_14 = __webpack_require__("./js/src/core/modules/asset/editor/types/text/tab-manager/text-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_unknown_tab_manager_unknown_tab_manager__rspack_import_15 = __webpack_require__("./js/src/core/modules/asset/editor/types/unknown/tab-manager/unknown-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_editor_types_video_tab_manager_video_tab_manager__rspack_import_16 = __webpack_require__("./js/src/core/modules/asset/editor/types/video/tab-manager/video-tab-manager.ts");
/* import */ var _Pimcore_modules_asset_hooks_use_asset__rspack_import_17 = __webpack_require__("./js/src/core/modules/asset/hooks/use-asset.ts");
/* import */ var _Pimcore_modules_asset_hooks_use_asset_draft__rspack_import_18 = __webpack_require__("./js/src/core/modules/asset/hooks/use-asset-draft.ts");
/* import */ var _Pimcore_modules_asset_hooks_use_asset_helper__rspack_import_19 = __webpack_require__("./js/src/core/modules/asset/hooks/use-asset-helper.ts");
/* import */ var _Pimcore_modules_asset_hooks_use_global_asset_context__rspack_import_20 = __webpack_require__("./js/src/core/modules/asset/hooks/use-global-asset-context.ts");
/* import */ var _Pimcore_modules_asset_asset_api_slice_enhanced__rspack_import_21 = __webpack_require__("./js/src/core/modules/asset/asset-api-slice-enhanced.ts");
/* import */ var _Pimcore_modules_asset_asset_draft_slice__rspack_import_22 = __webpack_require__("./js/src/core/modules/asset/asset-draft-slice.tsx");
/* import */ var _Pimcore_modules_asset_asset_provider__rspack_import_23 = __webpack_require__("./js/src/core/modules/asset/asset-provider.tsx");
/* import */ var _Pimcore_modules_asset_tree_utils_transform_api_data_to_node__rspack_import_24 = __webpack_require__("./js/src/core/modules/asset/tree/utils/transform-api-data-to-node.ts");
/* import */ var _Pimcore_modules_asset_listing_listing_container__rspack_import_25 = __webpack_require__("./js/src/core/modules/asset/listing/listing-container.tsx");
/* import */ var _Pimcore_modules_asset_listing_builder_asset_listing_builder__rspack_import_26 = __webpack_require__("./js/src/core/modules/asset/listing/builder/asset-listing-builder.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
/* import */ var _Pimcore_components_element_tree_provider_tree_permission_provider_use_tree_permission__rspack_import_5 = __webpack_require__("./js/src/core/components/element-tree/provider/tree-permission-provider/use-tree-permission.ts");
/* import */ var _Pimcore_modules_perspectives_enums_tree_permission__rspack_import_6 = __webpack_require__("./js/src/core/modules/perspectives/enums/tree-permission.ts");
/* import */ var _Pimcore_modules_element_actions__rspack_import_7 = __webpack_require__("./js/src/core/modules/element/actions/index.ts");
/* import */ var _Pimcore_components_modal_upload_provider_upload_modal_provider_use_upload_modal_context__rspack_import_8 = __webpack_require__("./js/src/core/components/modal-upload/provider/upload-modal-provider/use-upload-modal-context.tsx");
/* import */ var _Pimcore_app_api_pimcore_route__rspack_import_9 = __webpack_require__("./js/src/core/app/api/pimcore/route.ts");
...
/* import */ var _sdk_app__rspack_import_11 = __webpack_require__("./js/src/sdk/app/index.ts");
/* import */ var _Pimcore_components_element_tree_element_tree_slice__rspack_import_12 = __webpack_require__("./js/src/core/components/element-tree/element-tree-slice.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const useUploadNewVersion = ()=>{
    ...
    const dispatch = (0,_sdk_app__rspack_import_11.useAppDispatch)();
    const { triggerUpload } = (0,_Pimcore_components_modal_upload_provider_upload_modal_provider_use_upload_modal_context__rspack_import_8.useUploadModalContext)();
    const { isTreeActionAllowed } = (0,_Pimcore_components_element_tree_provider_tree_permission_provider_use_tree_permission__rspack_import_5.useTreePermission)();
    const uploadNewVersion = (id, onFinish)=>{
        triggerUpload({
            action: `${(0,_Pimcore_app_api_pimcore_route__rspack_import_9.getPrefix)()}/assets/${id}/replace`,
            maxItems: 1,
            multiple: false,
            onSuccess: async (result)=>{
                var _result__response, _result_;
                if (!(0,lodash__rspack_import_10.isNil)(result === null || result === void 0 ? void 0 : (_result_ = result[0]) === null || _result_ === void 0 ? void 0 : (_result__response = _result_.response) === null || _result__response === void 0 ? void 0 : _result__response.data)) {
                    const newFilename = result[0].response.data;
                    dispatch((0,_Pimcore_components_element_tree_element_tree_slice__rspack_import_12.renameNode)({
                        nodeId: String(id),
                        elementType: 'asset',
    ...
    const uploadNewVersionContextMenuItem = (node, onFinish)=>{
        return {
            ...
            key: _Pimcore_modules_element_actions__rspack_import_7.ContextMenuActionName.uploadNewVersion,
            icon: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_icon__rspack_import_2.Icon, {
                value: 'upload-cloud'
            }, void 0, false, {
            ...
            hidden: node.type === 'folder' || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'list') || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'view') || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'publish') || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'versions'),
            onClick: ()=>{
    ...
    const uploadNewVersionTreeContextMenuItem = (node)=>{
        return {
            ...
            hidden: !isTreeActionAllowed(_Pimcore_modules_perspectives_enums_tree_permission__rspack_import_6.TreePermission.UploadNewVersion) || node.type === 'folder' || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'list') || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'view') || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'publish') || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_4.checkElementPermission)(node.permissions, 'versions'),
            onClick: ()=>{
...
_s(useUploadNewVersion, "IzxZ1nHck89ayYWuwKkMIuHifAU=", false, function() {
    return [
        ...
        _sdk_app__rspack_import_11.useAppDispatch,
        _Pimcore_components_modal_upload_provider_upload_modal_provider_use_upload_modal_context__rspack_import_8.useUploadModalContext,
        _Pimcore_components_element_tree_provider_tree_permission_provider_use_tree_permission__rspack_import_5.useTreePermission
    ];
});
...
/* import */ var _Pimcore_modules_execution_engine_jobs_download_download_job__rspack_import_2 = __webpack_require__("./js/src/core/modules/execution-engine/jobs/download/download-job.ts");
...
/* import */ var _Pimcore_modules_element_actions__rspack_import_11 = __webpack_require__("./js/src/core/modules/element/actions/index.ts");
...
/* import */ var _Pimcore_app_api_pimcore_route__rspack_import_13 = __webpack_require__("./js/src/core/app/api/pimcore/route.ts");
/* import */ var _Pimcore_modules_execution_engine_hooks_use_execution_engine__rspack_import_14 = __webpack_require__("./js/src/core/modules/execution-engine/hooks/use-execution-engine.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const useZipDownload = (props)=>{
    ...
    const executionEngine = (0,_Pimcore_modules_execution_engine_hooks_use_execution_engine__rspack_import_14.useExecutionEngine)();
    ...
    const createZipDownload = (param)=>{
        ...
        const job = new _Pimcore_modules_execution_engine_jobs_download_download_job__rspack_import_2.DownloadJob({
            title: t('jobs.zip-job.title', {
                title: jobTitle
            }),
            downloadUrl: `${(0,_Pimcore_app_api_pimcore_route__rspack_import_13.getPrefix)()}/assets/download/zip/{jobRunId}`,
            action: async ()=>{
                let promise;
                ...
                if (!(0,lodash__rspack_import_12.isUndefined)(response.error)) {
                    (0,_Pimcore_modules_app_error_handler__rspack_import_10["default"])(new _Pimcore_modules_app_error_handler__rspack_import_10.ApiError(response.error));
                    throw new _Pimcore_modules_app_error_handler__rspack_import_10.ApiError(response.error);
                }
    ...
    const createZipDownloadContextMenuItem = (node, onFinish)=>{
        return {
            ...
            key: _Pimcore_modules_element_actions__rspack_import_11.ContextMenuActionName.downloadAsZip,
            ...
            onClick: ()=>{
                createZipDownload({
                    jobTitle: (0,_Pimcore_modules_element_element_helper__rspack_import_7.getElementKey)(node, 'asset'),
                    requestData: {
                        body: {
                            folders: [
                                node.id
    ...
    const createZipDownloadTreeContextMenuItem = (node)=>{
        return {
            ...
            hidden: !isTreeActionAllowed(_Pimcore_modules_perspectives_enums_tree_permission__rspack_import_9.TreePermission.DownloadZip) || node.type !== 'folder' || !(0,_Pimcore_modules_element_permissions_permission_helper__rspack_import_6.checkElementPermission)(node.permissions, 'view'),
            onClick: ()=>{
                createZipDownload({
                    jobTitle: node.label,
                    requestData: {
...
_s(useZipDownload, "krOLnN9AuElNonhQdali1O2qQJ8=", false, function() {
    return [
        ...
        _Pimcore_modules_execution_engine_hooks_use_execution_engine__rspack_import_14.useExecutionEngine,
