...
const selectDocumentAreablockGroupedTypes = (0,_reduxjs_toolkit__rspack_import_1.createSelector)([
    ...
    return (0,lodash__rspack_import_2.mergeWith)({}, ...Object.values(editableTypeCollections), (objValue, srcValue)=>{
 ...
 */ const getAreablockTypeIcon = (icon, index)=>{
    if ((0,_Pimcore_utils_type_utils__rspack_import_0.isNonEmptyString)(icon)) {
...
const useAddDocument = (config)=>{
    ...
    const getDocumentEntries = (node)=>{
        ...
        } else if (!(0,lodash__rspack_import_7.isUndefined)(error) || (0,lodash__rspack_import_7.isNil)(documentTypes) || (0,lodash__rspack_import_7.isEmpty)(documentTypes.items)) {
...
const AreablockTypesList = ()=>{
    ...
    if (groupEntries.length === 1 && groupEntries[0][0] === _Pimcore_modules_element_dynamic_types_definitions_document_editable_types_dynamic_type_document_editable_areablock__rspack_import_10.DEFAULT_AREABLOCK_GROUP) {
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_box_box__rspack_import_6.Box, {
            ...
            children: types.map((type, typeIndex)=>/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_draggable_areablock_type_draggable_areablock_type__rspack_import_9.DraggableAreablockType, {
            ...
            return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_panel_panel__rspack_import_7.Panel, {
                ...
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_box_box__rspack_import_6.Box, {
                    ...
                    children: types.map((type, typeIndex)=>{
                        ...
                        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_draggable_areablock_type_draggable_areablock_type__rspack_import_9.DraggableAreablockType, {
...
/* import */ var react_i18next__rspack_import_2 = __webpack_require__("webpack/sharing/consume/default/react-i18next/react-i18next");
/* import */ var react_i18next__rspack_import_2_default = /*#__PURE__*/__webpack_require__.n(react_i18next__rspack_import_2);
/* import */ var _Pimcore_components_drag_and_drop_draggable__rspack_import_3 = __webpack_require__("./js/src/core/components/drag-and-drop/draggable.tsx");
/* import */ var _Pimcore_components_grid_button_grid_button__rspack_import_4 = __webpack_require__("./js/src/core/components/grid-button/grid-button.tsx");
/* import */ var _utils_icon_fallback__rspack_import_5 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/tabs/areablock-types/utils/icon-fallback.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const DraggableAreablockType = (param)=>{
    ...
    _s();
    const { t } = (0,react_i18next__rspack_import_2.useTranslation)();
    const iconConfig = (0,_utils_icon_fallback__rspack_import_5.getAreablockTypeIcon)(type.icon, globalIndex);
    const dragInfo = {
        type: 'areablock-type',
        icon: iconConfig,
        title: t(type.name),
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_drag_and_drop_draggable__rspack_import_3.Draggable, {
        info: dragInfo,
        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_grid_button_grid_button__rspack_import_4.GridButton, {
            icon: iconConfig,
            label: t(type.name)
        }, void 0, false, {
...
/* import */ var _Pimcore_components_input_number_input_number__rspack_import_7 = __webpack_require__("./js/src/core/components/input-number/input-number.tsx");
/* import */ var _Pimcore_components_sidebar_headline_sidebar_headline__rspack_import_8 = __webpack_require__("./js/src/core/components/sidebar-headline/sidebar-headline.tsx");
/* import */ var _Pimcore_modules_document_hooks_use_document_draft__rspack_import_9 = __webpack_require__("./js/src/core/modules/document/hooks/use-document-draft.ts");
/* import */ var _Pimcore_modules_document_actions_save_use_save__rspack_import_10 = __webpack_require__("./js/src/core/modules/document/actions/save/use-save.tsx");
...
/* import */ var _Pimcore_components_formatted_date_time_formatted_date_time__rspack_import_12 = __webpack_require__("./js/src/core/components/formatted-date-time/formatted-date-time.tsx");
/* import */ var _Pimcore_components_form_hooks_use_debounced_form_change__rspack_import_13 = __webpack_require__("./js/src/core/components/form/hooks/use-debounced-form-change.ts");
/* import */ var _Pimcore_modules_document_utils_document_debounce_tag__rspack_import_14 = __webpack_require__("./js/src/core/modules/document/utils/document-debounce-tag.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const DocumentConfigurationForm = (param)=>{
    ...
    _s();
    const { t } = (0,react_i18next__rspack_import_2.useTranslation)();
    const { updateSettingsData, document } = (0,_Pimcore_modules_document_hooks_use_document_draft__rspack_import_9.useDocumentDraft)(documentId);
    const { debouncedAutoSave } = (0,_Pimcore_modules_document_actions_save_use_save__rspack_import_10.useSave)();
    ...
    const handleFormChange = (0,react__rspack_import_1.useCallback)((changedValues, allValues)=>{
        ...
        if ('predefinedDocumentType' in changedValues && !(0,lodash__rspack_import_11.isNil)(changedValues.predefinedDocumentType)) {
            const selectedDocType = predefinedDocTypes.find((docType)=>docType.id === changedValues.predefinedDocumentType);
            if (!(0,lodash__rspack_import_11.isNil)(selectedDocType)) {
                form.setFieldsValue({
                    ...allValues,
    ...
    const { handleFormChange: handleFormChangeDebounced } = (0,_Pimcore_components_form_hooks_use_debounced_form_change__rspack_import_13.useDebouncedFormChange)(handleFormChange, {
        delay: 500,
        immediateFields: [
            'predefinedDocumentType',
            'staticGeneratorEnabled'
        ],
        tag: (0,_Pimcore_modules_document_utils_document_debounce_tag__rspack_import_14.createDocumentDebounceTag)(documentId)
    });
        ...
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)("span", {
            children: [
                t('document-configuration.last-generated', {
                    timestamp: (0,lodash__rspack_import_11.isNil)(lastGenerated) ? t('never') : ''
                }),
                !(0,lodash__rspack_import_11.isNil)(lastGenerated) && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_formatted_date_time_formatted_date_time__rspack_import_12.FormattedDateTime, {
            ...
            showStaticGenerator && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(react_jsx_dev_runtime__rspack_import_0.Fragment, {
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_form_form__rspack_import_4.Form.Item, {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_input_number_input_number__rspack_import_7.InputNumber, {
                            disabled: !canEdit,
                            min: 1,
                            step: 1
                        }, void 0, false, {
...
_s(DocumentConfigurationForm, "e7C9kpaMMpQO10HpnKxiD+jFXfc=", false, function() {
    return [
        react_i18next__rspack_import_2.useTranslation,
        _Pimcore_modules_document_hooks_use_document_draft__rspack_import_9.useDocumentDraft,
        _Pimcore_modules_document_actions_save_use_save__rspack_import_10.useSave,
        _Pimcore_components_form_form__rspack_import_4.Form.useForm,
        _Pimcore_components_form_hooks_use_debounced_form_change__rspack_import_13.useDebouncedFormChange
    ];
});
...
const DocumentConfigurationSidebar = ()=>{
    ...
    const { data: controllersData, isLoading: isLoadingControllers } = (0,_Pimcore_modules_document_document_api_slice_enhanced__rspack_import_8.useDocumentAvailableControllersListQuery)(undefined, {
        refetchOnMountOrArgChange: true
    });
    const { data: templatesData, isLoading: isLoadingTemplates } = (0,_Pimcore_modules_document_document_api_slice_enhanced__rspack_import_8.useDocumentAvailableTemplatesListQuery)(undefined, {
        refetchOnMountOrArgChange: true
    });
    const { data: predefinedDocTypesData, isLoading: isLoadingDocTypes } = (0,_Pimcore_modules_document_document_api_slice_enhanced__rspack_import_8.useDocumentDocTypeListQuery)({
    ...
    const isDataReady = !(0,lodash__rspack_import_9.isUndefined)(document) && !isLoadingControllers && !isLoadingTemplates && !isLoadingDocTypes;
    const apiData = {
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sdk_components__rspack_import_4.Content, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_box_box__rspack_import_5.Box, {
                ...
                children: isDataReady && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_document_configuration_form__rspack_import_10.DocumentConfigurationForm, {
                    apiData: apiData,
                    documentId: id,
                    ...
                    /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_space_space__rspack_import_7.Space, {
                        ...
                        children: [
                            ...
                            isDocumentType && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_button_icon_button__rspack_import_9.IconButton, {
                                ...
                                loading: isLoading,
                                onClick: ()=>{
                                    if (!(0,lodash__rspack_import_3.isNull)(url)) {
