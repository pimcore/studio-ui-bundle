    ...
    try {
        ...
        i18next__rspack_import_0_default().on('missingKey', (lngs, namespace, key, res)=>{
            try {
                ...
                i18next__rspack_import_0_default().addResource(currentLanguage, namespace, key, key);
                if (currentLanguage !== fallbackLanguage) {
                    i18next__rspack_import_0_default().addResource(fallbackLanguage, namespace, key, key);
                }
