...
const useReportFormState = ()=>{
    ...
    const markFormSaved = ()=>{
        if (!(0,lodash__rspack_import_1.isNull)(currentData)) {
            setInitialData({
                ...currentData
            });
        }
...
const useColumns = ()=>{
    ...
    return [
        columnHelper.accessor(_Pimcore_modules_reports_reports_editor_components_report_configuration_components_column_configuration_constants__rspack_import_4.COLUMN_KEYS.ROW_DRAG, {
            header: '',
            size: 40
        }),
...
const Permissions = (param)=>{
    ...
    const { data: roleList } = (0,_Pimcore_modules_user_roles_roles_api_slice_enhanced__rspack_import_5.useRoleGetCollectionQuery)();
    const { data: userList } = (0,_Pimcore_modules_user_user_api_slice_enhanced__rspack_import_6.useUserGetCollectionQuery)();
...
_s(Permissions, "vj+Xfro34WOGYd/urEq4LiNalqQ=", false, function() {
    return [
        ...
        _Pimcore_modules_user_roles_roles_api_slice_enhanced__rspack_import_5.useRoleGetCollectionQuery,
        _Pimcore_modules_user_user_api_slice_enhanced__rspack_import_6.useUserGetCollectionQuery
    ];
});
_c = Permissions;
var _c;
...
const ReportConfiguration = (param)=>{
    ...
    (0,react__rspack_import_1.useEffect)(()=>{
        if (!(0,lodash__rspack_import_2.isNull)(currentData) && !(0,lodash__rspack_import_2.isUndefined)(dataSourceConfig === null || dataSourceConfig === void 0 ? void 0 : dataSourceConfig.type)) {
            form.resetFields();
            updateFormData === null || updateFormData === void 0 ? void 0 : updateFormData({
                ...currentData,
    ...
    const handleReportAdd = ()=>{
        modal.input({
            ...
            onOk: async (value)=>{
                ...
                if (!(0,lodash__rspack_import_2.isUndefined)(addedReport)) {
                    handleOpenReport(addedReport);
                }
            }
        });
    };
    const handleReportClone = ()=>{
        modal.input({
            ...
            onOk: async (value)=>{
                ...
                if (!(0,lodash__rspack_import_2.isUndefined)(clonedReport)) {
                    handleOpenReport(clonedReport);
                }
            }
        });
    };
...
const FieldFilters = ()=>{
    ...
    const onFilterChange = (data)=>{
        ...
        if (!(0,lodash__rspack_import_4.isUndefined)(updatedColumnFilters)) {
            setColumnsFilters(updatedColumnFilters);
        }
    };
    (0,react__rspack_import_1.useEffect)(()=>{
        setFieldFilters([]);
