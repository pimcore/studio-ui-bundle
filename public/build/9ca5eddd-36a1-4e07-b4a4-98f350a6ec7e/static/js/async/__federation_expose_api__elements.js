...
__webpack_require__.d(__webpack_exports__, {
  ...
  useElementLockMutation: () => (useElementLockMutation),
  useElementResolveBySearchTermQuery: () => (useElementResolveBySearchTermQuery),
  useElementUnlockMutation: () => (useElementUnlockMutation),
  useLazyElementGetEditlockQuery: () => (useLazyElementGetEditlockQuery),
...
const api = _Pimcore_modules_element_element_api_slice_gen__rspack_import_0.api.enhanceEndpoints({
    addTagTypes: [
        ...
        _Pimcore_app_api_pimcore_tags__rspack_import_1.tagNames.ASSET_GRID,
        _Pimcore_app_api_pimcore_tags__rspack_import_1.tagNames.DATA_OBJECT_GRID
    ],
    endpoints: {
        elementDelete: {
...
const { useElementDeleteMutation, useElementGetDeleteInfoQuery, useElementFolderCreateMutation, useElementGetContextPermissionsQuery, useElementGetIdByPathQuery, useLazyElementGetIdByPathQuery, useElementGetSubtypeQuery, useElementResolveBySearchTermQuery, useLazyElementResolveBySearchTermQuery, useLazyElementGetEditlockQuery, useElementLockMutation, useElementUnlockMutation } = api;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  useElementGetContextPermissionsQuery: () => (useElementGetContextPermissionsQuery),
  useElementGetDeleteInfoQuery: () => (useElementGetDeleteInfoQuery),
  useElementGetEditlockQuery: () => (useElementGetEditlockQuery),
  useElementGetIdByPathQuery: () => (useElementGetIdByPathQuery),
  useElementGetSubtypeQuery: () => (useElementGetSubtypeQuery),
...
const injectedRtkApi = _sdk_api__rspack_import_0.api.enhanceEndpoints({
    ...
    endpoints: (build)=>({
            ...
            elementGetEditlock: build.query({
                query: (queryArg)=>({
...
__webpack_require__.d(__webpack_exports__, {
  ...
  useElementLockMutation: () => (/* reexport safe */ _Pimcore_modules_element_element_api_slice_enhanced__rspack_import_0.useElementLockMutation),
  ...
  useElementUnlockMutation: () => (/* reexport safe */ _Pimcore_modules_element_element_api_slice_enhanced__rspack_import_0.useElementUnlockMutation),
  useLazyElementGetEditlockQuery: () => (/* reexport safe */ _Pimcore_modules_element_element_api_slice_enhanced__rspack_import_0.useLazyElementGetEditlockQuery),
