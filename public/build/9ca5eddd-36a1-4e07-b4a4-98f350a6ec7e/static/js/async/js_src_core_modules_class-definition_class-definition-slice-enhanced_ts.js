 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["js_src_core_modules_class-definition_class-definition-slice-enhanced_ts"], {
"./js/src/core/modules/class-definition/class-definition-slice-enhanced.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  api: () => (api),
  useClassBulkExportAvailableQuery: () => (useClassBulkExportAvailableQuery),
  useClassBulkExportMutation: () => (useClassBulkExportMutation),
  useClassBulkImportDeleteFileMutation: () => (useClassBulkImportDeleteFileMutation),
  useClassBulkImportMutation: () => (useClassBulkImportMutation),
  useClassBulkImportPrepareMutation: () => (useClassBulkImportPrepareMutation),
  ...
  useClassDefinitionGetBrickFieldsQuery: () => (useClassDefinitionGetBrickFieldsQuery),
  ...
  useClassSelectOptionCreateMutation: () => (useClassSelectOptionCreateMutation),
  useClassSelectOptionDeleteMutation: () => (useClassSelectOptionDeleteMutation),
  useClassSelectOptionGetQuery: () => (useClassSelectOptionGetQuery),
  useClassSelectOptionGetTreeQuery: () => (useClassSelectOptionGetTreeQuery),
  useClassSelectOptionGetUsagesQuery: () => (useClassSelectOptionGetUsagesQuery),
  useClassSelectOptionUpdateMutation: () => (useClassSelectOptionUpdateMutation),
...
/* import */ var _class_definition_slice_gen__rspack_import_2 = __webpack_require__("./js/src/core/modules/class-definition/class-definition-slice.gen.ts");
...
const normalizeLayout = (raw)=>(0,_Pimcore_utils_normalize_icon__rspack_import_1.normalizeLayoutTreeIcons)(raw);
const normalizeCustomLayouts = (raw)=>({
        ...raw,
        layoutDefinition: raw.layoutDefinition !== null ? normalizeLayout(raw.layoutDefinition) : null
    });
/* eslint-disable max-lines */ const apiWithTags = _class_definition_slice_gen__rspack_import_2.api.enhanceEndpoints({
    addTagTypes: [
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DATA_OBJECT,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.DATA_OBJECT_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.CLASS_DEFINITION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.CLASS_DEFINITION_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.CLASS_DEFINITION_COLLECTION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.CUSTOM_LAYOUT,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.CUSTOM_LAYOUT_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.CUSTOM_LAYOUT_COLLECTION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.FIELD_COLLECTION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.FIELD_COLLECTION_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.FIELD_COLLECTION_COLLECTION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.OBJECT_BRICK,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.OBJECT_BRICK_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.OBJECT_BRICK_COLLECTION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.OBJECT_BRICK_CUSTOM_LAYOUT,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.OBJECT_BRICK_CUSTOM_LAYOUT_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.OBJECT_BRICK_CUSTOM_LAYOUT_COLLECTION,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.SELECT_OPTION_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.SELECT_OPTION_COLLECTION
    ],
    endpoints: {
        classDefinitionCollection: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.CLASS_DEFINITION_COLLECTION()
        },
        classDefinitionCollectionCreatable: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.CLASS_DEFINITION_COLLECTION()
        },
        classDefinitionGetById: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.CLASS_DEFINITION_DETAIL(args.id)
        },
        ...
        classCustomLayoutCollection: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.CUSTOM_LAYOUT_COLLECTION()
        },
        classDefinitionUpdate: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.CLASS_DEFINITION_COLLECTION(),
            async onQueryStarted (args, param) {
                let { dispatch, queryFulfilled } = param;
                try {
                    const { data } = await queryFulfilled;
                    dispatch(apiWithTags.util.updateQueryData('classDefinitionGetById', {
                        id: args.id
                    }, (draft)=>{
        ...
        classDefinitionDelete: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.CLASS_DEFINITION_DETAIL(args.id),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.CLASS_DEFINITION_COLLECTION()
                ]
        },
        ...
        classCustomLayoutGet: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.CUSTOM_LAYOUT_DETAIL(args.customLayoutId),
        ...
        classCustomLayoutUpdate: {
            ...
            async onQueryStarted (args, param) {
                ...
                try {
                    const { data } = await queryFulfilled;
                    dispatch(apiWithTags.util.updateQueryData('classCustomLayoutGet', {
        ...
        classCustomLayoutCreate: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.CUSTOM_LAYOUT_COLLECTION()
        },
        ...
        classCustomLayoutImport: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.CUSTOM_LAYOUT_DETAIL(args.customLayoutId),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.CUSTOM_LAYOUT_COLLECTION()
                ]
        },
        classCustomLayoutEditorCollection: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.DATA_OBJECT_DETAIL_ID(args.objectId)
        },
        ...
        classFieldCollectionCollection: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.FIELD_COLLECTION_COLLECTION()
        },
        classFieldCollectionGetByKey: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.FIELD_COLLECTION_DETAIL(args.key)
        },
        ...
        classFieldCollectionUpdate: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.FIELD_COLLECTION_COLLECTION(),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.FIELD_COLLECTION_DETAIL(args.key)
                ],
            async onQueryStarted (args, param) {
                let { dispatch, queryFulfilled } = param;
                try {
                    const { data } = await queryFulfilled;
                    dispatch(apiWithTags.util.updateQueryData('classFieldCollectionGetByKey', {
                        key: args.key
                    }, (draft)=>{
                        Object.assign(draft, data);
                    }));
        ...
        classFieldCollectionCreate: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.FIELD_COLLECTION_COLLECTION()
        },
        ...
        classObjectBrickCollection: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.OBJECT_BRICK_COLLECTION()
        },
        classObjectBrickGetByKey: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.OBJECT_BRICK_DETAIL(args.key)
        },
        ...
        classObjectBrickUpdate: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.OBJECT_BRICK_COLLECTION(),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.OBJECT_BRICK_DETAIL(args.key)
                ],
            async onQueryStarted (args, param) {
                let { dispatch, queryFulfilled } = param;
                try {
                    const { data } = await queryFulfilled;
                    dispatch(apiWithTags.util.updateQueryData('classObjectBrickGetByKey', {
                        key: args.key
                    }, (draft)=>{
                        Object.assign(draft, data);
                    }));
        ...
        classObjectBrickCreate: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.OBJECT_BRICK_COLLECTION()
        },
        ...
        classObjectBrickCustomLayoutGet: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.OBJECT_BRICK_CUSTOM_LAYOUT_DETAIL(args.key, args.customLayoutId),
            transformResponse: normalizeCustomLayouts
        },
        classObjectBrickCustomLayoutUpdate: {
            ...
            async onQueryStarted (args, param) {
                ...
                try {
                    const { data } = await queryFulfilled;
                    await dispatch(apiWithTags.util.upsertQueryData('classObjectBrickCustomLayoutGet', {
                        key: args.key,
                        customLayoutId: args.customLayoutId
                    }, data));
                } catch  {
        ...
        classObjectBrickCustomLayoutDelete: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.OBJECT_BRICK_CUSTOM_LAYOUT_COLLECTION(args.key)
        },
        ...
        classObjectBrickCustomLayoutImport: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.OBJECT_BRICK_CUSTOM_LAYOUT_DETAIL(args.key, args.customLayoutId),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.OBJECT_BRICK_CUSTOM_LAYOUT_COLLECTION(args.key)
                ]
        },
        classSelectOptionGetTree: {
            providesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.SELECT_OPTION_COLLECTION()
        },
        classSelectOptionGet: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.SELECT_OPTION_DETAIL(args.id)
        },
        classSelectOptionUpdate: {
            invalidatesTags: ()=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.SELECT_OPTION_COLLECTION(),
            async onQueryStarted (args, param) {
                let { dispatch, queryFulfilled } = param;
                try {
                    const { data } = await queryFulfilled;
                    dispatch(apiWithTags.util.updateQueryData('classSelectOptionGet', {
                        id: args.id
                    }, (draft)=>{
                        Object.assign(draft, data);
                    }));
        ...
        classBulkImportPrepare: (endpoint)=>{
...
const apiWithReadTransforms = apiWithTags.enhanceEndpoints({
    endpoints: {
        classFieldCollectionGetLayoutByKey: {
            transformResponse: (raw)=>(0,_Pimcore_utils_normalize_icon__rspack_import_1.normalizeLayoutTreeIcons)(raw)
        },
        classObjectBrickGetLayoutByKey: {
            transformResponse: (raw)=>(0,_Pimcore_utils_normalize_icon__rspack_import_1.normalizeLayoutTreeIcons)(raw)
        }
...
const denormalizeConfigurationOnQuery = (endpoint)=>{
    const originalQuery = endpoint.query;
    if (originalQuery === undefined) {
        return;
    }
    endpoint.query = (queryArg)=>{
        ...
        return {
            ...
            body: {
                ...body,
                configuration: (0,_Pimcore_utils_normalize_icon__rspack_import_1.denormalizeLayoutTreeIcons)(body.configuration)
            }
        };
    };
};
...
"./js/src/core/modules/class-definition/class-definition-slice.gen.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
const injectedRtkApi = _sdk_api__rspack_import_0.api.enhanceEndpoints({
    ...
    endpoints: (build)=>({
            ...
            classBulkExportAvailable: build.query({
                query: ()=>({
                        url: `/pimcore-studio/api/class/bulk-export/available`
                    }),
                providesTags: [
                    "Class Definition"
                ]
            }),
            classBulkExport: build.mutation({
                query: (queryArg)=>({
            ...
            classBulkImport: build.mutation({
                query: (queryArg)=>({
            ...
            classBulkImportPrepare: build.mutation({
                query: (queryArg)=>({
            ...
            classSelectOptionCreate: build.mutation({
                query: (queryArg)=>({
            ...
            classSelectOptionGet: build.query({
                query: (queryArg)=>({
            ...
            classSelectOptionUpdate: build.mutation({
                query: (queryArg)=>({
                        url: `/pimcore-studio/api/class/select-option/${queryArg.id}`,
                        method: "PUT",
            ...
            classSelectOptionDelete: build.mutation({
                query: (queryArg)=>({
                        url: `/pimcore-studio/api/class/select-option/${queryArg.id}`,
                        method: "DELETE"
                    }),
            ...
            classSelectOptionGetUsages: build.query({
                query: (queryArg)=>({
                        url: `/pimcore-studio/api/class/select-option/${queryArg.id}/usages`
                    }),
                providesTags: [
                    "Class Definition"
                ]
