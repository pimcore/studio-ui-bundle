 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["vendors-node_modules_codemirror_language_dist_index_js"], {
"./node_modules/@codemirror/language/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* import */ var _codemirror_state__rspack_import_3 = __webpack_require__("./node_modules/@codemirror/state/dist/index.js");
/* import */ var _codemirror_view__rspack_import_4 = __webpack_require__("./node_modules/@codemirror/view/dist/index.js");
/* import */ var _lezer_highlight__rspack_import_1 = __webpack_require__("./node_modules/@lezer/highlight/dist/index.js");
/* import */ var style_mod__rspack_import_2 = __webpack_require__("./node_modules/style-mod/src/style-mod.js");
...
function defineLanguageFacet(baseData) {
    return _codemirror_state__rspack_import_3.Facet.define({
...
class Language {
    ...
    */
    name = "") {
        ...
        if (!_codemirror_state__rspack_import_3.EditorState.prototype.hasOwnProperty("tree"))
            Object.defineProperty(_codemirror_state__rspack_import_3.EditorState.prototype, "tree", { get() { return syntaxTree(this); } });
        this.parser = parser;
        this.extension = [
            language.of(this),
            _codemirror_state__rspack_import_3.EditorState.languageData.of((state, pos, side) => {
...
@internal
*/
Language.setState = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define();
...
Language.state = /*@__PURE__*/_codemirror_state__rspack_import_3.StateField.define({
...
const parseWorker = /*@__PURE__*/_codemirror_view__rspack_import_4.ViewPlugin.fromClass(class ParseWorker {
    constructor(view) {
        this.view = view;
        this.working = null;
    ...
    checkAsyncSchedule(cx) {
        if (cx.scheduleOn) {
            ...
            cx.scheduleOn
                ...
                .catch(err => (0,_codemirror_view__rspack_import_4.logException)(this.view.state, err))
...
*/
const language = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(languages) { return languages.length ? languages[0] : null; },
    enables: language => [
        Language.state,
        parseWorker,
        _codemirror_view__rspack_import_4.EditorView.contentAttributes.compute([language], state => {
            let lang = state.facet(language);
...
service.
*/
const indentService = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
/**
Facet for overriding the unit by which indentation happens. Should
be a string consisting entirely of the same whitespace character.
When not set, this defaults to 2 spaces.
*/
const indentUnit = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine: values => {
        if (!values.length)
            return "  ";
        let unit = values[0];
...
function getIndentation(context, pos) {
    if (context instanceof _codemirror_state__rspack_import_3.EditorState)
...
class IndentContext {
    ...
    */
    countColumn(line, pos = line.length) {
        return (0,_codemirror_state__rspack_import_3.countColumn)(line, this.state.tabSize, pos);
    }
    /**
...
function indentOnInput() {
    return _codemirror_state__rspack_import_3.EditorState.transactionFilter.of(tr => {
...
can be found.
*/
const foldService = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
/**
...
*/
const foldEffect = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define({ map: mapRange });
/**
State effect that unfolds the given range (if it was folded).
*/
const unfoldEffect = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define({ map: mapRange });
...
state.
*/
const foldState = /*@__PURE__*/_codemirror_state__rspack_import_3.StateField.define({
    create() {
        return _codemirror_view__rspack_import_4.Decoration.none;
    },
    update(folded, tr) {
        ...
        for (let e of tr.effects) {
            if (e.is(foldEffect) && !foldExists(folded, e.value.from, e.value.to)) {
                ...
                let widget = !preparePlaceholder ? foldWidget :
                    _codemirror_view__rspack_import_4.Decoration.replace({ widget: new PreparedFoldWidget(preparePlaceholder(tr.state, e.value)) });
    ...
    provide: f => _codemirror_view__rspack_import_4.EditorView.decorations.from(f),
    toJSON(folded, state) {
        let ranges = [];
    ...
    fromJSON(value) {
        ...
        return _codemirror_view__rspack_import_4.Decoration.set(ranges, true);
    }
});
...
function foldedRanges(state) {
    return state.field(foldState, false) || _codemirror_state__rspack_import_3.RangeSet.empty;
}
...
function maybeEnable(state, other) {
    return state.field(foldState, false) ? other : other.concat(_codemirror_state__rspack_import_3.StateEffect.appendConfig.of(codeFolding()));
}
/**
...
function announceFold(view, range, fold = true) {
    ...
    return _codemirror_view__rspack_import_4.EditorView.announce.of(`${view.state.phrase(fold ? "Folded lines" : "Unfolded lines")} ${lineFrom} ${view.state.phrase("to")} ${lineTo}.`);
}
/**
...
const foldConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(values) { return (0,_codemirror_state__rspack_import_3.combineConfig)(values, defaultConfig); }
});
/**
...
const foldWidget = /*@__PURE__*/_codemirror_view__rspack_import_4.Decoration.replace({ widget: /*@__PURE__*/new class extends _codemirror_view__rspack_import_4.WidgetType {
        toDOM(view) { return widgetToDOM(view, null); }
    } });
class PreparedFoldWidget extends _codemirror_view__rspack_import_4.WidgetType {
    constructor(value) {
        super();
        this.value = value;
    }
...
class FoldMarker extends _codemirror_view__rspack_import_4.GutterMarker {
...
function foldGutter(config = {}) {
    ...
    let markers = _codemirror_view__rspack_import_4.ViewPlugin.fromClass(class {
        constructor(view) {
        ...
        buildMarkers(view) {
            let builder = new _codemirror_state__rspack_import_3.RangeSetBuilder();
    ...
    return [
        markers,
        (0,_codemirror_view__rspack_import_4.gutter)({
            class: "cm-foldGutter",
            markers(view) { var _a; return ((_a = view.plugin(markers)) === null || _a === void 0 ? void 0 : _a.markers) || _codemirror_state__rspack_import_3.RangeSet.empty; },
            initialSpacer() {
...
const baseTheme$1 = /*@__PURE__*/_codemirror_view__rspack_import_4.EditorView.baseTheme({
    ".cm-foldPlaceholder": {
        backgroundColor: "#eee",
...
class HighlightStyle {
    ...
    */
    specs, options) {
        ...
        let modSpec;
        function def(spec) {
            let cls = style_mod__rspack_import_2.StyleModule.newName();
        ...
        this.style = (0,_lezer_highlight__rspack_import_1.tagHighlighter)(specs.map(style => ({
            tag: style.tag,
            class: style.class || def(Object.assign({}, style, { tag: null }))
        })), {
            all,
        }).style;
        this.module = modSpec ? new style_mod__rspack_import_2.StyleModule(modSpec) : null;
...
const highlighterFacet = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const fallbackHighlighter = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
...
function syntaxHighlighting(highlighter, options) {
    ...
    if (highlighter instanceof HighlightStyle) {
        if (highlighter.module)
            ext.push(_codemirror_view__rspack_import_4.EditorView.styleModule.of(highlighter.module));
        themeType = highlighter.themeType;
    }
    if (options === null || options === void 0 ? void 0 : options.fallback)
        ext.push(fallbackHighlighter.of(highlighter));
    else if (themeType)
        ext.push(highlighterFacet.computeN([_codemirror_view__rspack_import_4.EditorView.darkTheme], state => {
            return state.facet(_codemirror_view__rspack_import_4.EditorView.darkTheme) == (themeType == "dark") ? [highlighter] : [];
        }));
    else
...
class TreeHighlighter {
    ...
    buildDeco(view, highlighters) {
        ...
        for (let { from, to } of view.visibleRanges) {
            (0,_lezer_highlight__rspack_import_1.highlightTree)(this.tree, highlighters, (from, to, style) => {
                builder.add(from, to, this.markCache[style] || (this.markCache[style] = _codemirror_view__rspack_import_4.Decoration.mark({ class: style })));
            }, from, to);
        }
        return builder.finish();
    }
}
const treeHighlighter = /*@__PURE__*/_codemirror_state__rspack_import_3.Prec.high(/*@__PURE__*/_codemirror_view__rspack_import_4.ViewPlugin.fromClass(TreeHighlighter, {
...
const defaultHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    { tag: _lezer_highlight__rspack_import_1.tags.meta,
        color: "#404740" },
    { tag: _lezer_highlight__rspack_import_1.tags.link,
        textDecoration: "underline" },
    { tag: _lezer_highlight__rspack_import_1.tags.heading,
        textDecoration: "underline",
        fontWeight: "bold" },
    { tag: _lezer_highlight__rspack_import_1.tags.emphasis,
        fontStyle: "italic" },
    { tag: _lezer_highlight__rspack_import_1.tags.strong,
        fontWeight: "bold" },
    { tag: _lezer_highlight__rspack_import_1.tags.strikethrough,
        textDecoration: "line-through" },
    { tag: _lezer_highlight__rspack_import_1.tags.keyword,
        color: "#708" },
    { tag: [_lezer_highlight__rspack_import_1.tags.atom, _lezer_highlight__rspack_import_1.tags.bool, _lezer_highlight__rspack_import_1.tags.url, _lezer_highlight__rspack_import_1.tags.contentSeparator, _lezer_highlight__rspack_import_1.tags.labelName],
        color: "#219" },
    { tag: [_lezer_highlight__rspack_import_1.tags.literal, _lezer_highlight__rspack_import_1.tags.inserted],
        color: "#164" },
    { tag: [_lezer_highlight__rspack_import_1.tags.string, _lezer_highlight__rspack_import_1.tags.deleted],
        color: "#a11" },
    { tag: [_lezer_highlight__rspack_import_1.tags.regexp, _lezer_highlight__rspack_import_1.tags.escape, /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.special(_lezer_highlight__rspack_import_1.tags.string)],
        color: "#e40" },
    { tag: /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.definition(_lezer_highlight__rspack_import_1.tags.variableName),
        color: "#00f" },
    { tag: /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.local(_lezer_highlight__rspack_import_1.tags.variableName),
        color: "#30a" },
    { tag: [_lezer_highlight__rspack_import_1.tags.typeName, _lezer_highlight__rspack_import_1.tags.namespace],
        color: "#085" },
    { tag: _lezer_highlight__rspack_import_1.tags.className,
        color: "#167" },
    { tag: [/*@__PURE__*/_lezer_highlight__rspack_import_1.tags.special(_lezer_highlight__rspack_import_1.tags.variableName), _lezer_highlight__rspack_import_1.tags.macroName],
        color: "#256" },
    { tag: /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.definition(_lezer_highlight__rspack_import_1.tags.propertyName),
        color: "#00c" },
    { tag: _lezer_highlight__rspack_import_1.tags.comment,
        color: "#940" },
    { tag: _lezer_highlight__rspack_import_1.tags.invalid,
        color: "#f00" }
]);

const baseTheme = /*@__PURE__*/_codemirror_view__rspack_import_4.EditorView.baseTheme({
    "&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
    "&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
});
const DefaultScanDist = 10000, DefaultBrackets = "()[]{}";
const bracketMatchingConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(configs) {
        return (0,_codemirror_state__rspack_import_3.combineConfig)(configs, {
            afterCursor: true,
...
const matchingMark = /*@__PURE__*/_codemirror_view__rspack_import_4.Decoration.mark({ class: "cm-matchingBracket" }), nonmatchingMark = /*@__PURE__*/_codemirror_view__rspack_import_4.Decoration.mark({ class: "cm-nonmatchingBracket" });
...
function bracketDeco(state) {
    ...
    return _codemirror_view__rspack_import_4.Decoration.set(decorations, true);
}
const bracketMatcher = /*@__PURE__*/_codemirror_view__rspack_import_4.ViewPlugin.fromClass(class {
    constructor(view) {
        this.paused = false;
...
function createTokenType(extra, tagStr) {
    ...
    for (let name of tagStr.split(" ")) {
        ...
        for (let part of name.split(".")) {
            let value = (extra[part] || _lezer_highlight__rspack_import_1.tags[part]);
            if (!value) {
    ...
    let type = byTag[key] = _lezer_common__rspack_import_0.NodeType.define({
        id: typeArray.length,
        name,
        props: [(0,_lezer_highlight__rspack_import_1.styleTags)({ [name]: tags$1 })]
    });
    typeArray.push(type);
    return type.id;
}
...
const alwaysIsolate = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({ combine: values => values.some(x => x) });
/**
Make sure nodes
...
const isolateMarks = /*@__PURE__*/_codemirror_view__rspack_import_4.ViewPlugin.fromClass(class {
    constructor(view) {
        this.always = view.state.facet(alwaysIsolate) ||
            view.textDirection != _codemirror_view__rspack_import_4.Direction.LTR ||
            view.state.facet(_codemirror_view__rspack_import_4.EditorView.perLineTextDirection);
        this.hasRTL = !this.always && textHasRTL(view.state.doc);
        this.tree = syntaxTree(view.state);
        this.decorations = this.always || this.hasRTL ? buildDeco(view, this.tree, this.always) : _codemirror_view__rspack_import_4.Decoration.none;
    }
    update(update) {
        let always = update.state.facet(alwaysIsolate) ||
            update.view.textDirection != _codemirror_view__rspack_import_4.Direction.LTR ||
            update.state.facet(_codemirror_view__rspack_import_4.EditorView.perLineTextDirection);
    ...
    provide: plugin => {
        function access(view) {
            var _a, _b;
            return (_b = (_a = view.plugin(plugin)) === null || _a === void 0 ? void 0 : _a.decorations) !== null && _b !== void 0 ? _b : _codemirror_view__rspack_import_4.Decoration.none;
        }
        return [_codemirror_view__rspack_import_4.EditorView.outerDecorations.of(access),
            _codemirror_state__rspack_import_3.Prec.lowest(_codemirror_view__rspack_import_4.EditorView.bidiIsolatedRanges.of(access))];
    }
});
function buildDeco(view, tree, always) {
    let deco = new _codemirror_state__rspack_import_3.RangeSetBuilder();
...
const marks = {
    rtl: /*@__PURE__*/_codemirror_view__rspack_import_4.Decoration.mark({ class: "cm-iso", inclusive: true, attributes: { dir: "rtl" }, bidiIsolate: _codemirror_view__rspack_import_4.Direction.RTL }),
    ltr: /*@__PURE__*/_codemirror_view__rspack_import_4.Decoration.mark({ class: "cm-iso", inclusive: true, attributes: { dir: "ltr" }, bidiIsolate: _codemirror_view__rspack_import_4.Direction.LTR }),
    auto: /*@__PURE__*/_codemirror_view__rspack_import_4.Decoration.mark({ class: "cm-iso", inclusive: true, attributes: { dir: "auto" }, bidiIsolate: null })
};
...
"./node_modules/@codemirror/state/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _marijn_find_cluster_break__rspack_import_0 = __webpack_require__("./node_modules/@marijn/find-cluster-break/src/index.js");
...
function findClusterBreak(str, pos, forward = true, includeExtending = true) {
    return (0,_marijn_find_cluster_break__rspack_import_0.findClusterBreak)(str, pos, forward, includeExtending);
}
...
"./node_modules/@codemirror/view/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  BidiSpan: () => (BidiSpan),
  BlockInfo: () => (BlockInfo),
...
/* import */ var _codemirror_state__rspack_import_3 = __webpack_require__("./node_modules/@codemirror/state/dist/index.js");
/* import */ var style_mod__rspack_import_0 = __webpack_require__("./node_modules/style-mod/src/style-mod.js");
/* import */ var w3c_keyname__rspack_import_1 = __webpack_require__("./node_modules/w3c-keyname/index.js");
/* import */ var crelt__rspack_import_2 = __webpack_require__("./node_modules/crelt/index.js");
...
@nonabstract
*/
class Decoration extends _codemirror_state__rspack_import_3.RangeValue {
    constructor(
    /**
    @internal
    */
    ...
    */
    static set(of, sort = false) {
        return _codemirror_state__rspack_import_3.RangeSet.of(of, sort);
    }
    /**
    @internal
    */
...
*/
Decoration.none = _codemirror_state__rspack_import_3.RangeSet.empty;
...
LineDecoration.prototype.mapMode = _codemirror_state__rspack_import_3.MapMode.TrackBefore;
...
class PointDecoration extends Decoration {
    constructor(spec, startSide, endSide, block, widget, isReplace) {
        ...
        this.mapMode = !block ? _codemirror_state__rspack_import_3.MapMode.TrackDel : startSide <= 0 ? _codemirror_state__rspack_import_3.MapMode.TrackBefore : _codemirror_state__rspack_import_3.MapMode.TrackAfter;
    }
...
*/
class BlockWrapper extends _codemirror_state__rspack_import_3.RangeValue {
...
function moveVisually(line, order, dir, start, forward) {
    ...
    let nextIndex = (0,_codemirror_state__rspack_import_3.findClusterBreak)(line.text, startIndex, span.forward(forward, dir));
    if (nextIndex < span.from || nextIndex > span.to)
        nextIndex = spanEnd;
    movedOver = line.text.slice(Math.min(startIndex, nextIndex), Math.max(startIndex, nextIndex));
    let nextSpan = spanI == (forward ? order.length - 1 : 0) ? null : order[spanI + (forward ? 1 : -1)];
    if (nextSpan && nextIndex == spanEnd && nextSpan.level + (forward ? 0 : 1) < span.level)
        return _codemirror_state__rspack_import_3.EditorSelection.cursor(nextSpan.side(!forward, dir) + line.from, nextSpan.forward(forward, dir) ? 1 : -1, nextSpan.level);
    return _codemirror_state__rspack_import_3.EditorSelection.cursor(nextIndex + line.from, span.forward(forward, dir) ? -1 : 1, span.level);
}
...
const clickAddsSelectionRange = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const dragMovesSelection$1 = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const mouseSelectionStyle = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const exceptionSink = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const updateListener = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const inputHandler = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const focusChangeEffect = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const clipboardInputFilter = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const clipboardOutputFilter = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const perLineTextDirection = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine: values => values.some(x => x)
});
const nativeSelectionHidden = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine: values => values.some(x => x)
});
const scrollHandler = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
class ScrollTarget {
    ...
    clip(state) {
        return this.range.to <= state.doc.length ? this :
            new ScrollTarget(_codemirror_state__rspack_import_3.EditorSelection.cursor(state.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
    }
}
const scrollIntoView = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define({ map: (t, ch) => t.map(ch) });
const setEditContextFormatting = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define();
/**
...
const editable = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({ combine: values => values.length ? values[0] : true });
let nextPluginID = 0;
const viewPlugin = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(plugins) {
...
const editorAttributes = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const contentAttributes = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
// Provide decorations
const decorations = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const blockWrappers = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const outerDecorations = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const atomicRanges = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const bidiIsolatedRanges = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
function getIsolatedRanges(view, line) {
    ...
    let result = [];
    _codemirror_state__rspack_import_3.RangeSet.spans(sets, line.from, line.to, {
        point() { },
...
const scrollMargins = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
...
const styleModule = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
class ChangedRange {
    ...
    */
    transactions) {
        ...
        */
        ...
        this.changes = _codemirror_state__rspack_import_3.ChangeSet.empty(this.startState.doc.length);
...
class WidgetTile extends Tile {
    ...
    get overrideDOMText() {
        if (!this.length)
            return _codemirror_state__rspack_import_3.Text.empty;
        let { root } = this;
        if (!root)
            return _codemirror_state__rspack_import_3.Text.empty;
...
class WidgetBufferTile extends Tile {
    ...
    get overrideDOMText() { return _codemirror_state__rspack_import_3.Text.empty; }
...
class TileUpdate {
    constructor(view, old, blockWrappers, decorations, disallowBlockEffectsFor) {
        ...
        this.builder = new TileBuilder(this.cache, new DocTile(view, view.contentDOM), _codemirror_state__rspack_import_3.RangeSet.iter(blockWrappers));
    ...
    emit(from, to) {
        ...
        let openEnd = _codemirror_state__rspack_import_3.RangeSet.spans(this.decorations, from, to, {
...
class DocView {
    ...
    coordsForChar(pos) {
        ...
        function scan(tile, offset) {
            if (tile.isComposite()) {
                ...
                let end = (0,_codemirror_state__rspack_import_3.findClusterBreak)(tile.text, offset);
                if (end == offset)
                    return null;
    ...
    updateDeco() {
        ...
        if (outerDeco.length) {
            ...
            allDeco.push(_codemirror_state__rspack_import_3.RangeSet.join(outerDeco));
        }
        this.decorations = [
...
function findChangedDeco(a, b, diff) {
    ...
    _codemirror_state__rspack_import_3.RangeSet.compare(a, b, diff, comp);
    return comp.changes;
}
...
function groupAt(state, pos, bias = 1) {
    ...
    if (line.length == 0)
        return _codemirror_state__rspack_import_3.EditorSelection.cursor(pos);
    if (linePos == 0)
        bias = 1;
    ...
    if (bias < 0)
        from = (0,_codemirror_state__rspack_import_3.findClusterBreak)(line.text, linePos, false);
    else
        to = (0,_codemirror_state__rspack_import_3.findClusterBreak)(line.text, linePos);
    let cat = categorize(line.text.slice(from, to));
    while (from > 0) {
        let prev = (0,_codemirror_state__rspack_import_3.findClusterBreak)(line.text, from, false);
        if (categorize(line.text.slice(prev, from)) != cat)
            break;
        from = prev;
    }
    while (to < line.length) {
        let next = (0,_codemirror_state__rspack_import_3.findClusterBreak)(line.text, to);
        if (categorize(line.text.slice(to, next)) != cat)
            break;
        to = next;
    }
    return _codemirror_state__rspack_import_3.EditorSelection.range(from + line.from, to + line.from);
}
function posAtCoordsImprecise(view, contentRect, block, x, y) {
    ...
    return block.from + (0,_codemirror_state__rspack_import_3.findColumn)(content, into, view.state.tabSize);
}
...
function moveToLineBoundary(view, start, forward, includeWrap) {
    ...
    if (coords) {
        ...
        if (pos != null)
            return _codemirror_state__rspack_import_3.EditorSelection.cursor(pos, forward ? -1 : 1);
    }
    return _codemirror_state__rspack_import_3.EditorSelection.cursor(forward ? line.to : line.from, forward ? -1 : 1);
}
...
function byGroup(view, pos, start) {
    ...
    return (next) => {
        ...
        if (cat == _codemirror_state__rspack_import_3.CharCategory.Space)
            cat = nextCat;
        return cat == nextCat;
    };
}
function moveVertically(view, start, forward, distance) {
    ...
    if (startPos == (forward ? view.state.doc.length : 0))
        return _codemirror_state__rspack_import_3.EditorSelection.cursor(startPos, start.assoc);
    ...
    for (let scan = 0;; scan += halfText) {
        ...
        if (forward ? y > rect.bottom : y < rect.top)
            return _codemirror_state__rspack_import_3.EditorSelection.cursor(pos.pos, pos.assoc);
        ...
        if (!posCoords || (forward ? mid > startY : mid < startY))
            return _codemirror_state__rspack_import_3.EditorSelection.cursor(pos.pos, pos.assoc, undefined, goal);
    }
}
...
function skipAtomsForSelection(atoms, sel) {
    ...
    for (let i = 0; i < sel.ranges.length; i++) {
        ...
        if (range.empty) {
            ...
            if (pos != range.from)
                updated = _codemirror_state__rspack_import_3.EditorSelection.cursor(pos, -1);
        }
        else {
            let from = skipAtomicRanges(atoms, range.from, -1);
            let to = skipAtomicRanges(atoms, range.to, 1);
            if (from != range.from || to != range.to)
                updated = _codemirror_state__rspack_import_3.EditorSelection.range(range.from == range.anchor ? from : to, range.from == range.head ? from : to);
        }
        if (updated) {
            if (!ranges)
    ...
    return ranges ? _codemirror_state__rspack_import_3.EditorSelection.create(ranges, sel.mainIndex) : sel;
}
function skipAtoms(view, oldPos, pos) {
    let newPos = skipAtomicRanges(view.state.facet(atomicRanges).map(f => f(view)), pos.from, oldPos.head > pos.from ? -1 : 1);
    return newPos == pos.from ? pos : _codemirror_state__rspack_import_3.EditorSelection.cursor(newPos, newPos < pos.from ? 1 : -1);
}
class PosAssoc {
...
class InlineCoordsScan {
    ...
    scanText(tile, offset) {
        let positions = [];
        for (let i = 0; i < tile.length; i = (0,_codemirror_state__rspack_import_3.findClusterBreak)(tile.text, i))
...
class DOMReader {
    constructor(points, view) {
        ...
        this.view = view;
        this.text = "";
        this.lineSeparator = view.state.facet(_codemirror_state__rspack_import_3.EditorState.lineSeparator);
    }
    append(text) {
        this.text += text;
    }
    ...
    constructor(view, start, end, typeOver) {
        ...
        if (view.state.readOnly && start > -1) {
            ...
            if (view.inputState.composing > -1 && curSel.ranges.length > 1) {
                this.newSel = curSel.replaceRange(_codemirror_state__rspack_import_3.EditorSelection.range(anchor, head));
            }
                ...
                this.newSel = _codemirror_state__rspack_import_3.EditorSelection.create([_codemirror_state__rspack_import_3.EditorSelection.cursor(head, assoc)]);
            }
            else {
                this.newSel = _codemirror_state__rspack_import_3.EditorSelection.single(anchor, head);
            }
        }
    }
}
...
function applyDOMChange(view, domChange) {
    ...
    if (domChange.bounds) {
        ...
        if (!sel.empty && sel.from >= from && sel.to <= to && (domChange.typeOver || cmp != domChange.text) &&
            ...
            change = { from: sel.from, to: sel.to,
                insert: _codemirror_state__rspack_import_3.Text.of(domChange.text.slice(sel.from - from, selEnd).split(LineBreakPlaceholder)) };
        }
            ...
            change = { from: from + diff.from, to: from + diff.toA,
                insert: _codemirror_state__rspack_import_3.Text.of(domChange.text.slice(diff.from, diff.toB).split(LineBreakPlaceholder)) };
        }
    }
    ...
    if ((browser.mac || browser.android) && change && change.from == change.to && change.from == sel.head - 1 &&
        ...
        if (newSel && change.insert.length == 2)
            newSel = _codemirror_state__rspack_import_3.EditorSelection.single(newSel.main.anchor - 1, newSel.main.head - 1);
        change = { from: change.from, to: change.to, insert: _codemirror_state__rspack_import_3.Text.of([change.insert.toString().replace(".", " ")]) };
    }
        ...
        if (newSel)
            newSel = _codemirror_state__rspack_import_3.EditorSelection.single(newSel.main.anchor - 1, newSel.main.head - 1);
        change = { from: sel.from, to: sel.to, insert: _codemirror_state__rspack_import_3.Text.of([" "]) };
    }
    if (change) {
...
function applyDefaultInsert(view, change, newSel) {
    ...
    if (inAtomic > -1) {
        tr = {
            changes: change,
            selection: _codemirror_state__rspack_import_3.EditorSelection.cursor(change.from + change.insert.length, -1)
        };
    }
            ...
            tr = startState.changeByRange(range => {
                ...
                return {
                    ...
                    range: !mainSel ? range.map(rangeChanges) :
                        _codemirror_state__rspack_import_3.EditorSelection.range(Math.max(0, mainSel.anchor + selOff), Math.max(0, mainSel.head + selOff))
                };
            });
        }
        else {
...
function selectionFromPoints(points, base) {
    ...
    return anchor > -1 && head > -1 ? _codemirror_state__rspack_import_3.EditorSelection.single(anchor + base, head + base) : null;
}
...
class MouseSelection {
    constructor(view, startEvent, style, mustSelect) {
        ...
        this.multiple = view.state.facet(_codemirror_state__rspack_import_3.EditorState.allowMultipleSelections) && addsSelectionRange(view, startEvent);
    ...
    if (linewise) {
        ...
        changes = state.changeByRange(range => {
            ...
            return { changes: { from: line.from, insert },
                range: _codemirror_state__rspack_import_3.EditorSelection.cursor(range.from + insert.length) };
        });
    }
    else if (byLine) {
        changes = state.changeByRange(range => {
            ...
            return { changes: { from: range.from, to: range.to, insert: line.text },
                range: _codemirror_state__rspack_import_3.EditorSelection.cursor(range.from + line.length) };
        });
    }
    else {
...
function rangeForClick(view, pos, bias, type) {
    if (type == 1) { // Single click
        return _codemirror_state__rspack_import_3.EditorSelection.cursor(pos, bias);
    }
        ...
        if (to < view.state.doc.length && to == line.to)
            to++;
        return _codemirror_state__rspack_import_3.EditorSelection.range(from, to);
    }
}
    ...
    return {
        ...
        get(event, extend, multiple) {
            ...
            if (start.pos != cur.pos && !extend) {
                ...
                range = from < range.from ? _codemirror_state__rspack_import_3.EditorSelection.range(from, to, range.assoc) : _codemirror_state__rspack_import_3.EditorSelection.range(to, from, range.assoc);
            }
            if (extend)
                ...
                return _codemirror_state__rspack_import_3.EditorSelection.create([range]);
        }
    };
}
function removeRangeAround(sel, pos) {
    for (let i = 0; i < sel.ranges.length; i++) {
        ...
        if (from <= pos && to >= pos)
            return _codemirror_state__rspack_import_3.EditorSelection.create(sel.ranges.slice(0, i).concat(sel.ranges.slice(i + 1)), sel.mainIndex == i ? 0 : sel.mainIndex - (sel.mainIndex > i ? 1 : 0));
    }
    return null;
}
    ...
    if (event.target.draggable) {
        ...
        if (tile && tile.isWidget()) {
            ...
            if (from >= range.to || to <= range.from)
                range = _codemirror_state__rspack_import_3.EditorSelection.range(from, to);
        }
    }
    let { inputState } = view;
...
const isFocusChange = /*@__PURE__*/_codemirror_state__rspack_import_3.Annotation.define();
...
class HeightOracle {
    constructor(lineWrapping) {
        ...
        this.doc = _codemirror_state__rspack_import_3.Text.empty;
        this.heightSamples = {};
...
class NodeBuilder {
    ...
    static build(oracle, decorations, from, to) {
        ...
        _codemirror_state__rspack_import_3.RangeSet.spans(decorations, from, to, builder, 0);
        return builder.finish(from);
    }
}
function heightRelevantDecoChanges(a, b, diff) {
    let comp = new DecorationComparator;
    _codemirror_state__rspack_import_3.RangeSet.compare(a, b, diff, comp, 0);
    return comp.changes;
}
...
class ViewState {
    constructor(view, state) {
        ...
        this.heightMap = HeightMap.empty().applyChanges(this.stateDeco, _codemirror_state__rspack_import_3.Text.empty, this.heightOracle.setDoc(state.doc), [new ChangedRange(0, 0, 0, state.doc.length)]);
        for (let i = 0; i < 2; i++) {
    ...
    update(update, scrollTarget = null) {
        ...
        let heightChanges = ChangedRange.extendWithRanges(contentChanges, heightRelevantDecoChanges(prevDeco, this.stateDeco, update ? update.changes : _codemirror_state__rspack_import_3.ChangeSet.empty(this.state.doc.length)));
    ...
    measure() {
        ...
        if (measureContent) {
            ...
            for (let vp of this.viewports) {
                ...
                this.heightMap = (refresh ? HeightMap.empty().applyChanges(this.stateDeco, _codemirror_state__rspack_import_3.Text.empty, this.heightOracle, [new ChangedRange(0, 0, 0, view.state.doc.length)]) : this.heightMap).updateHeight(oracle, 0, refresh, new MeasuredHeights(vp.from, heights));
            }
            if (heightChangeFlag)
        ...
        let addGap = (from, to, line, structure) => {
            ...
            if (!gap) {
                ...
                if (to < line.to && mayMeasure && wrapping &&
                    ...
                    let lineStart = mayMeasure.moveToLineBoundary(_codemirror_state__rspack_import_3.EditorSelection.cursor(to), false, true).head;
                    if (lineStart > from)
                        to = lineStart;
                }
    ...
    computeVisibleRanges(changes) {
        ...
        let ranges = [];
        _codemirror_state__rspack_import_3.RangeSet.spans(deco, this.viewport.from, this.viewport.to, {
...
function lineStructure(from, to, stateDeco) {
    ...
    _codemirror_state__rspack_import_3.RangeSet.spans(stateDeco, from, to, {
        span() { },
        point(from, to) {
            if (from > pos) {
...
function staticDeco(state) {
    ...
    if (outer.length)
        deco.push(_codemirror_state__rspack_import_3.RangeSet.join(outer));
    return deco;
}
...
const theme = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({ combine: strs => strs.join(" ") });
const darkTheme = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({ combine: values => values.indexOf(true) > -1 });
const baseThemeID = /*@__PURE__*/style_mod__rspack_import_0.StyleModule.newName(), baseLightID = /*@__PURE__*/style_mod__rspack_import_0.StyleModule.newName(), baseDarkID = /*@__PURE__*/style_mod__rspack_import_0.StyleModule.newName();
const lightDarkIDs = { "&light": "." + baseLightID, "&dark": "." + baseDarkID };
function buildTheme(main, spec, scopes) {
    return new style_mod__rspack_import_0.StyleModule(spec, {
        finish(sel) {
...
class EditContextManager {
    constructor(view) {
        ...
        this.handlers.textupdate = e => {
            ...
            if (!diff) {
                let newSel = _codemirror_state__rspack_import_3.EditorSelection.single(this.toEditorPos(e.selectionStart), this.toEditorPos(e.selectionEnd));
                if (!sameSelPos(newSel, main))
                    view.dispatch({ selection: newSel, userEvent: "select" });
                return;
            }
            let change = { from: diff.from + from, to: diff.toA + from,
                insert: _codemirror_state__rspack_import_3.Text.of(e.text.slice(diff.from, diff.toB).split("\n")) };
            if ((browser.mac || browser.android) && change.from == head - 1 &&
                /^\. ?$/.test(e.text) && view.contentDOM.getAttribute("autocorrect") == "off")
                change = { from, to, insert: _codemirror_state__rspack_import_3.Text.of([e.text.replace(".", " ")]) };
            this.pendingContextChange = change;
            if (!view.state.readOnly) {
                let newLen = this.to - this.from + (change.to - change.from + change.insert.length);
                applyDOMChangeInner(view, change, _codemirror_state__rspack_import_3.EditorSelection.single(this.toEditorPos(e.selectionStart, newLen), this.toEditorPos(e.selectionEnd, newLen)));
            }
...
class EditorView {
    ...
    */
    constructor(config = {}) {
        ...
        */
        ...
        this.viewState = new ViewState(this, config.state || _codemirror_state__rspack_import_3.EditorState.create(config));
    ...
    dispatch(...input) {
        let trs = input.length == 1 && input[0] instanceof _codemirror_state__rspack_import_3.Transaction ? input
    ...
    */
    update(transactions) {
        ...
        if (state.facet(_codemirror_state__rspack_import_3.EditorState.phrases) != this.state.facet(_codemirror_state__rspack_import_3.EditorState.phrases))
        ...
        try {
            ...
            for (let tr of transactions) {
                ...
                if (tr.scrollIntoView) {
                    ...
                    scrollTarget = new ScrollTarget(main.empty ? main : _codemirror_state__rspack_import_3.EditorSelection.cursor(main.head, main.head > main.anchor ? -1 : 1));
                }
                for (let e of tr.effects)
    ...
    */
    ...
    mountStyles() {
        ...
        style_mod__rspack_import_0.StyleModule.mount(this.root, this.styleModules.concat(baseTheme$1).reverse(), nonce ? { nonce } : undefined);
    }
    readMeasured() {
    ...
    */
    visualLineSide(line, end) {
        ...
        return _codemirror_state__rspack_import_3.EditorSelection.cursor(span.side(end, dir) + line.from, span.forward(!end, dir) ? 1 : -1);
    }
    /**
    ...
    */
    static scrollIntoView(pos, options = {}) {
        return scrollIntoView.of(new ScrollTarget(typeof pos == "number" ? _codemirror_state__rspack_import_3.EditorSelection.cursor(pos) : pos, options.y, options.x, options.yMargin, options.xMargin));
    }
    /**
    ...
    */
    scrollSnapshot() {
        ...
        return scrollIntoView.of(new ScrollTarget(_codemirror_state__rspack_import_3.EditorSelection.cursor(ref.from), "start", "start", ref.top - scrollTop, scrollLeft, true));
    }
    /**
    ...
    */
    static theme(spec, options) {
        let prefix = style_mod__rspack_import_0.StyleModule.newName();
    ...
    */
    static baseTheme(spec) {
        return _codemirror_state__rspack_import_3.Prec.lowest(styleModule.of(buildTheme("." + baseThemeID, spec, lightDarkIDs)));
    }
    /**
...
*/
EditorView.cspNonce = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({ combine: values => values.length ? values[0] : "" });
/**
...
search match).
*/
EditorView.announce = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define();
...
const handleKeyEvents = /*@__PURE__*/_codemirror_state__rspack_import_3.Prec["default"](/*@__PURE__*/EditorView.domEventHandlers({
    keydown(event, view) {
...
*/
const keymap = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({ enables: handleKeyEvents });
...
function runHandlers(map, event, view, scope) {
    ...
    let charCode = (0,_codemirror_state__rspack_import_3.codePointAt)(name, 0), isChar = (0,_codemirror_state__rspack_import_3.codePointSize)(charCode) == name.length && name != " ";
    ...
    if (scopeObj) {
        if (runFor(scopeObj[prefix + modifiers(name, event, !isChar)])) {
            ...
            (baseName = w3c_keyname__rspack_import_1.base[event.keyCode]) && baseName != name) {
            if (runFor(scopeObj[prefix + modifiers(baseName, event, true)])) {
                handled = true;
            }
            else if (event.shiftKey && (shiftName = w3c_keyname__rspack_import_1.shift[event.keyCode]) != name && shiftName != baseName &&
...
const layerOrder = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
/**
Define a layer.
*/
...
const selectionConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(configs) {
        return (0,_codemirror_state__rspack_import_3.combineConfig)(configs, {
    ...
    markers(view) {
        ...
        for (let r of state.selection.ranges) {
            ...
            if (r.empty || conf.drawRangeCursor && !(prim && browser.ios && conf.iosSelectionHandles)) {
                ...
                let cursor = r.empty ? r : _codemirror_state__rspack_import_3.EditorSelection.cursor(r.head, r.assoc);
...
const selectionLayer = /*@__PURE__*/layer({
    ...
    markers(view) {
        ...
        if (browser.ios && !main.empty && view.state.facet(selectionConfig).iosSelectionHandles) {
            for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-start", _codemirror_state__rspack_import_3.EditorSelection.cursor(main.from, 1)))
                markers.push(piece);
            for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-end", _codemirror_state__rspack_import_3.EditorSelection.cursor(main.to, 1)))
                markers.push(piece);
        }
        return markers;
    },
...
const hideNativeSelection = /*@__PURE__*/_codemirror_state__rspack_import_3.Prec.highest(/*@__PURE__*/EditorView.theme({
    ".cm-line": {
...
const setDropCursorPos = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define({
    map(pos, mapping) { return pos == null ? null : mapping.mapPos(pos); }
});
const dropCursorPos = /*@__PURE__*/_codemirror_state__rspack_import_3.StateField.define({
    create() { return null; },
    update(pos, tr) {
        if (pos != null)
...
class MatchDecorator {
    ...
    */
    createDeco(view) {
        let build = new _codemirror_state__rspack_import_3.RangeSetBuilder(), add = build.add.bind(build);
...
const specialCharConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(configs) {
        let config = (0,_codemirror_state__rspack_import_3.combineConfig)(configs, {
            render: null,
        ...
        makeDecorator(conf) {
            return new MatchDecorator({
                ...
                decoration: (m, view, pos) => {
                    let { doc } = view.state;
                    let code = (0,_codemirror_state__rspack_import_3.codePointAt)(m[0], 0);
                    if (code == 9) {
                        let line = doc.lineAt(pos);
                        let size = view.state.tabSize, col = (0,_codemirror_state__rspack_import_3.countColumn)(line.text, size, pos - line.from);
                        return Decoration.replace({
    ...
    if (a.off > MaxOff || b.off > MaxOff || a.col < 0 || b.col < 0) {
        ...
        for (let i = startLine; i <= endLine; i++) {
            ...
            if (line.length <= endOff)
                ranges.push(_codemirror_state__rspack_import_3.EditorSelection.range(line.from + startOff, line.to + endOff));
        }
    }
    else {
        ...
        for (let i = startLine; i <= endLine; i++) {
            let line = state.doc.line(i);
            let start = (0,_codemirror_state__rspack_import_3.findColumn)(line.text, startCol, state.tabSize, true);
            if (start < 0) {
                ranges.push(_codemirror_state__rspack_import_3.EditorSelection.cursor(line.to));
            }
            else {
                let end = (0,_codemirror_state__rspack_import_3.findColumn)(line.text, endCol, state.tabSize);
                ranges.push(_codemirror_state__rspack_import_3.EditorSelection.range(line.from + start, line.from + end));
            }
        }
    }
    return ranges;
...
function getPos(view, event) {
    ...
    let col = off > MaxOff ? -1
        : off == line.length ? absoluteColumn(view, event.clientX)
            : (0,_codemirror_state__rspack_import_3.countColumn)(line.text, view.state.tabSize, offset - line.from);
    ...
    return {
        ...
        get(event, _extend, multiple) {
            ...
            if (!ranges.length)
                return startSel;
            if (multiple)
                return _codemirror_state__rspack_import_3.EditorSelection.create(ranges.concat(startSel.ranges));
            else
                return _codemirror_state__rspack_import_3.EditorSelection.create(ranges);
        }
    };
}
/**
...
const tooltipConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine: values => {
        var _a, _b, _c;
        return ({
...
*/
const showTooltip = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    enables: [tooltipPlugin, baseTheme]
});
const showHoverTooltip = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
...
function hoverTooltip(source, options = {}) {
    let setHover = _codemirror_state__rspack_import_3.StateEffect.define();
    let hoverState = _codemirror_state__rspack_import_3.StateField.define({
        create() { return []; },
        update(value, tr) {
            if (value.length) {
                ...
                if (tr.docChanged) {
                    ...
                    for (let tooltip of value) {
                        let newPos = tr.changes.mapPos(tooltip.pos, -1, _codemirror_state__rspack_import_3.MapMode.TrackDel);
                        if (newPos != null) {
...
const closeHoverTooltipEffect = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define();
/**
...
const panelConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(configs) {
...
*/
const showPanel = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    enables: panelPlugin
});
...
function showDialog(view, config) {
    ...
    if (view.state.field(dialogField, false)) {
        ...
        view.dispatch({ effects: _codemirror_state__rspack_import_3.StateEffect.appendConfig.of(dialogField.init(() => [panelCtor])) });
    }
...
const dialogField = /*@__PURE__*/_codemirror_state__rspack_import_3.StateField.define({
    create() { return []; },
    update(dialogs, tr) {
        for (let e of tr.effects) {
...
const openDialogEffect = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define();
const closeDialogEffect = /*@__PURE__*/_codemirror_state__rspack_import_3.StateEffect.define();
function createDialog(view, config, result) {
    let content = config.content ? config.content(view, () => done(null)) : null;
    if (!content) {
        content = (0,crelt__rspack_import_2["default"])("form");
        if (config.input) {
            let input = (0,crelt__rspack_import_2["default"])("input", config.input);
            if (/^(text|password|number|email|tel|url)$/.test(input.type))
                input.classList.add("cm-textfield");
            if (!input.name)
                input.name = "input";
            content.appendChild((0,crelt__rspack_import_2["default"])("label", (config.label || "") + ": ", input));
        }
        else {
            content.appendChild(document.createTextNode(config.label || ""));
        }
        content.appendChild(document.createTextNode(" "));
        content.appendChild((0,crelt__rspack_import_2["default"])("button", { class: "cm-button", type: "submit" }, config.submitLabel || "OK"));
    }
    ...
    let panel = (0,crelt__rspack_import_2["default"])("div", content, (0,crelt__rspack_import_2["default"])("button", {
        onclick: () => done(null),
...
class.
*/
class GutterMarker extends _codemirror_state__rspack_import_3.RangeValue {
    /**
    @internal
    */
    compare(other) {
...
GutterMarker.prototype.mapMode = _codemirror_state__rspack_import_3.MapMode.TrackBefore;
...
*/
const gutterLineClass = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
/**
Facet used to add a class to all gutter elements next to a widget.
Should not provide widgets with a `toDOM` method.
*/
const gutterWidgetClass = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const defaults = {
    class: "",
    renderEmptyElements: false,
    elementStyle: "",
    markers: () => _codemirror_state__rspack_import_3.RangeSet.empty,
    lineMarker: () => null,
    widgetMarker: () => null,
...
const activeGutters = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
/**
...
const unfixGutters = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine: values => values.some(x => x)
});
/**
...
const gutterView = /*@__PURE__*/ViewPlugin.fromClass(class {
    ...
    syncGutters(detach) {
        ...
        let lineClasses = _codemirror_state__rspack_import_3.RangeSet.iter(this.view.state.facet(gutterLineClass), this.view.viewport.from);
        let classSet = [];
    ...
    updateGutters(update) {
        ...
        let change = update.docChanged || update.heightChanged || update.viewportChanged ||
            !_codemirror_state__rspack_import_3.RangeSet.eq(update.startState.facet(gutterLineClass), update.state.facet(gutterLineClass), update.view.viewport.from, update.view.viewport.to);
        if (prev == cur) {
            for (let gutter of this.gutters)
...
class UpdateContext {
    constructor(gutter, viewport, height) {
        ...
        this.height = height;
        this.i = 0;
        this.cursor = _codemirror_state__rspack_import_3.RangeSet.iter(gutter.markers, viewport.from);
    }
...
class SingleGutterView {
    ...
    update(update) {
        ...
        return !_codemirror_state__rspack_import_3.RangeSet.eq(this.markers, prevMarkers, vp.from, vp.to) ||
...
*/
const lineNumberMarkers = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
/**
Facet used to create markers in the line number gutter next to widgets.
*/
const lineNumberWidgetMarker = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define();
const lineNumberConfig = /*@__PURE__*/_codemirror_state__rspack_import_3.Facet.define({
    combine(values) {
        return (0,_codemirror_state__rspack_import_3.combineConfig)(values, { formatNumber: String, domEventHandlers: {} }, {
...
const activeLineGutterHighlighter = /*@__PURE__*/gutterLineClass.compute(["selection"], state => {
    ...
    return _codemirror_state__rspack_import_3.RangeSet.of(marks);
});
/**
...
"./node_modules/@lezer/common/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
"./node_modules/@lezer/highlight/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Tag: () => (Tag),
...
"./node_modules/@marijn/find-cluster-break/src/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  findClusterBreak: () => (findClusterBreak),
...
"./node_modules/crelt/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (crelt)
});
...
"./node_modules/style-mod/src/style-mod.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
"./node_modules/w3c-keyname/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  base: () => (base),
  keyName: () => (keyName),
...
//# sourceMappingURL=vendors-node_modules_codemirror_language_dist_index_js.js.map