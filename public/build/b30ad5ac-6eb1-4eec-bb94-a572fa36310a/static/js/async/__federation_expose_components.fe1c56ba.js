...
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["38"],{61251:function(e,t,i){i.d(t,{G:()=>o,e:()=>l});let n=document.querySelector("#app"),o=window.location.origin;null===n&&console.warn("App element not found");let r=(null==n?void 0:n.getAttribute("data-app-config"))??null,a=null;null!==r&&(a=JSON.parse(r));let l={baseUrl:(null==a?void 0:a.baseUrl)??"/pimcore-studio/",mercureUrl:(null==a?void 0:a.mercureUrl)??`${o}/.well-known/mercure`,maxPageSize:(null==a?void 0:a.maxPageSize)??9999999,wysiwyg:(null==a?void 0:a.wysiwyg)??{defaultEditorConfig:{dataObject:{},document:{}}}}},36350:function(e,t,i){i.d(t,{PK:()=>ew,ZE:()=>ej,Nd:()=>ek,FH:()=>ey,_j:()=>eS});var n=i(85893),o=i(81004),r=i(89250),a=i(31600),l=i(28651);let s=(0,l.kc)(e=>{let{token:t,css:i}=e;return{leftSidebar:i`
    ...
    `}});var eo=i(78801);let er=()=>{let{jobs:e}=(0,H.C)(),{styles:t}=en(),{t:i}=(0,h.$G)(),r={key:"1",label:(0,n.jsx)("span",{children:i("jobs.notification.jobs",{count:e.length})}),children:(0,n.jsx)(K.M,{children:e.map(e=>(0,n.jsx)(Q.E.div,{animate:{opacity:1,height:"auto"},exit:{opacity:0,height:1},initial:{opacity:0,height:1},children:(0,o.createElement)(ei,{...e,key:e.id})},`${e.id}`))}),...0===e.length&&{disabled:!0}};return(0,n.jsx)(eo.UO,{bordered:!1,className:t.jobList,defaultActiveKeys:[r.key],hasContentSeparator:!1,items:[r]})},ea=()=>{let{jobs:e}=(0,H.C)(),t=e.length>0,[i]=(0,V.l)(),{t:r}=(0,h.$G)();return(0,o.useEffect)(()=>{t&&i.open({message:r("jobs.notification.title"),description:(0,n.jsx)(er,{}),duration:0,closable:!1,placement:"bottomRight"}),t||i.destroy()},[t]),(0,n.jsx)(n.Fragment,{})},el=()=>{let{styles:e}=O();return(0,n.jsxs)("div",{className:["base-layout",e.baseLayout].join(" "),children:[(0,n.jsx)(y,{}),(0,n.jsx)(G,{}),(0,n.jsx)(ea,{}),(0,n.jsx)(U,{})]})};var es=i(65921),ed=i(91030),ec=i(71098);let eu=()=>{var e,t,i;let n=(0,r.TH)(),{openElement:o}=(0,ec.f)();if((null==n||null==(e=n.state)?void 0:e.isDeeplink)===!0){let e=null==n||null==(t=n.state)?void 0:t.id,r=null==n||null==(i=n.state)?void 0:i.elementType;(async()=>{(0,_.isEmpty)(e)||(0,_.isEmpty)(r)||await o({id:Number(e),type:r})})().catch(()=>{(0,v.ZP)(new v.aE("An Error occured while opening the Element"))})}};var ep=i(48497);let em=()=>{let e=(0,ep.a)();return(0,o.useMemo)(()=>""!==e.username,[e])};var eh=i(82179),eg=i(61251);let ex=`${eg.G}/pimcore-statistics`,ev=async e=>{try{let t=await fetch(ex,{method:"GET",headers:{"X-Requested-With":"XMLHttpRequest"}});if(t.ok){let i=await t.json();e&&await fetch("https://license.pimcore.com/statistics",{method:"POST",body:new URLSearchParams({data:encodeURIComponent(JSON.stringify(i))})})}}catch(e){console.error("Error while sending statistics: ",e)}},ef=(0,l.kc)(e=>{let{token:t,css:i}=e;return{loginPage:i`
      display: flex;
      align-items: center;
