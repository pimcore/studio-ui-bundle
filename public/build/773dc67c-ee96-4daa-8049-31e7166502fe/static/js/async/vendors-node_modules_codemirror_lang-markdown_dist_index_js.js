 ...
 */
"use strict";
(self["webpackChunkpimcore_studio_ui_bundle_core"] = self["webpackChunkpimcore_studio_ui_bundle_core"] || []).push([["vendors-node_modules_codemirror_lang-markdown_dist_index_js"], {
"./node_modules/@codemirror/lang-markdown/dist/index.js": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* ESM import */var _codemirror_state__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./node_modules/@codemirror/state/dist/index.js");
...
/* ESM import */var _lezer_markdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/@lezer/markdown/dist/index.js");
/* ESM import */var _codemirror_lang_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("webpack/sharing/consume/default/@codemirror/lang-html/@codemirror/lang-html");
/* ESM import */var _lezer_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/@lezer/common/dist/index.js");
...
const data = /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.defineLanguageFacet)({ commentTokens: { block: { open: "<!--", close: "-->" } } });
const headingProp = /*@__PURE__*/new _lezer_common__WEBPACK_IMPORTED_MODULE_2__.NodeProp();
const commonmark = /*@__PURE__*/_lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.parser.configure({
    props: [
        /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.foldNodeProp.add(type => {
        ...
        /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.languageDataProp.add({
            Document: data
        })
    ]
});
...
const headerIndent = /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.foldService.of((state, start, end) => {
...
function mkLang(parser) {
    return new _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.Language(data, parser, [headerIndent], "markdown");
}
/**
    ...
    return (info) => {
        if (info && languages) {
            ...
            if (typeof languages == "function")
                ...
                found = _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.LanguageDescription.matchLanguageName(languages, info, true);
            if (found instanceof _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.LanguageDescription)
                return found.support ? found.support.language.parser : _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.ParseContext.getSkippingParser(found.load());
            else if (found)
                return found.parser;
        }
...
function normalizeIndent(content, state) {
    ...
    if (!blank || state.facet(_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.indentUnit) != "\t")
        return content;
    let col = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.countColumn)(content, 4, blank);
    let space = "";
    for (let i = col; i > 0;) {
        if (i >= 4) {
            space += "\t";
...
const insertNewlineContinueMarkup = ({ state, dispatch }) => {
    let tree = (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.syntaxTree)(state), { doc } = state;
    let dont = null, changes = state.changeByRange(range => {
        ...
        if (inner.item && emptyLine) {
            ...
            if (first.to >= pos || second && second.to < pos ||
                ...
                return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorSelection.cursor(delTo + insert.length), changes };
            }
            else { // Move second item down, making tight two-item list non-tight
                let insert = blankLine(context, state, line);
                return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorSelection.cursor(pos + insert.length + 1),
        ...
        if (!continued || /^[\s\d.)\-+*>]*/.exec(line.text)[0].length >= inner.to) {
            for (let i = 0, e = context.length - 1; i <= e; i++) {
                insert += i == e && !continued ? context[i].marker(doc, 1)
                    : context[i].blank(i < e ? (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.countColumn)(line.text, 4, context[i + 1].from) - insert.length : null);
            }
        }
        let from = pos;
        ...
        return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorSelection.cursor(from + insert.length + 1), changes };
    });
    if (dont)
        return false;
...
function blankLine(context, state, line) {
    ...
    for (let i = 0, e = context.length - 2; i <= e; i++) {
        insert += context[i].blank(i < e ? (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.countColumn)(line.text, 4, context[i + 1].from) - insert.length : null, i < e);
    }
        ...
        if (range.empty && markdownLanguage.isActiveAt(state, range.from)) {
            ...
            if (context.length) {
                ...
                if (pos - line.from > spaceEnd && !/\S/.test(line.text.slice(spaceEnd, pos - line.from)))
                    return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorSelection.cursor(line.from + spaceEnd),
                ...
                if (pos - line.from == spaceEnd &&
                    ...
                    if (inner.item && inner.node.from < inner.item.from && /\S/.test(line.text.slice(inner.from, inner.to))) {
                        let insert = inner.blank((0,_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.countColumn)(line.text, 4, inner.to) - (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.countColumn)(line.text, 4, inner.from));
                        if (start == line.from)
                            insert = normalizeIndent(insert, state);
                        return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorSelection.cursor(start + insert.length),
                            changes: { from: start, to: line.from + inner.to, insert } };
                    }
                    // Delete one level of indentation
                    if (start < pos)
                        return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorSelection.cursor(start), changes: { from: start, to: pos } };
                }
            }
        }
        return dont = { range };
...
const htmlNoMatch = /*@__PURE__*/(0,_codemirror_lang_html__WEBPACK_IMPORTED_MODULE_1__.html)({ matchClosingTags: false });
/**
...
function markdown(config = {}) {
    ...
    if (defaultCodeLanguage instanceof _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.LanguageSupport) {
    ...
    if (addKeymap)
        support.push(_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.Prec.high(_codemirror_view__WEBPACK_IMPORTED_MODULE_5__.keymap.of(markdownKeymap)));
    let lang = mkLang(parser.configure(extensions));
    if (completeHTMLTags)
        support.push(lang.data.of({ autocomplete: htmlTagCompletion }));
    return new _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.LanguageSupport(lang, support);
}
function htmlTagCompletion(context) {
    let { state, pos } = context, m = /<[:\-\.\w\u00b7-\uffff]*$/.exec(state.sliceDoc(pos - 25, pos));
    if (!m)
        return null;
    let tree = (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.syntaxTree)(state).resolveInner(pos, -1);
...
function htmlTagCompletions() {
    ...
    let result = (0,_codemirror_lang_html__WEBPACK_IMPORTED_MODULE_1__.htmlCompletionSource)(new _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_6__.CompletionContext(_codemirror_state__WEBPACK_IMPORTED_MODULE_4__.EditorState.create({ extensions: htmlNoMatch }), 0, true));
...
"./node_modules/@lezer/markdown/dist/index.js": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Autolink: () => (Autolink),
