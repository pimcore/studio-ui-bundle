 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["__federation_expose_api__translations"], {
...
"./js/src/sdk/api/translations/index.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  addTagTypes: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.addTagTypes),
  api: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.api),
  useTranslationCleanupByDomainMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationCleanupByDomainMutation),
  useTranslationCreateMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationCreateMutation),
  useTranslationDeleteByKeyMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationDeleteByKeyMutation),
  useTranslationDetermineCsvSettingsForImportMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationDetermineCsvSettingsForImportMutation),
  useTranslationExportListMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationExportListMutation),
  useTranslationGetAvailableLocalesQuery: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationGetAvailableLocalesQuery),
  useTranslationGetCollectionMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationGetCollectionMutation),
  useTranslationGetDomainsQuery: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationGetDomainsQuery),
  useTranslationGetListQuery: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationGetListQuery),
  useTranslationImportCsvMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationImportCsvMutation),
  useTranslationUpdateMutation: () => (/* reexport safe */ _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0.useTranslationUpdateMutation)
});
/* import */ var _Pimcore_modules_app_translations_translations_api_slice_gen__rspack_import_0 = __webpack_require__("./js/src/core/modules/app/translations/translations-api-slice.gen.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
