 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["vendors-node_modules_codemirror_lang-sql_dist_index_js"], {
"./node_modules/@codemirror/lang-sql/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* import */ var _lezer_lr__rspack_import_1 = __webpack_require__("./node_modules/@lezer/lr/dist/index.js");
/* import */ var _codemirror_autocomplete__rspack_import_3 = __webpack_require__("./node_modules/@codemirror/autocomplete/dist/index.js");
...
function tokensFor(d) {
    return new _lezer_lr__rspack_import_1.ExternalTokenizer(input => {
        var _a;
        let { next } = input;
        input.advance();
...
// This file was generated by lezer-generator. You probably shouldn't edit it.
const parser$1 = /*@__PURE__*/_lezer_lr__rspack_import_1.LRParser.deserialize({
  version: 14,
...
function sourceContext(state, startPos) {
    let pos = (0,_codemirror_language__rspack_import_2.syntaxTree)(state).resolveInner(startPos, -1);
...
function completeKeywords(keywords, upperCase, build) {
    ...
    return (0,_codemirror_autocomplete__rspack_import_3.ifNotIn)(["QuotedIdentifier", "String", "LineComment", "BlockComment", "."], (0,_codemirror_autocomplete__rspack_import_3.completeFromList)(completions));
}

let parser = /*@__PURE__*/parser$1.configure({
    props: [
        /*@__PURE__*/_codemirror_language__rspack_import_2.indentNodeProp.add({
            Statement: /*@__PURE__*/(0,_codemirror_language__rspack_import_2.continuedIndent)()
        }),
        ...
        /*@__PURE__*/(0,_lezer_highlight__rspack_import_0.styleTags)({
            Keyword: _lezer_highlight__rspack_import_0.tags.keyword,
            Type: _lezer_highlight__rspack_import_0.tags.typeName,
            Builtin: /*@__PURE__*/_lezer_highlight__rspack_import_0.tags.standard(_lezer_highlight__rspack_import_0.tags.name),
            Bits: _lezer_highlight__rspack_import_0.tags.number,
            Bytes: _lezer_highlight__rspack_import_0.tags.string,
            Bool: _lezer_highlight__rspack_import_0.tags.bool,
            Null: _lezer_highlight__rspack_import_0.tags["null"],
            Number: _lezer_highlight__rspack_import_0.tags.number,
            String: _lezer_highlight__rspack_import_0.tags.string,
            Identifier: _lezer_highlight__rspack_import_0.tags.name,
            QuotedIdentifier: /*@__PURE__*/_lezer_highlight__rspack_import_0.tags.special(_lezer_highlight__rspack_import_0.tags.string),
            SpecialVar: /*@__PURE__*/_lezer_highlight__rspack_import_0.tags.special(_lezer_highlight__rspack_import_0.tags.name),
            LineComment: _lezer_highlight__rspack_import_0.tags.lineComment,
            BlockComment: _lezer_highlight__rspack_import_0.tags.blockComment,
            Operator: _lezer_highlight__rspack_import_0.tags.operator,
            "Semi Punctuation": _lezer_highlight__rspack_import_0.tags.punctuation,
            "( )": _lezer_highlight__rspack_import_0.tags.paren,
            "{ }": _lezer_highlight__rspack_import_0.tags.brace,
            "[ ]": _lezer_highlight__rspack_import_0.tags.squareBracket
        })
    ]
});
/**
...
class SQLDialect {
    ...
    */
    static define(spec) {
        ...
        let language = _codemirror_language__rspack_import_2.LRLanguage.define({
            name: "sql",
...
function sql(config = {}) {
    ...
    return new _codemirror_language__rspack_import_2.LanguageSupport(lang.language, [
...
//# sourceMappingURL=vendors-node_modules_codemirror_lang-sql_dist_index_js.js.map