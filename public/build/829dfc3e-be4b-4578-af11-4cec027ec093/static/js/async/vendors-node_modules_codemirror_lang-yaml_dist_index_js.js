 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["vendors-node_modules_codemirror_lang-yaml_dist_index_js"], {
"./node_modules/@codemirror/lang-yaml/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* import */ var _lezer_yaml__rspack_import_0 = __webpack_require__("./node_modules/@lezer/yaml/dist/index.js");
/* import */ var _codemirror_language__rspack_import_4 = __webpack_require__("./node_modules/@codemirror/language/dist/index.js");
/* import */ var _lezer_common__rspack_import_1 = __webpack_require__("./node_modules/@lezer/common/dist/index.js");
/* import */ var _lezer_highlight__rspack_import_2 = __webpack_require__("./node_modules/@lezer/highlight/dist/index.js");
/* import */ var _lezer_lr__rspack_import_3 = __webpack_require__("./node_modules/@lezer/lr/dist/index.js");
...
const parser = /*@__PURE__*/_lezer_lr__rspack_import_3.LRParser.deserialize({
  version: 14,
...
*/
const yamlLanguage = /*@__PURE__*/_codemirror_language__rspack_import_4.LRLanguage.define({
    name: "yaml",
    parser: /*@__PURE__*/_lezer_yaml__rspack_import_0.parser.configure({
        props: [
            /*@__PURE__*/_codemirror_language__rspack_import_4.indentNodeProp.add({
                Stream: cx => {
                ...
                FlowMapping: /*@__PURE__*/(0,_codemirror_language__rspack_import_4.delimitedIndent)({ closing: "}" }),
                FlowSequence: /*@__PURE__*/(0,_codemirror_language__rspack_import_4.delimitedIndent)({ closing: "]" }),
            }),
            /*@__PURE__*/_codemirror_language__rspack_import_4.foldNodeProp.add({
                "FlowMapping FlowSequence": _codemirror_language__rspack_import_4.foldInside,
...
*/
function yaml() {
    return new _codemirror_language__rspack_import_4.LanguageSupport(yamlLanguage);
}
const frontmatterLanguage = /*@__PURE__*/_codemirror_language__rspack_import_4.LRLanguage.define({
    name: "yaml-frontmatter",
    parser: /*@__PURE__*/parser.configure({
        props: [/*@__PURE__*/(0,_lezer_highlight__rspack_import_2.styleTags)({ DashLine: _lezer_highlight__rspack_import_2.tags.meta })]
    })
});
/**
...
function yamlFrontmatter(config) {
    let { language, support } = config.content instanceof _codemirror_language__rspack_import_4.LanguageSupport ? config.content
        : { language: config.content, support: [] };
    return new _codemirror_language__rspack_import_4.LanguageSupport(frontmatterLanguage.configure({
        wrap: (0,_lezer_common__rspack_import_1.parseMixed)(node => {
...
"./node_modules/@lezer/yaml/dist/index.js"(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  parser: () => (parser)
});
...
const indentation = new _lezer_lr__rspack_import_0.ContextTracker({
  start: Context.top,
  reduce(context, term) {
...
const newlines = new _lezer_lr__rspack_import_0.ExternalTokenizer((input, stack) => {
...
const blockMark = new _lezer_lr__rspack_import_0.ExternalTokenizer((input, stack) => {
...
const literals = new _lezer_lr__rspack_import_0.ExternalTokenizer((input, stack) => {
  if (input.next == 33 /* '!' */) {
    readTag(input);
...
const blockLiteral = new _lezer_lr__rspack_import_0.ExternalTokenizer((input, stack) => {
...
const yamlHighlighting = (0,_lezer_highlight__rspack_import_1.styleTags)({
  DirectiveName: _lezer_highlight__rspack_import_1.tags.keyword,
  DirectiveContent: _lezer_highlight__rspack_import_1.tags.attributeValue,
  "DirectiveEnd DocEnd": _lezer_highlight__rspack_import_1.tags.meta,
  QuotedLiteral: _lezer_highlight__rspack_import_1.tags.string,
  BlockLiteralHeader: _lezer_highlight__rspack_import_1.tags.special(_lezer_highlight__rspack_import_1.tags.string),
  BlockLiteralContent: _lezer_highlight__rspack_import_1.tags.content,
  Literal: _lezer_highlight__rspack_import_1.tags.content,
  "Key/Literal Key/QuotedLiteral": _lezer_highlight__rspack_import_1.tags.definition(_lezer_highlight__rspack_import_1.tags.propertyName),
  "Anchor Alias": _lezer_highlight__rspack_import_1.tags.labelName,
  Tag: _lezer_highlight__rspack_import_1.tags.typeName,
  Comment: _lezer_highlight__rspack_import_1.tags.lineComment,
...
//# sourceMappingURL=vendors-node_modules_codemirror_lang-yaml_dist_index_js.js.map