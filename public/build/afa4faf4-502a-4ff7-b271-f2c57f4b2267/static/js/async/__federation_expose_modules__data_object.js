...
/* ESM import */var _sdk_app__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./js/src/sdk/app/index.ts");
...
const DataObjectEditorWidget = {
    ...
    isModified: (tabNode)=>{
        ...
        const dataObject = (0,_Pimcore_modules_data_object_data_object_draft_slice__WEBPACK_IMPORTED_MODULE_6__.selectDataObjectById)(_sdk_app__WEBPACK_IMPORTED_MODULE_3__.store.getState(), config.id);
