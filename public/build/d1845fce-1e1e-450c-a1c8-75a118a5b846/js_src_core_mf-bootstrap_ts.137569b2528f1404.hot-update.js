        ...
        const processClassificationStoreData = (param)=>{
            ...
            return data.flatMap((dataItem)=>{
                ...
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_4__.isEmpty)(dataItem.definition)) {
                    ...
                    if ((0,lodash__WEBPACK_IMPORTED_MODULE_4__.isUndefined)(groupKey)) return {};
                    const fieldValue = (0,lodash__WEBPACK_IMPORTED_MODULE_4__.get)(fieldValueByName, groupKey);
                    return {
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.137569b2528f1404.hot-update.js.map