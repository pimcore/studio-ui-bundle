...
/* ESM import */var _dynamic_type_object_data_abstract__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./js/src/core/modules/element/dynamic-types/definitions/objects/data-related/dynamic-type-object-data-abstract.tsx");
/* ESM import */var _components_classification_store_classification_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./js/src/core/modules/element/dynamic-types/definitions/objects/data-related/components/classification-store/classification-store.tsx");
...
class DynamicTypeObjectDataClassificationStore extends _dynamic_type_object_data_abstract__WEBPACK_IMPORTED_MODULE_2__.DynamicTypeObjectDataAbstract {
    getObjectDataComponent(props) {
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_components_classification_store_classification_store__WEBPACK_IMPORTED_MODULE_3__.ClassificationStore, {
            ...props
        }, void 0, false, {
    ...
    async processVersionFieldData(props) {
        ...
        const processClassificationStoreData = (param)=>{
            let { data, updatedFieldBreadcrumbTitle = fieldBreadcrumbTitle } = param;
            return data.flatMap((dataItem)=>{
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_4__.isEmpty)(dataItem.activeGroupDefinitions)) {
                    console.log('----->>>>>> 0000 dataItem: ', dataItem);
                    ...
                    return processClassificationStoreData({
                        data: dataItem.activeGroupDefinitions,
                        updatedFieldBreadcrumbTitle: breadcrumbTitle
                    });
                }
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_4__.isEmpty)(dataItem.keys)) {
                    console.log('----->>>>>> 11111 dataItem: ', dataItem);
                    return processClassificationStoreData({
                        data: dataItem.keys,
                        updatedFieldBreadcrumbTitle
                    });
                }
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_4__.isEmpty)(dataItem.definition)) {
                    console.log('----->>>>>> 222 dataItem: ', dataItem);
                    console.log('----->>>>>> 222 fieldValueByName: ', fieldValueByName);
                    console.log('----->>>>> 222 NEXT');
                    const fieldPath = dataItem.id;
                    const fieldValue = (0,lodash__WEBPACK_IMPORTED_MODULE_4__.get)(fieldValueByName, fieldPath);
                    return {
        ...
        async function handleClassificationStoreData() {
            try {
                if ((0,lodash__WEBPACK_IMPORTED_MODULE_4__.isEmpty)(item)) return [];
...
//# sourceMappingURL=js_src_core_mf-bootstrap_ts.e658844a3361bd78.hot-update.js.map