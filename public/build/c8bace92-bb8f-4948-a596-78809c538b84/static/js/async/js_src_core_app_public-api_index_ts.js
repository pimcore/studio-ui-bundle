...
"./js/src/core/app/public-api/document/document-api.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _iframe_registry__rspack_import_2 = __webpack_require__("./js/src/core/app/public-api/document/iframe-registry.ts");
/* import */ var _Pimcore_modules_document_services__rspack_import_3 = __webpack_require__("./js/src/core/modules/document/services/index.ts");
...
class DocumentApiImpl {
    markDraftAsModified(documentId) {
        ...
        const currentState = _Pimcore_app_store__rspack_import_0.store.getState();
        const document = (0,_Pimcore_modules_document_document_draft_slice__rspack_import_1.selectDocumentById)(currentState, documentId);
        ...
        setTimeout(()=>{
            _Pimcore_app_store__rspack_import_0.store.dispatch((0,_Pimcore_modules_document_document_draft_slice__rspack_import_1.markDocumentEditablesAsModified)(documentId));
        }, 0);
    }
    getIframeApi(documentId) {
        return _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.getDocumentEditorApi(documentId);
    }
    getIframeDocument(documentId) {
        return _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.getIframeDocument(documentId);
    }
    isIframeAvailable(documentId) {
        return _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.isIframeRegistered(documentId);
    }
    registerIframe(documentId, iframe, iframeRef) {
        _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.register(documentId, iframe, iframeRef);
        this.autoSaveCallbacks.set(documentId, (0,lodash__rspack_import_4.debounce)(async ()=>{
            await this.performAutoSave(documentId);
        }, 800));
        // Automatically set up ready state notification when iframe becomes ready
        _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.onReady(documentId, ()=>{
    ...
    unregisterIframe(documentId) {
        _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.unregister(documentId);
    ...
    notifyIframeReady(documentId) {
        _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.markAsReady(documentId);
    }
    notifyAreablockTypes(documentId, editableTypeId, areablockTypes) {
        _Pimcore_app_store__rspack_import_0.store.dispatch((0,_Pimcore_modules_document_document_editor_slice__rspack_import_5.setDocumentAreablockTypes)({
            documentId,
            editableTypeId,
            areablockTypes
        }));
    }
    mergeAreablockTypes(documentId, editableTypeId, areablockTypes) {
        _Pimcore_app_store__rspack_import_0.store.dispatch((0,_Pimcore_modules_document_document_editor_slice__rspack_import_5.mergeDocumentAreablockTypes)({
            documentId,
            editableTypeId,
            areablockTypes
        }));
    }
    notifyTimeSliderVisible(documentId, visible) {
        _Pimcore_app_store__rspack_import_0.store.dispatch((0,_Pimcore_modules_document_document_editor_slice__rspack_import_5.setDocumentTimeSliderVisible)({
            documentId,
            visible
        }));
    }
    isIframeReady(documentId) {
        return _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.isIframeReady(documentId);
    }
    onReady(documentId, callback) {
        _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.onReady(documentId, callback);
    }
    async performAutoSave(documentId) {
        try {
            await _Pimcore_modules_document_services__rspack_import_3.documentSaveService.saveDocument(documentId, _Pimcore_modules_document_services__rspack_import_3.SaveTaskType.AutoSave);
        } catch (error) {
    ...
    async performAutoSaveAndReload(documentId) {
        try {
            const iframeRef = _iframe_registry__rspack_import_2.iframeDocumentEditorRegistry.getIframeRef(documentId);
            if (!(0,lodash__rspack_import_4.isNil)(iframeRef === null || iframeRef === void 0 ? void 0 : iframeRef.current)) {
...
"./js/src/core/app/public-api/document/iframe-registry.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
class IframeDocumentEditorRegistry {
    register(documentId, iframe, iframeRef) {
        if ((0,lodash__rspack_import_0.isNull)(iframe.contentWindow)) {
   ...
   */ markAsReady(documentId) {
        ...
        if (!(0,lodash__rspack_import_0.isNil)(reference) && !reference.isReady) {
   ...
   */ onReady(documentId, callback) {
        const reference = this.iframes.get(documentId);
        if (!(0,lodash__rspack_import_0.isNil)(reference)) {
