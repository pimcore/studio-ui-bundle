...
const api = _asset_api_slice_gen__rspack_import_1.api.enhanceEndpoints({
    ...
    endpoints: {
        ...
        assetSaveGridConfiguration: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_GRID_CONFIGURATION_LIST()
        },
