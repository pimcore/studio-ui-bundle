...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  addCacheBusterToUrl: () => (/* reexport safe */ _Pimcore_utils_url_cache_buster__WEBPACK_IMPORTED_MODULE_13__.addCacheBusterToUrl),
  buildQueryString: () => (/* reexport safe */ _Pimcore_utils_query_string__WEBPACK_IMPORTED_MODULE_11__.buildQueryString),
  compose: () => (/* reexport safe */ _Pimcore_utils_compose__WEBPACK_IMPORTED_MODULE_0__.compose),
  decodeHtmlEntities: () => (/* reexport safe */ _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__.decodeHtmlEntities),
  escapeHtml: () => (/* reexport safe */ _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__.escapeHtml),
  fetchBlobWithPolling: () => (/* reexport safe */ _Pimcore_utils_polling_helper__WEBPACK_IMPORTED_MODULE_10__.fetchBlobWithPolling),
  ...
  formatNumber: () => (/* reexport safe */ _Pimcore_utils_number__WEBPACK_IMPORTED_MODULE_9__.formatNumber),
  formatRelativeTime: () => (/* reexport safe */ _Pimcore_utils_relative_time__WEBPACK_IMPORTED_MODULE_12__.formatRelativeTime),
  formatTime: () => (/* reexport safe */ _Pimcore_utils_date_time__WEBPACK_IMPORTED_MODULE_4__.formatTime),
  getIframeOffset: () => (/* reexport safe */ _Pimcore_utils_iframe__WEBPACK_IMPORTED_MODULE_8__.getIframeOffset),
  getParentDocument: () => (/* reexport safe */ _Pimcore_utils_iframe__WEBPACK_IMPORTED_MODULE_8__.getParentDocument),
  hasLineBreaks: () => (/* reexport safe */ _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__.hasLineBreaks),
  isHtmlContent: () => (/* reexport safe */ _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__.isHtmlContent),
  isInIframe: () => (/* reexport safe */ _Pimcore_utils_iframe__WEBPACK_IMPORTED_MODULE_8__.isInIframe),
  ...
  pasteHtmlAtCaret: () => (/* reexport safe */ _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__.pasteHtmlAtCaret),
  ...
  stripTags: () => (/* reexport safe */ _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__.stripTags),
  toCssDimension: () => (/* reexport safe */ _Pimcore_utils_css__WEBPACK_IMPORTED_MODULE_1__.toCssDimension),
  useClickOutside: () => (/* reexport safe */ _Pimcore_utils_hooks_use_click_outside__WEBPACK_IMPORTED_MODULE_15__.useClickOutside),
  useCssContainer: () => (/* reexport safe */ _Pimcore_utils_hooks_use_css_container_use_css_container__WEBPACK_IMPORTED_MODULE_16__.useCssContainer),
  useDebounce: () => (/* reexport safe */ _Pimcore_utils_hooks_use_debounce__WEBPACK_IMPORTED_MODULE_21__.useDebounce),
  usePrevious: () => (/* reexport safe */ _Pimcore_utils_hooks_use_previous__WEBPACK_IMPORTED_MODULE_19__.usePrevious),
  useServerSideEvent: () => (/* reexport safe */ _Pimcore_utils_hooks_use_server_side_event__WEBPACK_IMPORTED_MODULE_20__.useServerSideEvent),
  uuid: () => (/* reexport safe */ _Pimcore_utils_uuid__WEBPACK_IMPORTED_MODULE_14__.uuid)
});
...
/* ESM import */var _Pimcore_utils_html__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./js/src/core/utils/html.ts");
/* ESM import */var _Pimcore_utils_iframe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./js/src/core/utils/iframe.ts");
/* ESM import */var _Pimcore_utils_number__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./js/src/core/utils/number.ts");
...
/* ESM import */var _Pimcore_utils_query_string__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./js/src/core/utils/query-string.ts");
/* ESM import */var _Pimcore_utils_relative_time__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./js/src/core/utils/relative-time.ts");
/* ESM import */var _Pimcore_utils_url_cache_buster__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./js/src/core/utils/url-cache-buster.ts");
/* ESM import */var _Pimcore_utils_uuid__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./js/src/core/utils/uuid.ts");
/* ESM import */var _Pimcore_utils_hooks_use_click_outside__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./js/src/core/utils/hooks/use-click-outside.ts");
/* ESM import */var _Pimcore_utils_hooks_use_css_container_use_css_container__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./js/src/core/utils/hooks/use-css-container/use-css-container.tsx");
/* ESM import */var _Pimcore_utils_hooks_use_element_resize__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("./js/src/core/utils/hooks/use-element-resize.ts");
/* ESM import */var _Pimcore_utils_hooks_use_element_visible__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("./js/src/core/utils/hooks/use-element-visible.ts");
/* ESM import */var _Pimcore_utils_hooks_use_previous__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("./js/src/core/utils/hooks/use-previous.ts");
/* ESM import */var _Pimcore_utils_hooks_use_server_side_event__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__("./js/src/core/utils/hooks/use-server-side-event.ts");
/* ESM import */var _Pimcore_utils_hooks_use_debounce__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("./js/src/core/utils/hooks/use-debounce.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
