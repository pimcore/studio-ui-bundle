 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["js_src_core_modules_background-processor_process_abstract-mercure-process_ts-js_src_core_modu-57c3cd"], {
"./js/src/core/app/config/services/service-ids.ts"(module, __webpack_exports__, __webpack_require__) {
...
"./js/src/core/app/depency-injection/index.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _Pimcore_lib_dependency_injection__rspack_import_0 = __webpack_require__("./js/src/core/lib/dependency-injection/index.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
 ...
 *  @license    Pimcore Open Core License (POCL)
 */ 
const { container, ContainerContext, ContainerProvider, useInjection, useMultiInjection, useOptionalInjection } = (0,_Pimcore_lib_dependency_injection__rspack_import_0.createDiInstance)();
...
"./js/src/core/lib/dependency-injection/index.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function createDiInstance() {
    var _window_Pimcore;
    const container = new inversify__rspack_import_2.Container();
    ...
    const ContainerContext = /*#__PURE__*/ (0,react__rspack_import_1.createContext)(currentContainer);
    const ContainerProvider = (param)=>{
        let { children } = param;
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(ContainerContext.Provider, {
            value: currentContainer,
            children: children
        }, void 0, false, {
            fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/lib/dependency-injection/index.tsx",
            lineNumber: 25,
            columnNumber: 12
        }, this);
    };
...
//# sourceMappingURL=js_src_core_modules_background-processor_process_abstract-mercure-process_ts-js_src_core_modu-57c3cd.js.map