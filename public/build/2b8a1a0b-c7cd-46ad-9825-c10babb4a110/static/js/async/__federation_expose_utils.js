...
/** Narrows an unknown caught value to the ApiErrorData shape accepted by the ApiError constructor. */ function isApiErrorData(error) {
...
var ErrorKeyTypes = /*#__PURE__*/ function(ErrorKeyTypes) {
    ...
    ErrorKeyTypes["DOCUMENT_LANGUAGE_NOT_SET"] = "error_document_language_not_set";
    ...
    ErrorKeyTypes["GDI_PARSING_EXCEPTION"] = "error_gdi_parsing_exception";
...
__webpack_require__.d(__webpack_exports__, {
  ...
  ErrorKeyTypes: () => (/* reexport safe */ _constants_errorTypes__rspack_import_4.ErrorKeyTypes),
  ...
  getErrorKey: () => (/* reexport safe */ _utils_get_error_key__rspack_import_3.getErrorKey),
  isApiErrorData: () => (/* reexport safe */ _classes_api_error__rspack_import_1.isApiErrorData)
});
...
/* import */ var _utils_get_error_key__rspack_import_3 = __webpack_require__("./js/src/core/modules/app/error-handler/utils/get-error-key.ts");
/* import */ var _constants_errorTypes__rspack_import_4 = __webpack_require__("./js/src/core/modules/app/error-handler/constants/errorTypes.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
"./js/src/core/modules/app/error-handler/utils/get-error-key.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
const getErrorKey = (error)=>{
    if (!(0,lodash__rspack_import_0.isPlainObject)(error)) {
        return undefined;
    }
    const errorObj = error;
    if (!(0,lodash__rspack_import_0.isPlainObject)(errorObj.data)) {
        return undefined;
    }
    const data = errorObj.data;
    if ((0,lodash__rspack_import_0.isString)(data.errorKey)) {
 ...
 *  @copyright  Copyright (c) Pimcore GmbH (https://www.pimcore.com)
 *  @license    Pimcore Open Core License (POCL)
 */ /* eslint-disable @typescript-eslint/no-unsafe-argument */ const compose = function() {
...
function formatCurrency(param) {
    ...
    if (lng === undefined) {
        lng = (i18next__rspack_import_0_default().language);
    }
 ...
 */ const toDisplayString = (value)=>{
    if ((0,lodash__rspack_import_0.isNil)(value)) {
        return '';
    }
    if ((0,lodash__rspack_import_0.isString)(value)) {
        return value;
    }
    if ((0,lodash__rspack_import_0.isObject)(value)) {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  downloadFromUrl: () => (/* reexport safe */ _Pimcore_utils_files__rspack_import_6.downloadFromUrl),
  ...
  toDisplayString: () => (/* reexport safe */ _Pimcore_utils_type_utils__rspack_import_17.toDisplayString),
...
"./js/src/core/components/sanitize-html/sanitize-html.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var react__rspack_import_1 = __webpack_require__("webpack/sharing/consume/default/react/react");
/* import */ var react__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(react__rspack_import_1);
/* import */ var dompurify__rspack_import_2 = __webpack_require__("webpack/sharing/consume/default/dompurify/dompurify");
/* import */ var dompurify__rspack_import_2_default = /*#__PURE__*/__webpack_require__.n(dompurify__rspack_import_2);
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const SanitizeHtml = (param)=>{
    let { html, options, tag: Tag = 'div' } = param;
    let cleanHtml;
    if (options !== undefined) {
        cleanHtml = dompurify__rspack_import_2_default().sanitize(html, options);
    } else {
        cleanHtml = dompurify__rspack_import_2_default().sanitize(html);
    }
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(Tag, {
        dangerouslySetInnerHTML: {
            __html: cleanHtml
        }
    }, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/components/sanitize-html/sanitize-html.tsx",
        lineNumber: 24,
        columnNumber: 10
    }, undefined);
};
...
/* import */ var _Pimcore_components_sanitize_html_sanitize_html__rspack_import_5 = __webpack_require__("./js/src/core/components/sanitize-html/sanitize-html.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const ApiErrorViewUI = (param)=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_sanitize_html_sanitize_html__rspack_import_5.SanitizeHtml, {
        html: textValue
    }, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/app/error-handler/components/api-error-view-ui.tsx",
        lineNumber: 29,
        columnNumber: 10
    }, undefined);
};
