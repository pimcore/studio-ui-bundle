...
/* import */ var _Pimcore_styles_global_styles__rspack_import_5 = __webpack_require__("./js/src/core/styles/global.styles.ts");
/* import */ var _Pimcore_components_modal_alert_modal_hooks_use_alert_modal__rspack_import_6 = __webpack_require__("./js/src/core/components/modal/alert-modal/hooks/use-alert-modal.tsx");
/* import */ var _Pimcore_modules_app_error_handler_services_error_modal_service__rspack_import_7 = __webpack_require__("./js/src/core/modules/app/error-handler/services/error-modal-service.ts");
/* import */ var _Pimcore_modules_auth_hooks_use_is_authenticated__rspack_import_8 = __webpack_require__("./js/src/core/modules/auth/hooks/use-is-authenticated.ts");
/* import */ var _loader_translation_loader__rspack_import_9 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/translation/loader.ts");
/* import */ var _loader_user_loader__rspack_import_10 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/user/loader.ts");
/* import */ var _mercure_api_slice_gen__rspack_import_11 = __webpack_require__("./js/src/core/modules/app/mercure-api-slice.gen.ts");
/* import */ var _loader_settings_loader__rspack_import_12 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/settings/loader.tsx");
/* import */ var _loader_language_loader__rspack_import_13 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/language/loader.ts");
/* import */ var _loader_brand_thumbnail_urls_loader__rspack_import_14 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/brand-thumbnail-urls/loader.tsx");
/* import */ var _loader_admin_settings_loader__rspack_import_15 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/admin-settings/loader.tsx");
/* import */ var _Pimcore_modules_auth_user_user_slice__rspack_import_16 = __webpack_require__("./js/src/core/modules/auth/user/user-slice.ts");
/* import */ var _Pimcore_modules_perspectives_hooks_use_perspectives__rspack_import_17 = __webpack_require__("./js/src/core/modules/perspectives/hooks/use-perspectives.tsx");
/* import */ var antd__rspack_import_18 = __webpack_require__("webpack/sharing/consume/default/antd/antd");
/* import */ var antd__rspack_import_18_default = /*#__PURE__*/__webpack_require__.n(antd__rspack_import_18);
/* import */ var _Pimcore_app_public_api_modal_modal_api__rspack_import_19 = __webpack_require__("./js/src/core/app/public-api/modal/modal-api.ts");
...
/* import */ var _sdk_app__rspack_import_21 = __webpack_require__("./js/src/sdk/app/index.ts");
/* import */ var _loader_global_message_bus_loader__rspack_import_22 = __webpack_require__("./js/src/core/modules/app/app-loader/loader/global-message-bus/loader.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const AppLoader = (props)=>{
    ...
    const modal = (0,_Pimcore_components_modal_alert_modal_hooks_use_alert_modal__rspack_import_6.useAlertModal)();
    const { modal: studioModal } = antd__rspack_import_18.App.useApp();
    // Register the modal instance to allow centralized error message display throughout the project
    _Pimcore_modules_app_error_handler_services_error_modal_service__rspack_import_7.ErrorModalService.setModalInstance(modal);
    // Register the modal instance for iframe communication
    _Pimcore_app_public_api_modal_modal_api__rspack_import_19.modalApi.setModalInstance(studioModal);
    const { isAuthenticated } = (0,_Pimcore_modules_auth_hooks_use_is_authenticated__rspack_import_8.useIsAuthenticated)();
    const { loadPublicTranslations, loadTranslations } = (0,_loader_translation_loader__rspack_import_9.useTranslationLoader)();
    const { loadUser } = (0,_loader_user_loader__rspack_import_10.useUserLoader)();
    const [fetchMercureCookie] = (0,_mercure_api_slice_gen__rspack_import_11.useMercureCreateCookieMutation)();
    const { loadSettings } = (0,_loader_settings_loader__rspack_import_12.useSettingsLoader)();
    const { loadAvailableLocales } = (0,_loader_language_loader__rspack_import_13.useLanguageLoader)();
    const { loadBrandThumbnailUrls } = (0,_loader_brand_thumbnail_urls_loader__rspack_import_14.useBrandThumbnailUrlLoader)();
    const { loadAdminSettings } = (0,_loader_admin_settings_loader__rspack_import_15.useAdminSettingsLoader)();
    const { loadPerspective } = (0,_Pimcore_modules_perspectives_hooks_use_perspectives__rspack_import_17.usePerspectives)();
    const { initGlobalMessageBus } = (0,_loader_global_message_bus_loader__rspack_import_22.useGlobalMessageBusLoader)();
    const appLoaderRegistry = _sdk_app__rspack_import_21.container.get(_sdk_app__rspack_import_21.serviceIds["AppLoader/Registry"]);
    async function initActivePerspective() {
        const user = (0,_Pimcore_modules_auth_user_user_slice__rspack_import_16.selectCurrentUser)(_Pimcore_app_store__rspack_import_3.store.getState());
        ...
        void (async ()=>{
            ...
            if (isAuthenticated) {
                ...
                await Promise.all([
                    ...
                    (0,_Pimcore_modules_reports_utils_reports_loader__rspack_import_20.loadReportsMenuItems)()
                ]);
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(react_jsx_dev_runtime__rspack_import_0.Fragment, {
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_styles_global_styles__rspack_import_5.GlobalStyles, {}, void 0, false, {
                fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/app/app-loader/app-loader.tsx",
                lineNumber: 105,
                columnNumber: 7
            }, undefined),
            isLoading && /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_content_content__rspack_import_4.Content, {
                loading: true
            }, void 0, false, {
                fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/app/app-loader/app-loader.tsx",
                lineNumber: 107,
...
_s(AppLoader, "ccjmZMyV3Uzk2KAowAnkmfWNp1A=", false, function() {
    return [
        _Pimcore_components_modal_alert_modal_hooks_use_alert_modal__rspack_import_6.useAlertModal,
        antd__rspack_import_18.App.useApp,
        _Pimcore_modules_auth_hooks_use_is_authenticated__rspack_import_8.useIsAuthenticated,
        _loader_translation_loader__rspack_import_9.useTranslationLoader,
        _loader_user_loader__rspack_import_10.useUserLoader,
        _mercure_api_slice_gen__rspack_import_11.useMercureCreateCookieMutation,
        _loader_settings_loader__rspack_import_12.useSettingsLoader,
        _loader_language_loader__rspack_import_13.useLanguageLoader,
        _loader_brand_thumbnail_urls_loader__rspack_import_14.useBrandThumbnailUrlLoader,
        _loader_admin_settings_loader__rspack_import_15.useAdminSettingsLoader,
        _Pimcore_modules_perspectives_hooks_use_perspectives__rspack_import_17.usePerspectives,
        _loader_global_message_bus_loader__rspack_import_22.useGlobalMessageBusLoader
    ];
});
_c = AppLoader;
var _c;
