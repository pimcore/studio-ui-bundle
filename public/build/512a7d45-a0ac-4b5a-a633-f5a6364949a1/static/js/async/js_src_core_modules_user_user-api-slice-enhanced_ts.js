 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["js_src_core_modules_user_user-api-slice-enhanced_ts"], {
"./js/src/core/modules/auth/user/user-api-slice.gen.ts"(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  useUserGetShareCollectionQuery: () => (useUserGetShareCollectionQuery),
...
const injectedRtkApi = _sdk_api__rspack_import_0.api.enhanceEndpoints({
    ...
    endpoints: (build)=>({
            ...
            userGetShareCollection: build.query({
                query: ()=>({
                        url: `/pimcore-studio/api/users-share-list`
                    }),
                providesTags: [
                    "User Management"
                ]
...
"./js/src/core/modules/user/user-api-slice-enhanced.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  api: () => (api),
...
/* import */ var _Pimcore_modules_auth_user_user_api_slice_gen__rspack_import_1 = __webpack_require__("./js/src/core/modules/auth/user/user-api-slice.gen.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const api = _Pimcore_modules_auth_user_user_api_slice_gen__rspack_import_1.api.enhanceEndpoints({
    addTagTypes: [
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.USERS,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.USER_DETAIL,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.USER_TREE
    ],
    endpoints: {
        ...
        userGetCollection: {
            providesTags: (result, error, args)=>{
                let detailTags = [];
                if (result !== undefined) {
                    detailTags = result === null || result === void 0 ? void 0 : result.items.flatMap((item)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.USER_DETAIL(item.id));
                }
                return [
                    ...detailTags,
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.USERS()
                ];
            }
        },
        userGetById: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.USER_DETAIL(args.id),
            transformResponse: (raw)=>({
                    ...raw,
                    perspectives: (raw.perspectives ?? []).sort((a, b)=>a.name.localeCompare(b.name)).map((p)=>p.id)
                })
        },
        userDeleteById: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.USER_DETAIL(args.id)
        },
        userUpdateById: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.USER_DETAIL(args.id)
        },
        userGetTree: {
            providesTags: (result, error, args)=>{
                ...
                return [
                    ...detailTags,
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.USER_TREE(),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.USERS()
                ];
            }
        }
