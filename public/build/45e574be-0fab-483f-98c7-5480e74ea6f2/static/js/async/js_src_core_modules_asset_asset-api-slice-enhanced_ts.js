 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["js_src_core_modules_asset_asset-api-slice-enhanced_ts"], {
"./js/src/core/modules/asset/asset-api-slice-enhanced.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  api: () => (api),
  useAssetBatchDeleteMutation: () => (useAssetBatchDeleteMutation),
  ...
  useAssetVideoThumbnailStatusQuery: () => (useAssetVideoThumbnailStatusQuery),
...
/* import */ var _asset_api_slice_gen__rspack_import_1 = __webpack_require__("./js/src/core/modules/asset/asset-api-slice.gen.ts");
...
const api = _asset_api_slice_gen__rspack_import_1.api.enhanceEndpoints({
    addTagTypes: [
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.ASSET,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.ASSET_TREE,
        _Pimcore_app_api_pimcore_tags__rspack_import_0.tagNames.ASSET_DETAIL
    ],
    endpoints: {
        assetClone: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_TREE_ID(args.parentId)
        },
        assetCustomMetadataGetById: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_DETAIL_ID(args.id)
        },
        ...
        assetGetTree: {
            providesTags: (result, error, args)=>{
                ...
                if (result !== undefined) {
                    providingTagsForTree = result === null || result === void 0 ? void 0 : result.items.flatMap((item)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_DETAIL_ID(item.id));
                }
                providingTagsForTree = [
                    ...providingTagsForTree,
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_TREE(),
                    ...args.parentId !== undefined ? _Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_TREE_ID(args.parentId) : []
                ];
                return providingTagsForTree;
            }
        },
        assetUpdateById: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_DETAIL_ID(args.id)
        },
        assetAdd: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_TREE_ID(args.parentId)
        },
        assetPatchById: {
            invalidatesTags: (result, error, args)=>{
                ...
                for (const asset of args.body.data){
                    invalidatingTagsForPatch.push(..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_DETAIL_ID(asset.id));
                }
                return invalidatingTagsForPatch;
            }
        },
        assetGetGridConfigurationByFolderId: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_GRID_CONFIGURATION_DETAIL(args.configurationId)
        },
        assetGetGrid: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_GRID_ID(args.body.folderId)
        },
        assetSaveGridConfiguration: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_GRID_CONFIGURATION()
        },
        ...
        assetUpdateGridConfiguration: {
            invalidatesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_GRID_CONFIGURATION_DETAIL(args.configurationId)
        },
        assetDeleteGridConfigurationByConfigurationId: {
            invalidatesTags: (result, error, args)=>[
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_GRID_CONFIGURATION_DETAIL(),
                    ..._Pimcore_app_api_pimcore_tags__rspack_import_0.invalidatingTags.ASSET_GRID_CONFIGURATION_LIST()
                ]
        },
        assetGetSavedGridConfigurations: {
            providesTags: (result, error, args)=>_Pimcore_app_api_pimcore_tags__rspack_import_0.providingTags.ASSET_GRID_CONFIGURATION_LIST()
        }
    }
});
const { useAssetGetByIdQuery, useAssetGetTreeQuery, useLazyAssetGetTreeQuery, useAssetUpdateByIdMutation, useAssetCloneMutation, useAssetReplaceMutation, useAssetBatchDeleteMutation, useAssetCustomMetadataGetByIdQuery, useAssetCustomSettingsGetByIdQuery, useAssetGetTextDataByIdQuery, useAssetGetGridQuery, useAssetPatchByIdMutation, useAssetExportZipAssetMutation, useAssetExportZipFolderMutation, useAssetGetSavedGridConfigurationsQuery, useAssetSaveGridConfigurationMutation, useAssetSetGridConfigurationAsFavoriteMutation, useAssetUpdateGridConfigurationMutation, useAssetDeleteGridConfigurationByConfigurationIdMutation, useAssetGetGridConfigurationByFolderIdQuery, useAssetGetAvailableGridColumnsQuery, useAssetPatchFolderByIdMutation, useAssetUploadInfoQuery, useAssetVideoThumbnailStatusQuery } = api;
...
"./js/src/core/modules/asset/asset-api-slice.gen.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  ...
  useAssetDocumentDownloadByThumbnailQuery: () => (useAssetDocumentDownloadByThumbnailQuery),
  useAssetDocumentDownloadCustomQuery: () => (useAssetDocumentDownloadCustomQuery),
  useAssetDocumentStreamByThumbnailQuery: () => (useAssetDocumentStreamByThumbnailQuery),
  useAssetDocumentStreamCustomQuery: () => (useAssetDocumentStreamCustomQuery),
  useAssetDocumentStreamDynamicQuery: () => (useAssetDocumentStreamDynamicQuery),
  ...
  useAssetGetTextDataByIdQuery: () => (useAssetGetTextDataByIdQuery),
  useAssetGetTreeQuery: () => (useAssetGetTreeQuery),
  useAssetGetTypesQuery: () => (useAssetGetTypesQuery),
  useAssetGetVideoTypesQuery: () => (useAssetGetVideoTypesQuery),
  ...
  useAssetImageStreamByThumbnailQuery: () => (useAssetImageStreamByThumbnailQuery),
  useAssetImageStreamCustomQuery: () => (useAssetImageStreamCustomQuery),
  useAssetImageStreamDynamicQuery: () => (useAssetImageStreamDynamicQuery),
  useAssetImageStreamPreviewQuery: () => (useAssetImageStreamPreviewQuery),
  useAssetImageStreamQuery: () => (useAssetImageStreamQuery),
  useAssetPatchByIdMutation: () => (useAssetPatchByIdMutation),
  useAssetPatchFolderByIdMutation: () => (useAssetPatchFolderByIdMutation),
  useAssetRemoveGridConfigurationAsFavoriteMutation: () => (useAssetRemoveGridConfigurationAsFavoriteMutation),
  useAssetReplaceMutation: () => (useAssetReplaceMutation),
  useAssetSaveGridConfigurationMutation: () => (useAssetSaveGridConfigurationMutation),
  useAssetSetGridConfigurationAsFavoriteMutation: () => (useAssetSetGridConfigurationAsFavoriteMutation),
  useAssetUpdateByIdMutation: () => (useAssetUpdateByIdMutation),
...
const injectedRtkApi = _sdk_api__rspack_import_0.api.enhanceEndpoints({
    ...
    endpoints: (build)=>({
            assetGetTypes: build.query({
                query: ()=>({
                        url: `/pimcore-studio/api/assets/types`
                    }),
                providesTags: [
                    "Assets"
                ]
            }),
            assetBatchDelete: build.mutation({
                query: (queryArg)=>({
            ...
            assetImageStreamDynamic: build.query({
                query: (queryArg)=>({
            ...
            assetGetVideoTypes: build.query({
                query: ()=>({
                        url: `/pimcore-studio/api/assets/video/types`
                    }),
                providesTags: [
                    "Assets"
                ]
...
const { useAssetGetTypesQuery, useAssetBatchDeleteMutation, useAssetCloneMutation, useAssetCustomSettingsGetByIdQuery, useAssetGetTextDataByIdQuery, useAssetDocumentDownloadCustomQuery, useAssetDocumentStreamCustomQuery, useAssetDocumentStreamDynamicQuery, useAssetDocumentStreamPreviewQuery, useAssetDocumentDownloadByThumbnailQuery, useAssetDocumentStreamByThumbnailQuery, useAssetDownloadZipQuery, useAssetDeleteZipMutation, useAssetDownloadByIdQuery, useAssetExportZipAssetMutation, useAssetExportZipFolderMutation, useAssetGetByIdQuery, useAssetUpdateByIdMutation, useAssetDeleteGridConfigurationByConfigurationIdMutation, useAssetGetAvailableGridColumnsQuery, useAssetGetGridConfigurationByFolderIdQuery, useAssetGetSavedGridConfigurationsQuery, useAssetRemoveGridConfigurationAsFavoriteMutation, useAssetSaveGridConfigurationMutation, useAssetSetGridConfigurationAsFavoriteMutation, useAssetUpdateGridConfigurationMutation, useAssetGetGridQuery, useAssetImageDownloadCustomQuery, useAssetImageStreamCustomQuery, useAssetImageStreamDynamicQuery, useAssetImageDownloadByFormatQuery, useAssetImageStreamPreviewQuery, useAssetImageStreamQuery, useAssetImageDownloadByThumbnailQuery, useAssetImageStreamByThumbnailQuery, useAssetPatchByIdMutation, useAssetPatchFolderByIdMutation, useAssetClearThumbnailMutation, useAssetGetTreeQuery, useAssetAddMutation, useAssetUploadInfoQuery, useAssetReplaceMutation, useAssetUploadZipMutation, useAssetVideoImageThumbnailStreamQuery, useAssetVideoDownloadByThumbnailQuery, useAssetVideoThumbnailStatusQuery, useAssetVideoStreamByThumbnailQuery, useAssetGetVideoTypesQuery, useAssetCustomMetadataGetByIdQuery } = injectedRtkApi;
