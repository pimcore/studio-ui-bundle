...
"./js/src/core/modules/app/theme/utils/theme-from-url.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  getThemeIdFromUrl: () => (getThemeIdFromUrl),
  themeUrlParameter: () => (themeUrlParameter)
});
/* import */ var lodash__rspack_import_0 = __webpack_require__("webpack/sharing/consume/default/lodash/lodash");
/* import */ var lodash__rspack_import_0_default = /*#__PURE__*/__webpack_require__.n(lodash__rspack_import_0);
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
 ...
 * theme is applied.
 */ const getThemeIdFromUrl = function() {
    let search = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : window.location.search;
    var _get;
    const value = (_get = new URLSearchParams(search).get(themeUrlParameter)) === null || _get === void 0 ? void 0 : _get.trim();
    if ((0,lodash__rspack_import_0.isNil)(value) || (0,lodash__rspack_import_0.isEmpty)(value)) {
        return undefined;
    }
    return value;
};
...
const AppView = function() {
    let { themeId } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
/* import */ var _Pimcore_modules_app_theme_utils_theme_from_url__rspack_import_7 = __webpack_require__("./js/src/core/modules/app/theme/utils/theme-from-url.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
function runApp() {
    ...
    root.render(/*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_app_view__rspack_import_3.AppView, {
        themeId: (0,_Pimcore_modules_app_theme_utils_theme_from_url__rspack_import_7.getThemeIdFromUrl)()
    }, void 0, false, {
