...
/* import */ var _Pimcore_modules_app_error_handler_error_handler__rspack_import_5 = __webpack_require__("./js/src/core/modules/app/error-handler/error-handler.tsx");
/* import */ var _Pimcore_modules_app_error_handler_classes_api_error__rspack_import_6 = __webpack_require__("./js/src/core/modules/app/error-handler/classes/api-error.ts");
...
const ExportButton = (param)=>{
    ...
    _s();
    const [trigger, { isLoading }] = (0,_gdpr_data_extractor_slice_enhanced__rspack_import_3.useLazyGdprExportQuery)();
    const handleExport = async (e)=>{
        try {
            ...
            (0,_Pimcore_modules_app_error_handler_error_handler__rspack_import_5["default"])((0,_Pimcore_modules_app_error_handler_classes_api_error__rspack_import_6.isApiErrorData)(error) ? new _Pimcore_modules_app_error_handler_classes_api_error__rspack_import_6["default"](error) : new _sdk_modules_app__rspack_import_7.GeneralError(error === null || error === void 0 ? void 0 : error.message));
        }
    };
...
_s(ExportButton, "cdIsgTW/yifxnzMPeu8Iw5W2JSA=", false, function() {
    return [
