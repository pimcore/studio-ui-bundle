...
__webpack_require__.d(__webpack_exports__, {
  ...
  selectDocumentHighlightEditables: () => (selectDocumentHighlightEditables),
  selectDocumentTimeSliderVisible: () => (selectDocumentTimeSliderVisible),
  setDocumentAreablockTypes: () => (setDocumentAreablockTypes),
  setDocumentHighlightEditables: () => (setDocumentHighlightEditables),
...
const documentEditorSlice = (0,_reduxjs_toolkit__rspack_import_1.createSlice)({
    ...
    reducers: {
        ...
        setDocumentHighlightEditables: (state, action)=>{
...
const { setDocumentAreablockTypes, mergeDocumentAreablockTypes, setDocumentTimeSliderVisible, setDocumentHighlightEditables, removeDocument, clearAllDocuments } = documentEditorSlice.actions;
...
const selectDocumentHighlightEditables = (0,_reduxjs_toolkit__rspack_import_1.createSelector)([
    selectDocumentEditorState,
    (_state, documentId)=>documentId
], (documentEditorState, documentId)=>{
...
"./js/src/core/modules/document/actions/highlight-editables/highlight-editables-button.styles.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  useStyles: () => (useStyles)
});
...
"./js/src/core/modules/document/actions/highlight-editables/highlight-editables-button.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  HighlightEditablesButton: () => (HighlightEditablesButton)
});
/* import */ var react_jsx_dev_runtime__rspack_import_0 = __webpack_require__("./node_modules/react/jsx-dev-runtime.js");
...
/* import */ var _Pimcore_app_store__rspack_import_7 = __webpack_require__("./js/src/core/app/store/index.ts");
/* import */ var _Pimcore_modules_document_document_editor_slice__rspack_import_8 = __webpack_require__("./js/src/core/modules/document/document-editor-slice.ts");
/* import */ var _Pimcore_app_public_api_helpers_api_helper__rspack_import_9 = __webpack_require__("./js/src/core/app/public-api/helpers/api-helper.ts");
/* import */ var _highlight_editables_button_styles__rspack_import_10 = __webpack_require__("./js/src/core/modules/document/actions/highlight-editables/highlight-editables-button.styles.tsx");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const TYPES_WITH_EDITABLES = [
    'page',
    'snippet',
    'email'
];
const HighlightEditablesButton = ()=>{
    _s();
    const { t } = (0,react_i18next__rspack_import_2.useTranslation)();
    const { styles } = (0,_highlight_editables_button_styles__rspack_import_10.useStyles)();
    const { id } = (0,react__rspack_import_1.useContext)(_Pimcore_modules_document_document_provider__rspack_import_5.DocumentContext);
    const { document } = (0,_Pimcore_modules_document_hooks_use_document_draft__rspack_import_6.useDocumentDraft)(id);
    const isHighlighted = (0,_Pimcore_app_store__rspack_import_7.useAppSelector)((state)=>(0,_Pimcore_modules_document_document_editor_slice__rspack_import_8.selectDocumentHighlightEditables)(state, id));
    if ((document === null || document === void 0 ? void 0 : document.type) === undefined || !TYPES_WITH_EDITABLES.includes(document.type)) {
        return null;
    }
    const toggleHighlight = ()=>{
        try {
            const { document: documentApi } = (0,_Pimcore_app_public_api_helpers_api_helper__rspack_import_9.getPimcoreStudioApi)();
            documentApi.setHighlightEditables(id, !isHighlighted);
        } catch (error) {
            console.warn('Could not toggle highlight-editables state:', error);
        }
    };
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_components_icon_button_icon_button__rspack_import_4.IconButton, {
        className: classnames__rspack_import_3_default()(styles.highlightEditablesButton, {
            [styles.highlightEditablesButtonActive]: isHighlighted
        }),
        icon: {
            value: 'highlight',
        ...
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/document/actions/highlight-editables/highlight-editables-button.tsx",
        lineNumber: 49,
        columnNumber: 10
    }, undefined);
};
_s(HighlightEditablesButton, "KmeD8rBrdw6S3c+BPcitmdcpoOc=", false, function() {
    return [
        react_i18next__rspack_import_2.useTranslation,
        _highlight_editables_button_styles__rspack_import_10.useStyles,
        _Pimcore_modules_document_hooks_use_document_draft__rspack_import_6.useDocumentDraft,
        _Pimcore_app_store__rspack_import_7.useAppSelector
    ];
});
_c = HighlightEditablesButton;
var _c;
$RefreshReg$(_c, "HighlightEditablesButton");
...
__webpack_require__.d(__webpack_exports__, {
  ...
  SIDEBAR_HIGHLIGHT_EDITABLES: () => (SIDEBAR_HIGHLIGHT_EDITABLES),
...
/* import */ var react__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(react__rspack_import_1);
/* import */ var _Pimcore_components_icon_icon__rspack_import_2 = __webpack_require__("./js/src/core/components/icon/icon.tsx");
/* import */ var _Pimcore_modules_document_actions_highlight_editables_highlight_editables_button__rspack_import_3 = __webpack_require__("./js/src/core/modules/document/actions/highlight-editables/highlight-editables-button.tsx");
/* import */ var _sidebar_tabs_content_settings_content_settings_sidebar__rspack_import_4 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/tabs/content-settings/content-settings-sidebar.tsx");
/* import */ var _sidebar_tabs_areablock_types_areablock_types_sidebar__rspack_import_5 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/tabs/areablock-types/areablock-types-sidebar.tsx");
/* import */ var _sidebar_tabs_navigation_navigation_sidebar__rspack_import_6 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/tabs/navigation/navigation-sidebar.tsx");
/* import */ var _sidebar_tabs_document_configuration_document_configuration_sidebar__rspack_import_7 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/tabs/document-configuration/document-configuration-sidebar.tsx");
/* import */ var _sidebar_visibility_areablock_types_visibility__rspack_import_8 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/visibility/areablock-types-visibility.ts");
/* import */ var _sidebar_visibility_content_settings_visibility__rspack_import_9 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/visibility/content-settings-visibility.ts");
/* import */ var _sidebar_visibility_navigation_visibility__rspack_import_10 = __webpack_require__("./js/src/core/modules/document/editor/sidebar/visibility/navigation-visibility.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const SIDEBAR_AREABLOCK_TYPES = {
    ...
    component: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sidebar_tabs_areablock_types_areablock_types_sidebar__rspack_import_5.AreablockTypesSidebar, {}, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/document/editor/shared-tab-manager/sidebar-definitions.tsx",
        lineNumber: 24,
        columnNumber: 14
    }, undefined),
    tooltip: 'add-areas',
    isVisible: _sidebar_visibility_areablock_types_visibility__rspack_import_8.checkAreablockTypesVisibility
};
const SIDEBAR_CONTENT_SETTINGS = {
    ...
    component: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sidebar_tabs_content_settings_content_settings_sidebar__rspack_import_4.ContentSettingsSidebar, {}, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/document/editor/shared-tab-manager/sidebar-definitions.tsx",
        lineNumber: 31,
        columnNumber: 14
    }, undefined),
    tooltip: 'content-settings',
    isVisible: _sidebar_visibility_content_settings_visibility__rspack_import_9.checkSettingsVisibility
};
const SIDEBAR_NAVIGATION = {
    ...
    component: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sidebar_tabs_navigation_navigation_sidebar__rspack_import_6.NavigationSidebar, {}, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/document/editor/shared-tab-manager/sidebar-definitions.tsx",
        lineNumber: 38,
        columnNumber: 14
    }, undefined),
    tooltip: 'navigation.sidebar-title',
    isVisible: _sidebar_visibility_navigation_visibility__rspack_import_10.checkNavigationVisibility
};
const SIDEBAR_DOCUMENT_CONFIGURATION = {
    ...
    component: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_sidebar_tabs_document_configuration_document_configuration_sidebar__rspack_import_7.DocumentConfigurationSidebar, {}, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/document/editor/shared-tab-manager/sidebar-definitions.tsx",
        lineNumber: 45,
        columnNumber: 14
    }, undefined),
...
const SIDEBAR_HIGHLIGHT_EDITABLES = {
    ...
    component: /*#__PURE__*/ (0,react_jsx_dev_runtime__rspack_import_0.jsxDEV)(_Pimcore_modules_document_actions_highlight_editables_highlight_editables_button__rspack_import_3.HighlightEditablesButton, {}, void 0, false, {
        fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/document/editor/shared-tab-manager/sidebar-definitions.tsx",
        lineNumber: 52,
        columnNumber: 14
    }, undefined)
...
/* import */ var antd_style__rspack_import_18 = __webpack_require__("webpack/sharing/consume/default/antd-style/antd-style");
/* import */ var antd_style__rspack_import_18_default = /*#__PURE__*/__webpack_require__.n(antd_style__rspack_import_18);
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
...
const DocumentPreview = (param)=>{
    ...
    _s();
    const { t } = (0,react_i18next__rspack_import_2.useTranslation)();
    const token = (0,antd_style__rspack_import_18.useTheme)();
...
_s(DocumentPreview, "hp2KcCT1lFX56zKyZz6LTMoTVVI=", false, function() {
    return [
        react_i18next__rspack_import_2.useTranslation,
        antd_style__rspack_import_18.useTheme,
