...
const EditablesLoader = (param)=>{
    ...
    const { initializeData, notifyReady, initializeInheritanceState, initializeHighlightEditables } = (0,_hooks_use_document_editor__rspack_import_5.useDocumentEditor)();
...
_s(EditablesLoader, "NPKESROiOkVe2rwmmIp+QaPle4E=", false, function() {
    return [
