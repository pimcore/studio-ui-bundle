...
class DocumentApiImpl {
    ...
    notifyTimeSliderVisible(documentId, visible) {
        _Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__.store.dispatch((0,_Pimcore_modules_document_document_editor_slice__WEBPACK_IMPORTED_MODULE_5__.setDocumentTimeSliderVisible)({
            documentId,
            visible
        }));
    }
