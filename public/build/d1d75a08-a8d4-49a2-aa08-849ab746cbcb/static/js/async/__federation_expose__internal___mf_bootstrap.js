...
"./js/src/core/modules/app/app-loader/loader/global-message-bus/loader.ts": (function (module, __webpack_exports__, __webpack_require__) {
...
/* ESM import */var _Pimcore_modules_execution_engine_topics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./js/src/core/modules/execution-engine/topics.ts");
...
const useGlobalMessageBusLoader = ()=>{
    ...
    const initGlobalMessageBus = (userId)=>{
        ...
        try {
            const messageRegistry = _sdk_app__WEBPACK_IMPORTED_MODULE_1__.container.get(_sdk_app__WEBPACK_IMPORTED_MODULE_1__.serviceIds.globalMessageBus);
            const globalProcess = _sdk_app__WEBPACK_IMPORTED_MODULE_1__.container.get(_sdk_app__WEBPACK_IMPORTED_MODULE_1__.serviceIds.globalMessageBusProcess);
            const backgroundProcessor = _sdk_app__WEBPACK_IMPORTED_MODULE_1__.container.get(_sdk_app__WEBPACK_IMPORTED_MODULE_1__.serviceIds.backgroundProcessor);
            messageRegistry.registerTopics([
                ...Object.values(_Pimcore_modules_execution_engine_topics__WEBPACK_IMPORTED_MODULE_2__.topics),
...
/* ESM import */var _Pimcore_styles_global_styles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./js/src/core/styles/global.styles.ts");
/* ESM import */var _Pimcore_components_modal_alert_modal_hooks_use_alert_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./js/src/core/components/modal/alert-modal/hooks/use-alert-modal.tsx");
/* ESM import */var _Pimcore_modules_app_error_handler_services_error_modal_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./js/src/core/modules/app/error-handler/services/error-modal-service.ts");
/* ESM import */var _Pimcore_modules_auth_hooks_use_is_authenticated__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./js/src/core/modules/auth/hooks/use-is-authenticated.ts");
/* ESM import */var _loader_translation_loader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/translation/loader.ts");
/* ESM import */var _loader_user_loader__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/user/loader.ts");
/* ESM import */var _mercure_api_slice_gen__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./js/src/core/modules/app/mercure-api-slice.gen.ts");
/* ESM import */var _loader_settings_loader__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/settings/loader.tsx");
/* ESM import */var _loader_language_loader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/language/loader.ts");
/* ESM import */var _loader_brand_thumbnail_urls_loader__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/brand-thumbnail-urls/loader.tsx");
/* ESM import */var _loader_admin_settings_loader__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/admin-settings/loader.tsx");
/* ESM import */var _Pimcore_modules_auth_user_user_slice__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./js/src/core/modules/auth/user/user-slice.ts");
/* ESM import */var _Pimcore_modules_perspectives_hooks_use_perspectives__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("./js/src/core/modules/perspectives/hooks/use-perspectives.tsx");
/* ESM import */var antd__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("webpack/sharing/consume/default/antd/antd");
/* ESM import */var antd__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(antd__WEBPACK_IMPORTED_MODULE_18__);
/* ESM import */var _Pimcore_app_public_api_modal_modal_api__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("./js/src/core/app/public-api/modal/modal-api.ts");
...
/* ESM import */var _sdk_app__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("./js/src/sdk/app/index.ts");
/* ESM import */var _loader_global_message_bus_loader__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("./js/src/core/modules/app/app-loader/loader/global-message-bus/loader.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rsbuild/plugin-react/node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const AppLoader = (props)=>{
    ...
    const modal = (0,_Pimcore_components_modal_alert_modal_hooks_use_alert_modal__WEBPACK_IMPORTED_MODULE_6__.useAlertModal)();
    const { modal: studioModal } = antd__WEBPACK_IMPORTED_MODULE_18__.App.useApp();
    // Register the modal instance to allow centralized error message display throughout the project
    _Pimcore_modules_app_error_handler_services_error_modal_service__WEBPACK_IMPORTED_MODULE_7__.ErrorModalService.setModalInstance(modal);
    // Register the modal instance for iframe communication
    _Pimcore_app_public_api_modal_modal_api__WEBPACK_IMPORTED_MODULE_19__.modalApi.setModalInstance(studioModal);
    const { isAuthenticated } = (0,_Pimcore_modules_auth_hooks_use_is_authenticated__WEBPACK_IMPORTED_MODULE_8__.useIsAuthenticated)();
    const { loadPublicTranslations, loadTranslations } = (0,_loader_translation_loader__WEBPACK_IMPORTED_MODULE_9__.useTranslationLoader)();
    const { loadUser } = (0,_loader_user_loader__WEBPACK_IMPORTED_MODULE_10__.useUserLoader)();
    const [fetchMercureCookie] = (0,_mercure_api_slice_gen__WEBPACK_IMPORTED_MODULE_11__.useMercureCreateCookieMutation)();
    const { loadSettings } = (0,_loader_settings_loader__WEBPACK_IMPORTED_MODULE_12__.useSettingsLoader)();
    const { loadAvailableLocales } = (0,_loader_language_loader__WEBPACK_IMPORTED_MODULE_13__.useLanguageLoader)();
    const { loadBrandThumbnailUrls } = (0,_loader_brand_thumbnail_urls_loader__WEBPACK_IMPORTED_MODULE_14__.useBrandThumbnailUrlLoader)();
    const { loadAdminSettings } = (0,_loader_admin_settings_loader__WEBPACK_IMPORTED_MODULE_15__.useAdminSettingsLoader)();
    const { loadPerspective } = (0,_Pimcore_modules_perspectives_hooks_use_perspectives__WEBPACK_IMPORTED_MODULE_17__.usePerspectives)();
    const { initGlobalMessageBus } = (0,_loader_global_message_bus_loader__WEBPACK_IMPORTED_MODULE_22__.useGlobalMessageBusLoader)();
    const appLoaderRegistry = _sdk_app__WEBPACK_IMPORTED_MODULE_21__.container.get(_sdk_app__WEBPACK_IMPORTED_MODULE_21__.serviceIds["AppLoader/Registry"]);
    async function initActivePerspective() {
        const user = (0,_Pimcore_modules_auth_user_user_slice__WEBPACK_IMPORTED_MODULE_16__.selectCurrentUser)(_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_3__.store.getState());
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        void (async ()=>{
            ...
            if (isAuthenticated) {
                ...
                const user = (0,_Pimcore_modules_auth_user_user_slice__WEBPACK_IMPORTED_MODULE_16__.selectCurrentUser)(_Pimcore_app_store__WEBPACK_IMPORTED_MODULE_3__.store.getState());
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isNil)(user === null || user === void 0 ? void 0 : user.id)) {
                ...
                await Promise.all([
                    ...
                    (0,_Pimcore_modules_reports_utils_reports_loader__WEBPACK_IMPORTED_MODULE_20__.loadReportsMenuItems)()
                ]);
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_Pimcore_styles_global_styles__WEBPACK_IMPORTED_MODULE_5__.GlobalStyles, {}, void 0, false, {
                fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/app/app-loader/app-loader.tsx",
                lineNumber: 105,
                columnNumber: 7
            }, undefined),
            isLoading && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_Pimcore_components_content_content__WEBPACK_IMPORTED_MODULE_4__.Content, {
                loading: true
            }, void 0, false, {
                fileName: "/var/www/dev-bundles/pimcore/studio-ui-bundle/assets/js/src/core/modules/app/app-loader/app-loader.tsx",
                lineNumber: 107,
...
_s(AppLoader, "ccjmZMyV3Uzk2KAowAnkmfWNp1A=", false, function() {
    return [
        _Pimcore_components_modal_alert_modal_hooks_use_alert_modal__WEBPACK_IMPORTED_MODULE_6__.useAlertModal,
        antd__WEBPACK_IMPORTED_MODULE_18__.App.useApp,
        _Pimcore_modules_auth_hooks_use_is_authenticated__WEBPACK_IMPORTED_MODULE_8__.useIsAuthenticated,
        _loader_translation_loader__WEBPACK_IMPORTED_MODULE_9__.useTranslationLoader,
        _loader_user_loader__WEBPACK_IMPORTED_MODULE_10__.useUserLoader,
        _mercure_api_slice_gen__WEBPACK_IMPORTED_MODULE_11__.useMercureCreateCookieMutation,
        _loader_settings_loader__WEBPACK_IMPORTED_MODULE_12__.useSettingsLoader,
        _loader_language_loader__WEBPACK_IMPORTED_MODULE_13__.useLanguageLoader,
        _loader_brand_thumbnail_urls_loader__WEBPACK_IMPORTED_MODULE_14__.useBrandThumbnailUrlLoader,
        _loader_admin_settings_loader__WEBPACK_IMPORTED_MODULE_15__.useAdminSettingsLoader,
        _Pimcore_modules_perspectives_hooks_use_perspectives__WEBPACK_IMPORTED_MODULE_17__.usePerspectives,
        _loader_global_message_bus_loader__WEBPACK_IMPORTED_MODULE_22__.useGlobalMessageBusLoader
    ];
});
_c = AppLoader;
var _c;
...
"./js/src/core/modules/app/app-loader/loader/admin-settings/loader.tsx": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* ESM import */var _Pimcore_app_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./js/src/core/app/store/index.ts");
/* ESM import */var _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./js/src/core/modules/app/error-handler/index.ts");
/* ESM import */var _Pimcore_modules_app_settings_settings_slice_gen__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./js/src/core/modules/app/settings/settings-slice.gen.ts");
/* ESM import */var _Pimcore_modules_app_settings_settings_slice__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./js/src/core/modules/app/settings/settings-slice.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rsbuild/plugin-react/node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
const useAdminSettingsLoader = ()=>{
    ...
    const loadAdminSettings = async ()=>{
        const adminSettingsFetcher = dispatch(_Pimcore_modules_app_settings_settings_slice_gen__WEBPACK_IMPORTED_MODULE_2__.api.endpoints.adminSettingsGet.initiate());
        await adminSettingsFetcher.then((param)=>{
            let { data, isSuccess, isError, error } = param;
            if (isError) {
                (0,_Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__["default"])(new _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__.ApiError(error));
            } else if (isSuccess && data !== undefined) {
                dispatch((0,_Pimcore_modules_app_settings_settings_slice__WEBPACK_IMPORTED_MODULE_3__.setAdminSettings)(data));
            }
        }).catch(()=>{
            (0,_Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__["default"])(new _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__.GeneralError('Error loading admin settings'));
        });
    };
    return {
        loadAdminSettings
...
"./js/src/core/modules/app/app-loader/loader/brand-thumbnail-urls/loader.tsx": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
const useBrandThumbnailUrlLoader = ()=>{
    ...
    const loadBrandThumbnailUrls = async ()=>{
        const thumbnailsFetcher = dispatch(_Pimcore_modules_app_settings_settings_slice_gen__WEBPACK_IMPORTED_MODULE_2__.api.endpoints.settingAdminThumbnail.initiate());
        await thumbnailsFetcher.then((param)=>{
            let { data, isSuccess, isError, error } = param;
            if (isError) {
                (0,_Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__["default"])(new _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__.ApiError(error));
            } else if (isSuccess && data !== undefined) {
                dispatch((0,_Pimcore_modules_app_settings_settings_slice__WEBPACK_IMPORTED_MODULE_3__.setThumbnails)(data));
            }
        }).catch(()=>{
            (0,_Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__["default"])(new _Pimcore_modules_app_error_handler__WEBPACK_IMPORTED_MODULE_1__.GeneralError('Error loading brand thumbnail URLs'));
        });
    };
    return {
        loadBrandThumbnailUrls
