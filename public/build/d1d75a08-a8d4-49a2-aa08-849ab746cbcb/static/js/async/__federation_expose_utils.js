...
"./js/src/core/utils/language.ts": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function getLanguageName(param) {
    ...
    lng ?? (lng = (i18next__WEBPACK_IMPORTED_MODULE_0___default().language));
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  addCacheBusterToUrl: () => (/* reexport safe */ _Pimcore_utils_url_cache_buster__WEBPACK_IMPORTED_MODULE_15__.addCacheBusterToUrl),
  buildQueryString: () => (/* reexport safe */ _Pimcore_utils_query_string__WEBPACK_IMPORTED_MODULE_13__.buildQueryString),
  ...
  fetchBlobWithPolling: () => (/* reexport safe */ _Pimcore_utils_polling_helper__WEBPACK_IMPORTED_MODULE_12__.fetchBlobWithPolling),
  ...
  formatNumber: () => (/* reexport safe */ _Pimcore_utils_number__WEBPACK_IMPORTED_MODULE_11__.formatNumber),
  formatRelativeTime: () => (/* reexport safe */ _Pimcore_utils_relative_time__WEBPACK_IMPORTED_MODULE_14__.formatRelativeTime),
  ...
  getLanguageName: () => (/* reexport safe */ _Pimcore_utils_language__WEBPACK_IMPORTED_MODULE_10__.getLanguageName),
  getLocalStorageItem: () => (/* reexport safe */ _Pimcore_utils_local_storage__WEBPACK_IMPORTED_MODULE_18__.getLocalStorageItem),
  ...
  isDontAskAgainEnabled: () => (/* reexport safe */ _Pimcore_utils_local_storage__WEBPACK_IMPORTED_MODULE_18__.isDontAskAgainEnabled),
  isEmptyValue: () => (/* reexport safe */ _Pimcore_utils_type_utils__WEBPACK_IMPORTED_MODULE_17__.isEmptyValue),
  ...
  isNonEmptyString: () => (/* reexport safe */ _Pimcore_utils_type_utils__WEBPACK_IMPORTED_MODULE_17__.isNonEmptyString),
  ...
  removeLocalStorageItem: () => (/* reexport safe */ _Pimcore_utils_local_storage__WEBPACK_IMPORTED_MODULE_18__.removeLocalStorageItem),
  ...
  setDontAskAgain: () => (/* reexport safe */ _Pimcore_utils_local_storage__WEBPACK_IMPORTED_MODULE_18__.setDontAskAgain),
  setLocalStorageItem: () => (/* reexport safe */ _Pimcore_utils_local_storage__WEBPACK_IMPORTED_MODULE_18__.setLocalStorageItem),
  ...
  useClickOutside: () => (/* reexport safe */ _Pimcore_utils_hooks_use_click_outside__WEBPACK_IMPORTED_MODULE_19__.useClickOutside),
  useCssContainer: () => (/* reexport safe */ _Pimcore_utils_hooks_use_css_container_use_css_container__WEBPACK_IMPORTED_MODULE_20__.useCssContainer),
  useDebounce: () => (/* reexport safe */ _Pimcore_utils_hooks_use_debounce__WEBPACK_IMPORTED_MODULE_25__.useDebounce),
  useElementResize: () => (/* reexport safe */ _Pimcore_utils_hooks_use_element_resize__WEBPACK_IMPORTED_MODULE_21__.useElementResize),
  useElementVisible: () => (/* reexport safe */ _Pimcore_utils_hooks_use_element_visible__WEBPACK_IMPORTED_MODULE_22__.useElementVisible),
  usePrevious: () => (/* reexport safe */ _Pimcore_utils_hooks_use_previous__WEBPACK_IMPORTED_MODULE_23__.usePrevious),
  useServerSideEvent: () => (/* reexport safe */ _Pimcore_utils_hooks_use_server_side_event__WEBPACK_IMPORTED_MODULE_24__.useServerSideEvent),
  uuid: () => (/* reexport safe */ _Pimcore_utils_uuid__WEBPACK_IMPORTED_MODULE_16__.uuid)
});
...
/* ESM import */var _Pimcore_utils_language__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./js/src/core/utils/language.ts");
/* ESM import */var _Pimcore_utils_number__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./js/src/core/utils/number.ts");
/* ESM import */var _Pimcore_utils_polling_helper__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./js/src/core/utils/polling-helper.ts");
/* ESM import */var _Pimcore_utils_query_string__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./js/src/core/utils/query-string.ts");
/* ESM import */var _Pimcore_utils_relative_time__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./js/src/core/utils/relative-time.ts");
/* ESM import */var _Pimcore_utils_url_cache_buster__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./js/src/core/utils/url-cache-buster.ts");
/* ESM import */var _Pimcore_utils_uuid__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./js/src/core/utils/uuid.ts");
/* ESM import */var _Pimcore_utils_type_utils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("./js/src/core/utils/type-utils.ts");
/* ESM import */var _Pimcore_utils_local_storage__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("./js/src/core/utils/local-storage.ts");
/* ESM import */var _Pimcore_utils_hooks_use_click_outside__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("./js/src/core/utils/hooks/use-click-outside.ts");
/* ESM import */var _Pimcore_utils_hooks_use_css_container_use_css_container__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__("./js/src/core/utils/hooks/use-css-container/use-css-container.tsx");
/* ESM import */var _Pimcore_utils_hooks_use_element_resize__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("./js/src/core/utils/hooks/use-element-resize.ts");
/* ESM import */var _Pimcore_utils_hooks_use_element_visible__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("./js/src/core/utils/hooks/use-element-visible.ts");
/* ESM import */var _Pimcore_utils_hooks_use_previous__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__("./js/src/core/utils/hooks/use-previous.ts");
/* ESM import */var _Pimcore_utils_hooks_use_server_side_event__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__("./js/src/core/utils/hooks/use-server-side-event.ts");
/* ESM import */var _Pimcore_utils_hooks_use_debounce__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__("./js/src/core/utils/hooks/use-debounce.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rsbuild/plugin-react/node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
