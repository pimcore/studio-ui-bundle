/*! For license information please see __federation_expose__internal___mf_bootstrap.2d8f32ff.js.LICENSE.txt */
"use strict";(self["chunk_pimcore_studio_ui_bundle "]=self["chunk_pimcore_studio_ui_bundle "]||[]).push([["2108"],{60656(e,t,i){i.r(t),i.d(t,{PimcoreStudio:()=>h,Pimcore:()=>s});var a=i(63364),n=i(92812),r=i(88358),m=i(35864),o=i(25085);let d=new class{getTranslationResources(){let e={};return(r.A.languages??[]).forEach(t=>{let i=r.A.getResourceBundle(t,"translation");(0,m.isNil)(i)||(e[t]=i)}),e}getCurrentLanguage(){return r.A.language}getFallbackLanguage(){let e=r.A.options.fallbackLng;if(Array.isArray(e))return e[0]??"en";if((0,o.isNonEmptyString)(e))return e;if((0,m.isPlainObject)(e)){var t;return(null==(t=e.default)?void 0:t[0])??"en"}return"en"}reportMissingTranslation(e){r.A.emit("missingKey",[r.A.language],"translation",e,e)}};var g=i(57259),p=i(81607),l=i(70463);let s={container:a.kL},h={document:n.I,i18n:d,element:g.h,modal:p.Y,settings:l.a}},81607(e,t,i){i.d(t,{Y:()=>r});var a=i(35864);let n=null,r=new class{setModalInstance(e){n=e}getModalInstance(){if((0,a.isNull)(n))throw Error("Modal instance not initialized. Make sure App.useApp() is called in the parent window.");return n}constructor(){this.info=e=>this.getModalInstance().info(e),this.success=e=>this.getModalInstance().success(e),this.error=e=>this.getModalInstance().error(e),this.warning=e=>this.getModalInstance().warning(e),this.confirm=e=>this.getModalInstance().confirm(e)}}},70463(e,t,i){i.d(t,{a:()=>n});var a=i(72098);let n=new class{initialize(e){this.store=e}getSettings(){if(null===this.store)return console.warn("Settings API not initialized - Redux store not available"),null;try{return(0,a.mt)(this.store.getState())}catch(e){return console.error("Failed to get settings from store:",e),null}}areSettingsAvailable(){return null!==this.store&&null!==(0,a.mt)(this.store.getState())}constructor(){this.store=null}}},55831(e,t,i){i.a(e,async function(a,n){try{i.r(t),i(20058);var r=i(53458),m=i(80323),o=i(60656),d=i(27755);e=i.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(i.bind(i,60656))).Pimcore,window.PimcoreStudio=o.PimcoreStudio,window.addEventListener("load",async()=>{await m.f.loadPlugins(),m.f.initPlugins(),m.f.startupPlugins(),d.s.initModules(),(0,r.T)()}),n()}catch(e){n(e)}},1)},53458(e,t,i){i.d(t,{T:()=>H});var a=i(74848),n=i(47867),r=i(5338),m=i(64471),o=i(86569),d=i(52725),g=i(2659),p=i(35864),l=i(41630),s=i(39154),h=i(77885),x=i(44241);let c=(0,x.createGlobalStyle)`
  * {
...
`;var u=i(92203),$=i(86375),b=i(19808),X=i(88358),f=i(55638),S=i(74365),w=i(73565),L=i(46881),v=i(52178);let{useMercureCreateCookieMutation:y}=i(53073).api.enhanceEndpoints({addTagTypes:["Mercure"]}).injectEndpoints({endpoints:e=>({mercureCreateCookie:e.mutation({query:()=>({url:"/pimcore-studio/api/mercure/auth",method:"POST"}),invalidatesTags:["Mercure"]})}),overrideExisting:!1});var M=i(72098),k=i(52626),A=i(63824),E=i(76374),D=i(81607),G=i(1019),z=i(66410);let P=(0,n.createContext)({registerLoader:()=>{},unregisterLoader:()=>{},isAppLoading:!1}),j=e=>{let t,i,r,m,d,[g,x]=(0,n.useState)("loading"),[j,I]=(0,n.useState)(new Set),T=(0,n.useCallback)(e=>{I(t=>new Set(t).add(e))},[]),_=(0,n.useCallback)(e=>{I(t=>{let i=new Set(t);return i.delete(e),i})},[]),R="loading"===g||"outro"===g||j.size>0,C=(0,n.useMemo)(()=>({registerLoader:T,unregisterLoader:_,isAppLoading:R}),[T,_,R]),F=(0,n.useRef)(null),B=(0,n.useCallback)(()=>{x("outro"),F.current=setTimeout(()=>{x("idle")},1e3)},[]);(0,n.useEffect)(()=>()=>{null!==F.current&&clearTimeout(F.current)},[]);let H=(0,u.Z)(),{modal:U}=o.App.useApp();$.B.setModalInstance(H),D.Y.setModalInstance(U);let{isAuthenticated:N}=(0,b.X)(),{loadPublicTranslations:O,loadTranslations:Y}=(()=>{let[e]=(0,S.oG)();return{loadPublicTranslations:async()=>{await e({translation:{locale:X.g,keys:[],useFallback:!0}}).unwrap().then(e=>{X.A.addResourceBundle(X.g,"translation",e.keys??[],!0,!0),X.A.changeLanguage(X.g)}).catch(()=>{throw(0,f.Ay)(new f.$g("Error loading translations")),Error("Error loading translations")})},loadTranslations:async()=>{let t=(0,w.xu)(l.M_.getState());await e({translation:{locale:t.language,keys:[],useFallback:!0}}).unwrap().then(e=>{X.A.addResourceBundle(t.language,"translation",e.keys??[],!0,!0),X.A.changeLanguage(t.language)}).catch(e=>{console.error("Error loading translations",e),(0,f.Ay)(new f.$g("Error loading translations"))})}}})(),{loadUser:K}=(t=(0,L.useAppDispatch)(),{loadUser:async()=>{let e=t(v.FH.endpoints.userGetCurrentInformation.initiate());await e.then(e=>{let{data:i,isSuccess:a,isError:n,error:r}=e;n?(0,f.Ay)(new f.hD(r)):a&&void 0!==i&&t((0,w.gV)(i))}).catch(e=>{throw(0,f.Ay)(new f.$g("Error loading user information")),Error("Error loading user information",{cause:e})})}}),[W]=y(),{loadSettings:q}=(i=(0,L.useAppDispatch)(),{loadSettings:async()=>{i(k.FH.endpoints.systemSettingsGet.initiate()).then(e=>{let{data:t,isSuccess:a,isError:n,error:r}=e;n&&(0,f.Ay)(new f.hD(r)),a&&void 0!==t&&i((0,M.oc)(t))}).catch(()=>{})}}),{loadAvailableLocales:Q}={loadAvailableLocales:async()=>{try{await l.M_.dispatch(A.FH.endpoints.translationGetAvailableLocales.initiate(void 0,{forceRefetch:!1,subscribe:!0})).unwrap()}catch(e){throw(0,f.Ay)(new f.$g("Error loading available locales")),e}}},{loadBrandThumbnailUrls:V}=(r=(0,L.useAppDispatch)(),{loadBrandThumbnailUrls:async()=>{let e=r(k.FH.endpoints.settingAdminThumbnail.initiate());await e.then(e=>{let{data:t,isSuccess:i,isError:a,error:n}=e;a?(0,f.Ay)(new f.hD(n)):i&&void 0!==t&&r((0,M.MM)(t))}).catch(()=>{(0,f.Ay)(new f.$g("Error loading brand thumbnail URLs"))})}}),{loadAdminSettings:Z}=(m=(0,l.jL)(),{loadAdminSettings:async()=>{let e=m(k.FH.endpoints.adminSettingsGet.initiate());await e.then(e=>{let{data:t,isSuccess:i,isError:a,error:n}=e;a?(0,f.Ay)(new f.hD(n)):i&&void 0!==t&&m((0,M.XE)(t))}).catch(()=>{(0,f.Ay)(new f.$g("Error loading admin settings"))})}}),{loadPerspective:J}=(0,E.n)(),{initGlobalMessageBus:ee}=(d=(0,n.useRef)(!1),{initGlobalMessageBus:e=>{if(!d.current)try{let t=L.container.get(L.serviceIds.globalMessageBus),i=L.container.get(L.serviceIds.globalMessageBusProcess),a=L.container.get(L.serviceIds.backgroundProcessor);t.registerTopics([...Object.values(z.v),`studio-backend-default/user/${e}`]),a.registerProcess(i),t.startGlobalSubscription(),document.addEventListener("visibilitychange",()=>{"visible"!==document.visibilityState||i.isConnected()||i.start()}),window.addEventListener("online",()=>{i.start()}),d.current=!0}catch(e){console.error("Failed to initialize global message bus:",e)}}}),et=L.container.get(L.serviceIds["AppLoader/Registry"]);async function ei(){let e=(0,w.xu)(l.M_.getState()),t=String((null==e?void 0:e.activePerspective)??"studio_default_perspective");return await J(t)}return(0,n.useEffect)(()=>{(async()=>{if(x("loading"),void 0!==N&&(N||await Promise.all([O(),V()]).then(()=>{B()}).catch(e=>{console.error("Error during login preparation",e)}),N)){await Promise.all([K()]),await W();let e=(0,w.xu)(l.M_.getState());(0,p.isNil)(null==e?void 0:e.id)||ee(e.id),await Promise.all([Y(),q(),Z(),V(),Q(),ei(),(0,G.N)()]),await et.loadAll(),B()}})()},[N]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(c,{}),(0,a.jsxs)(P.Provider,{value:C,children:[(0,a.jsx)(h.bU,{component:h.eb.app.background.name,props:{phase:g}}),"idle"===g&&(0,a.jsxs)("div",{style:{position:"absolute",inset:0,animation:`${s.y} 600ms ease 200ms both`},children:["            ",e.children]})]})]})};var I=i(37327),T=i(13947),_=i(17777),R=i(81558),C=i(63993);let F=()=>(0,a.jsx)(n.StrictMode,{children:(0,a.jsx)(T.A,{children:(0,a.jsx)(m.D,{children:(0,a.jsx)(o.App,{notification:{stack:!1},children:(0,a.jsx)(C._,{children:(0,a.jsxs)(_.Y,{children:[(0,a.jsx)(R.bk,{}),(0,a.jsx)(I.M,{children:(0,a.jsx)(j,{children:(0,a.jsx)(d.RouterProvider,{router:g.QB})})})]})})})})})});var B=i(70463);function H(){B.a.initialize(l.M_);let e=document.getElementById("app");null===e?(0,f.Ay)(new f.$g("Root element not found")):(0,r.createRoot)(e).render((0,a.jsx)(F,{}))}}}]);