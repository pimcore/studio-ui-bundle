/*! For license information please see __federation_expose__internal___mf_bootstrap.40917a33.js.LICENSE.txt */
"use strict";(self.webpackChunkpimcore_studio_ui_bundle=self.webpackChunkpimcore_studio_ui_bundle||[]).push([["8785"],{8178:function(e,i,a){a.d(i,{LA:()=>n,d_:()=>r,hi:()=>m,wG:()=>p});var t=a(42125);let n=["Settings"],m=t.api.enhanceEndpoints({addTagTypes:n}).injectEndpoints({endpoints:e=>({systemSettingsGet:e.query({query:()=>({url:"/pimcore-studio/api/settings"}),providesTags:["Settings"]}),activeBundlesGet:e.query({query:()=>({url:"/pimcore-studio/api/settings/active-bundles"}),providesTags:["Settings"]})}),overrideExisting:!1}),{useSystemSettingsGetQuery:r,useActiveBundlesGetQuery:p}=m},11918:function(e,i,a){a.a(e,async function(t,n){try{a.r(i),a(39959);var m=a(483),r=a(55620),p=a(80452),g=a(69984);e=a.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(a.bind(a,80452))).Pimcore,window.PimcoreStudio=p.PimcoreStudio,window.addEventListener("load",async()=>{await r.p.loadPlugins(),r.p.initPlugins(),r.p.startupPlugins(),g._.initModules(),(0,m.m)()}),n()}catch(e){n(e)}},1)},483:function(e,i,a){a.d(i,{m:()=>R});var t=a(85893),n=a(81004),m=a(20745),r=a(13436),p=a(26788),g=a(20602),d=a(78712),o=a(46309),l=a(62368),h=a(29202);let s=(0,h.createGlobalStyle)`
  * {
