 ...
 */
"use strict";
(self["chunk_pimcore_studio_ui_bundle "] = self["chunk_pimcore_studio_ui_bundle "] || []).push([["__federation_expose_default_export"], {
"./js/src/core/lib/event-bus/event-types.ts"(module, __webpack_exports__, __webpack_require__) {
...
"./js/src/core/lib/event-bus/index.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  eventBus: () => (eventBus),
  eventTypes: () => (/* reexport safe */ _event_types__rspack_import_1.eventTypes)
});
...
/* import */ var _event_types__rspack_import_1 = __webpack_require__("./js/src/core/lib/event-bus/event-types.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
...
class EventBus {
    ...
    publish(event) {
        this.subscribers.forEach((subscriber)=>{
            ...
            const idMatches = (0,lodash__rspack_import_0.isUndefined)(subscriber.identifier.id) || subscriber.identifier.id === event.identifier.id;
...
"./js/src/core/modules/widget-editor/services/widget-context-menu-item-registry.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
ElementTreeWidgetPermissionRegistry = (0,_swc_helpers_ts_decorate__rspack_import_1.__decorate)([
...
"./js/src/sdk/main.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  ElementTreeWidgetPermissionRegistry: () => (/* reexport safe */ _Pimcore_modules_widget_editor_services_widget_context_menu_item_registry__rspack_import_1.ElementTreeWidgetPermissionRegistry),
  Pimcore: () => (Pimcore),
  container: () => (container),
  eventBus: () => (/* reexport safe */ _Pimcore_lib_event_bus__rspack_import_0.eventBus),
  eventTypes: () => (/* reexport safe */ _Pimcore_lib_event_bus__rspack_import_0.eventTypes)
});
/* import */ var _Pimcore_lib_event_bus__rspack_import_0 = __webpack_require__("./js/src/core/lib/event-bus/index.ts");
/* import */ var _Pimcore_modules_widget_editor_services_widget_context_menu_item_registry__rspack_import_1 = __webpack_require__("./js/src/core/modules/widget-editor/services/widget-context-menu-item-registry.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("./node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
/**
 * This source file is available under the terms of the
 * Pimcore Open Core License (POCL)
