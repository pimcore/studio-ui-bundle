...
import { type BatchDeleteJob } from '@Pimcore/modules/execution-engine/jobs/batch-delete/factory'

export interface BatchDeleteProps extends JobProps {
  config: BatchDeleteJob['config']
  refreshGrid: () => Promise<void>
}
export const NotificationJobContainer = (props: BatchDeleteProps): React.JSX.Element => {
