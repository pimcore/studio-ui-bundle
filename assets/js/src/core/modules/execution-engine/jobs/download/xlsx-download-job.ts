...
export class XlsxDownloadJob extends AbstractDownloadJob {
  ...
  protected static override getTitle (): string { return t('jobs.download-xlsx-job.title') }
  protected static override getDownloadUrl (): string { return `${getPrefix()}/export/download/xlsx/{jobRunId}` }
...
void (XlsxDownloadJob satisfies RehydratableJob)
