...
@injectable()
export class VideoTransformationDynamicTypeRegistry extends DynamicTypeRegistryAbstract<TransformationDynamicTypeAbstract> {
  public static readonly SERVICE_ID = 'video-thumbnails.transformation-dynamic-type-registry'
