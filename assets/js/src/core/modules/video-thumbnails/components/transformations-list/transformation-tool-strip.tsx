...
export interface VideoTransformationToolStripProps {
      ...
      <Space size="mini">
        {onMoveUp != null && (
          <IconButton
            ...
            onClick={ onMoveUp }
            size="small"
            title={ t('video-thumbnails.transformations.move-up') }
          />
        )}
        ...
        {onMoveDown != null && (
          <IconButton
            ...
            onClick={ onMoveDown }
            size="small"
            title={ t('video-thumbnails.transformations.move-down') }
          />
        )}
        ...
        <IconButton
          ...
          onClick={ onRemove }
          size="small"
          title={ t('video-thumbnails.transformations.remove') }
        />
      </Space>
    </ToolStrip>
  )
