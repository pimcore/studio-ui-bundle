...
interface VideoTransformationItemProps {
...
const VideoTransformationItem = memo(({
  transformation,
  onRemove,
  onUpdate,
  onMoveUp,
  onMoveDown
}: VideoTransformationItemProps): React.JSX.Element => {
...
VideoTransformationItem.displayName = 'VideoTransformationItem'
