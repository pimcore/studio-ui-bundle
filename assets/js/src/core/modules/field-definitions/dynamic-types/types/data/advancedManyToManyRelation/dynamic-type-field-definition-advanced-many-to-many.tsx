...
import { FieldDefinitionAdvancedManyToManyRelationFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/advancedManyToManyRelation/field-definition-advanced-many-to-many-relation-form-fields'
...
export class DynamicTypeFieldDefinitionAdvancedManyToMany extends DynamicTypeFieldDefinitionDataAbstract {
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionAdvancedManyToManyRelationFormFields
        context={ context }
