...
import { FieldDefinitionLinkFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/link/field-definition-link-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionLink extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'link'
