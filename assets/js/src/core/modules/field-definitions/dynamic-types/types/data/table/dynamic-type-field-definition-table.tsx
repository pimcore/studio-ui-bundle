...
import { FieldDefinitionTableFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/table/field-definition-table-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionTable extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'table'

  getIcon (): ElementIcon {
    return { type: 'name', value: 'table' }
  }
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionTableFormFields
        context={ context }
