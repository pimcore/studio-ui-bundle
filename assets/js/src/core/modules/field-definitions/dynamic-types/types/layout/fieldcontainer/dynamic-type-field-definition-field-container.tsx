...
import { FieldDefinitionFieldContainerFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/layout/fieldcontainer/field-definition-field-container-form-fields'
import { type ElementIcon } from '@sdk/components'
import React from 'react'

export class DynamicTypeFieldDefinitionFieldContainer extends DynamicTypeFieldDefinitionLayoutAbstract {
  id: string = 'fieldcontainer'

  getGroup (): string[] {
    return [...super.getGroup(), 'fieldcontainer']
  }
