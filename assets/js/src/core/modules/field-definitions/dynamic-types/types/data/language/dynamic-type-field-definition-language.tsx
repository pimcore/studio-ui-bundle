...
import { FieldDefinitionLanguageFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/language/field-definition-language-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionLanguage extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'language'

  getIcon (): ElementIcon {
    return { type: 'name', value: 'language-select' }
  }
