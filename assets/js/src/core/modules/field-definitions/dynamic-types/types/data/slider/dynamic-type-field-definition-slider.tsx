...
import { FieldDefinitionSliderFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/slider/field-definition-slider-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionSlider extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'slider'

  getIcon (): ElementIcon {
    return { type: 'name', value: 'slider' }
  }
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionSliderFormFields
        context={ context }
