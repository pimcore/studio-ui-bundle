...
import { FieldDefinitionAdvancedManyToManyObjectRelationFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/advancedManyToManyObjectRelation/field-definition-advanced-many-to-many-object-relation-form-fields'
...
export class DynamicTypeFieldDefinitionAdvancedManyToManyObject extends DynamicTypeFieldDefinitionDataAbstract {
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionAdvancedManyToManyObjectRelationFormFields
        context={ context }
