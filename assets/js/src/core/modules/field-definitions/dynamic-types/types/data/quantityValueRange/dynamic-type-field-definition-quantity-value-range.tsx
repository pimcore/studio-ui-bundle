...
import { FieldDefinitionQuantityValueRangeFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/quantityValueRange/field-definition-quantity-value-range-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionQuantityValueRange extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'quantityValueRange'

  getIcon (): ElementIcon {
    return { type: 'name', value: 'quantity-value-range' }
  }
