...
import { FieldDefinitionGeopolylineFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/geopolyline/field-definition-geopolyline-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionGeopolyline extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'geopolyline'

  getIcon (): ElementIcon {
    return { type: 'name', value: 'geographical-polyline' }
  }
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionGeopolylineFormFields
        context={ context }
