...
import { FieldDefinitionWysiwygFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/wysiwyg/field-definition-wysiwyg-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionWysiwyg extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'wysiwyg'
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionWysiwygFormFields
        context={ context }
