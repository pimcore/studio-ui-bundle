...
import { FieldDefinitionUrlSlugFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/urlSlug/field-definition-url-slug-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionUrlSlug extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'urlSlug'
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionUrlSlugFormFields
        context={ context }
