...
import { FieldDefinitionGeopointFormFields } from '@Pimcore/modules/field-definitions/dynamic-types/types/data/geopoint/field-definition-geopoint-form-fields'
import { type ElementIcon } from '@sdk/modules/widget-manager'
import React from 'react'

export class DynamicTypeFieldDefinitionGeopoint extends DynamicTypeFieldDefinitionDataAbstract {
  id: string = 'geopoint'

  getIcon (): ElementIcon {
    return { type: 'name', value: 'location-marker' }
  }
  ...
  getSpecificFormFields (context: FieldDefinitionContext): React.JSX.Element {
    ...
    return (
      <FieldDefinitionGeopointFormFields
        context={ context }
