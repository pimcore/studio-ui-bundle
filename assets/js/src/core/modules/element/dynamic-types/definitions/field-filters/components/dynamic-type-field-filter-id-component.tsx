...
export interface DynamicTypeFieldFilterIdProps extends AbstractFieldFilterDefinition {}

export const DynamicTypeFieldFilterIdComponent = (props: DynamicTypeFieldFilterIdProps): React.JSX.Element => {
