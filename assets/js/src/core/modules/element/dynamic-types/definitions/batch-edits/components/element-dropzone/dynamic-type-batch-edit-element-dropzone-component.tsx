...
export const DynamicTypeBatchEditElementDropzoneComponent = ({ batchEdit, ...props }: DynamicTypeBatchEditElementDropzoneProps): React.JSX.Element => {
  const { key } = batchEdit

  console.log('----->>>> DynamicTypeBatchEditElementDropzoneComponent props: ', props)
