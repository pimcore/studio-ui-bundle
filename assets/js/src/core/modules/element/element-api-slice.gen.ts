...
export type ElementGetIdByPathApiResponse = /** status 200 element_get_id_by_path_success_response */ {
    /** ID of the element */
    id: number;
};
...
export type ElementResolveBySearchTermApiResponse = /** status 200 element_resolve_success_response */ {
    /** ID of the element */
    id: number;
};
