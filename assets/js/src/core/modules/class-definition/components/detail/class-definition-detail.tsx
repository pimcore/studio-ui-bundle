...
import { type ClassDefinitionPartial } from '@Pimcore/modules/class-definition/components/tabs/class-definition-tabs/class-defintion-tabs-provider'
import { type Layout, useClassDefinitionGetByIdQuery, useClassDefinitionGetLayoutByIdQuery } from '@sdk/api/class-definition'
