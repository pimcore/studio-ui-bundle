...
interface AssetContextMenuOptionsPanelProps {
  items: string[]
  isLoading: boolean
}

export const AssetContextMenuOptionsPanel = ({ items, isLoading }: AssetContextMenuOptionsPanelProps): React.JSX.Element => {
