  ...
  return (
    <>
      <Dropdown
        menu={ menu }
      >
        <DropdownButton data-testid="listing-batch-actions-button" key={ 'dropdown-button' }>{hasSelectedItems ? t('listing.actions') : t('listing.non-selected.actions')}</DropdownButton>
      </Dropdown>
