...
// import { TAB_VARIANTS } from '../object/tab-manager/tabs/variants/variants-container'

moduleSystem.registerModule({
  onInit: () => {
    const objectEditorTabManager = container.get<ObjectTabManager>(serviceIds['DataObject/Editor/VariantTabManager'])
