...
import { WidgetManagerService } from '@Pimcore/modules/widget-manager/services/widget-manager-service'
...
container.bind(serviceIds.widgetManagerService).to(WidgetManagerService).inSingletonScope()
