...
export const tagNames = {
  ...
  DOCUMENT_SITE_DETAIL: 'DOCUMENT_SITE_DETAIL',
  WORKFLOW: 'WORKFLOW',
  VERSIONS: 'VERSION',
...
export const providingTags = {
  ...
  DOCUMENT_SITE_DETAIL: (id: number) => [tagNames.DOCUMENT, { type: tagNames.DOCUMENT_SITE_DETAIL, id }],
...
export const invalidatingTags = {
  ...
  DOCUMENT_SITE_DETAIL: (id: number) => [{ type: tagNames.DOCUMENT_SITE_DETAIL, id }],
  DOMAIN_TRANSLATIONS: () => [tagNames.DOMAIN_TRANSLATIONS],
  LOCALES: () => [tagNames.LOCALES],
