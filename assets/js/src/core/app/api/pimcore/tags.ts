...
export const providingTags = {
  ...
  SELECT_OPTION: () => [tagNames.SELECT_OPTION],
  SELECT_OPTION_COLLECTION: () => [tagNames.SELECT_OPTION, tagNames.SELECT_OPTION_COLLECTION],
  SELECT_OPTION_DETAIL: (id: string) => [tagNames.SELECT_OPTION, { type: tagNames.SELECT_OPTION_DETAIL, id }]
}
