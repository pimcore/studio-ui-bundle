...
import { useStyles } from './object-versions-fields-view.styles'
...
export const ObjectVersionsFieldsView = ({ categoriesList, versionViewData, versionKeysList, modifiedFields }: IAssetVersionsFieldsViewProps): React.JSX.Element => {
