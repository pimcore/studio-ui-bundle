...
export const HeadWithButtons = {
    args: {
        ...
        title: <Fragment>
            Card Title
            <IconTextButton icon="PlusCircleOutlined" type="default">Add</IconTextButton>
        </Fragment>,
        extra: [
            {
                icon: 'eye-outlined',
...
export const ToggleButton = {
  args: {
    title: 'Manufacturer Uppercase',
      extra: [<Switch key="toggle-switch" labelLeft={"Toggle"} onChange={() => console.log('change')}></Switch>]
  }
}
