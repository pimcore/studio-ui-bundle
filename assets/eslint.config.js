...
export default tseslint.config(
  // 1. Ignore patterns (replaces ignorePatterns in .eslintrc.js)
  {
    ignores: ['**/*.gen.ts', '**/twemoji-icons-list-complete.ts']
  },
  ...
  // 3. Storybook — manual flat config (eslint-plugin-storybook v0.8.x is not ESLint v9 compatible;
  //    rules that call context.getScope() are omitted: csf-component, hierarchy-separator,
  //    meta-inline-properties, no-title-property-in-meta, no-uninstalled-addons,
  //    prefer-pascal-case, story-exports)
  {
  ...
  // 4. Node environment for config files themselves
  {
  ...
  // 5. Test files — add jest globals, disable type-aware rules that don't apply
  {
  ...
  // 6. Stories files — disable max-lines
  {
    files: ['**/*.stories.tsx'],
    rules: {
      'max-lines': 'off'
