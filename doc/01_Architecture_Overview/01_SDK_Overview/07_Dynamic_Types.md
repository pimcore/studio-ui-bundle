...
### Grid-Cells
For grid cells, dynamic types describe how each cell should behave based on its specific type. It defines how a value of a cell should be rendered and also whether it should be editable or not.
...
### Assets
Defines which types (image, audio, folder, etc.) are available in Pimcore Studio
