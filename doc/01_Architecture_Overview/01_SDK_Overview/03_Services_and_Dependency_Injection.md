...
## Full Code Example
The DI container is used in multiple examples. For instance, refer to the [How to Use the Tab Manager Example](../../04_Extending/02_Plugin_Development_Examples/04_Use_the_Tab_Manager.md). 
