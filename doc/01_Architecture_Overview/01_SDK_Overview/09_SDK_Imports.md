...
`@pimcore/studio-ui-bundle/api/*`: Provides access to RTK Query APIs, including hooks for fetching, mutating, and managing data. [See here](./08_RTK_Query_API.md) for more details.
