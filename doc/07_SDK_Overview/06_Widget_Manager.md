...
For a step-by-step guide on how to add a new widget to the Widget Manager, refer to the [Add Your First Widget example](../05_Examples/03_Add_your_first_widget.md).
