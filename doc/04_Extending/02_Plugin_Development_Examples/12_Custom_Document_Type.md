...
Adding a custom document type requires both a PHP backend and a Studio UI frontend plugin:
...
[Adding Document Types](https://github.com/pimcore/pimcore/blob/2025.x/doc/10_Extending_Pimcore/03_Custom_Extension_Guides/02_Adding_Document_Types.md)
