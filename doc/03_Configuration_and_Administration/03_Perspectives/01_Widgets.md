...
A widget is an additional custom tree representing a subset of elements of the corresponding original tree.
Widgets can be configured for Documents, Assets and Data Objects.

To create or edit perspectives and widgets within Pimcore Studio use the [perspective editor](https://github.com/pimcore/perspective-editor) bundle.

> **Security Note**
> Perspectives and Widgets are not intended to be used to restrict access to data

An unlimited number of widgets can be created. Specify the tree type, root node and layout settings.
Note that the ID is mandatory and must be unique!

![Widgets](../../img/classes-custom-views1.png)

For a sample configuration file have a look at the examples below.

## The Configuration File

Format and location of the widget configuration depends on your environment.
...
![Widgets](../../img/classes-custom-views2.png)
...
![Widgets](../../img/classes-custom-views3.png)
...
![Widgets](../../img/classes-custom-views4.png)


## Customizing the Tree Context Menu

Allows you to hide certain context menu items via the widget's treeContextMenu configuration option.
...
![Widgets](../../img/classes-custom-views5.png)
